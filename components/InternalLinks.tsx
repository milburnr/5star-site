        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4">
              We also provide expert {serviceData[currentService]?.name.toLowerCase()} services in
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4">
              Looking for other roofing services? We offer comprehensive roofing solutions in{" "}
              {cityInfo.name}:
            </p>
            <div className="grid gap-3">
