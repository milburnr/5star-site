...
export const mdxComponents: MDXComponents = {
  ...
  h1: (props) => (
    <h1
      className="text-4xl md:text-5xl font-bold text-gray-primary mt-0 mb-6 leading-tight"
      {...props}
    />
  ),
  h2: (props) => (
  ...
  h3: (props) => <h3 className="text-2xl font-semibold text-gray-primary mt-8 mb-3" {...props} />,
  h4: (props) => <h4 className="text-xl font-semibold text-gray-primary mt-6 mb-2" {...props} />,
  p: (props) => <p className="text-gray-text leading-relaxed mb-4" {...props} />,
  ul: (props) => <ul className="list-disc pl-6 mb-4 space-y-2 text-gray-text" {...props} />,
  ol: (props) => <ol className="list-decimal pl-6 mb-4 space-y-2 text-gray-text" {...props} />,
  li: (props) => <li className="leading-relaxed" {...props} />,
  strong: (props) => <strong className="font-semibold text-gray-primary" {...props} />,
  blockquote: (props) => (
    <blockquote
  ...
  td: (props) => <td className="border-b border-gray-200 px-4 py-2" {...props} />,
  code: (props) => (
    <code
      className="bg-gray-100 text-brand-brown px-1.5 py-0.5 rounded text-sm font-mono"
      {...props}
    />
  ),
};
