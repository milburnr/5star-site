    ...
    <div className="container-custom py-12">
        ...
        <section className="container-custom mt-4 mb-8">
          <div className="max-w-5xl mx-auto bg-amber-50 border-l-4 border-brand-gold rounded-r-2xl p-6">
            ...
            <ul className="space-y-2 text-gray-800 font-medium leading-relaxed">
              <li className="flex gap-2"><span className="text-brand-gold flex-shrink-0">•</span><span>What this page covers: why 5 Star Roofing is the local choice for Amarillo homeowners and property owners.</span></li>
              <li className="flex gap-2"><span className="text-brand-gold flex-shrink-0">•</span><span>Credentials: headquartered in Amarillo since 2014, Class 4 hail-rated installs, real Google reviews, and direct insurance documentation.</span></li>
              <li className="flex gap-2"><span className="text-brand-gold flex-shrink-0">•</span><span>Service area: every Amarillo neighborhood plus the broader Panhandle and West Texas region.</span></li>
              <li className="flex gap-2"><span className="text-brand-gold flex-shrink-0">•</span><span>Next step: free roof inspections available. Call (806) 622-6041 to schedule.</span></li>
            </ul>
          </div>
        </section>
      </FadeIn>
      ...
      <aside className="container-custom mt-6 mb-8">
        <div className="max-w-5xl mx-auto bg-white border-l-4 border-brand-brown rounded-r-2xl p-5 text-sm text-gray-700">
          ...
          <p>For the next step, see <a href="/amarillo-tx-roofing/" className="text-brand-brown font-semibold hover:text-brand-gold underline">amarillo-tx-roofing</a> or <a href="/services/" className="text-brand-brown font-semibold hover:text-brand-gold underline">our full service list</a>.</p>
        </div>
      </aside>
      {/* /auto-link */}
      ...
      {/* Featured Image */}
      <img
        src="https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/heroes/amarillo-hero.jpg"
      ...
      <div className="prose max-w-none">
        <p>
          Finding the best roofing contractor in Amarillo is a crucial decision for homeowners
          looking for top-notch roofing services. It's not just about finding a{" "}
          <strong>reliable</strong> and <strong>experienced</strong> roofer - pricing and
          affordability also play a significant role. At 5 Star Commercial Roofing, we've earned our
          reputation as Amarillo's premier roofing contractor through over a decade of exceptional
          service to the Texas Panhandle.
        </p>

        <p>
          Nobody wants to break the bank when it comes to fixing their roof, but quality should
          never be compromised. That's why we offer competitive pricing, transparent estimates, and
          work directly with your insurance company to ensure you get the coverage you deserve. Call
          us at <strong>(806) 622-6041</strong> for a <strong>free inspection</strong> and estimate.
        </p>
        ...
        <p>
          Next, consider the range of services offered by the roofer. A{" "}
          <strong>top roofing company</strong> should be able to provide a wide range of services,
          including inspections, repairs, replacements, and installations. We handle everything from{" "}
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">
          What Makes 5 Star Roofing the Best Choice in Amarillo?
        </h2>

        <p>
          When you're choosing a roofing contractor in Amarillo, you need more than just someone who
          can install shingles. You need a partner who understands the unique challenges of West
          Texas weather, has deep local relationships, and backs their work with ironclad
          guarantees. Here's why Amarillo homeowners consistently choose 5 Star Commercial Roofing
          as their trusted roofing partner:
        </p>
        ...
        <div className="bg-amber-50 p-6 rounded-lg mb-6">
          <ul className="space-y-3">
            <li>
              <strong>Class 4 Specialists:</strong> UL 2218 impact-resistant shingles that qualify
              most homeowners for insurance discounts and are built for Texas Panhandle hail
              exposure
            </li>
            <li>
              <strong>Weather-Tested Knowledge:</strong> We've weathered every major storm system,
              from the 2019 Amarillo hailstorm to the 2021 freeze
            </li>
            <li>
              <strong>Local Supply Chain Mastery:</strong> Exclusive relationships with suppliers
              ensure material availability when you need it most
            </li>
            <li>
              <strong>Permit & Code Expertise:</strong> Deep knowledge of Amarillo building codes,
              permit requirements, and inspection processes
            </li>
            <li>
              <strong>Neighborhood Familiarity:</strong> We know the specific challenges of
              different Amarillo areas, from older homes in San Jacinto to newer developments in
              West Amarillo
            </li>
          </ul>
        </div>
        ...
        <div className="bg-gray-50 p-6 rounded-lg mb-6">
          <div className="grid md:grid-cols-3 gap-4 text-center">
            <div>
              ...
              <div className="text-sm">Roof Inspections</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-brand-gold">Class 4</div>
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            <strong>Drone Roof Inspections:</strong> Safe, thorough assessments without walking on
            your roof
          </li>
          <li>
            <strong>Digital Documentation:</strong> Comprehensive photo reports for insurance and
            warranty records
          </li>
          <li>
            <strong>Thermal Imaging:</strong> Detect hidden moisture problems and insulation gaps
          </li>
          <li>
            <strong>3D Measurement Systems:</strong> Precise material calculations for accurate
            estimates
          </li>
          <li>
            <strong>Project Management Software:</strong> Real-time updates on your project progress
          </li>
          <li>
            <strong>Weather Monitoring:</strong> Strategic scheduling around Amarillo's
        ...
        <p>
          As Amarillo's premier roofing contractor, we offer complete roofing solutions that address
          every aspect of your roofing needs. From emergency storm repairs to complete system
          replacements, our comprehensive service menu ensures we can handle any challenge your West
          Texas roof may face.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-6">
          <div className="bg-white p-6 rounded-lg shadow border">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                •{" "}
                <a href="/tpo-roofing-amarillo/" className="text-brand-gold hover:underline">
                  TPO Flat Roofing
                </a>
              </li>
        ...
        <p>
          ...
          contractors who inflate prices to account for potential insurance claim rejections, we
          provide honest estimates based on actual project costs.
        </p>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">
          The Amarillo Advantage: Local Expertise Matters
        </h2>

        <p>
          Choosing a local contractor isn't just about supporting your community—it's about working
          with professionals who understand your specific challenges. Amarillo's unique position in
          the Texas Panhandle creates weather patterns that out-of-state contractors simply don't
          comprehend. Our deep local knowledge translates into better solutions, faster service, and
        ...
        <div className="bg-gray-50 p-6 rounded-lg mb-6">
          ...
          <p className="mb-3">
            We've tracked and analyzed Amarillo weather patterns for over 15 years. We know that
            northeast Amarillo typically sees more hail activity due to storm cell formation
            patterns near the caprock. We understand that west Amarillo homes face stronger wind
            loads due to the open prairie geography. This knowledge informs our material
            recommendations and installation methods.
          </p>
          ...
          <p>
            When severe weather damages hundreds of roofs simultaneously, material availability
            becomes critical. Our established relationships with local suppliers, combined with
            strategic inventory management, ensures we can source quality materials even during peak
            demand periods.
          </p>
        </div>
        ...
        <p>
          Every successful roofing project follows a structured process. Our time-tested approach
          ensures quality results while minimizing disruption to your daily routine:
        </p>

        <div className="space-y-4 mb-6">
          <div className="flex items-start space-x-4 bg-white p-4 rounded-lg shadow border">
            <div className="flex-shrink-0 w-8 h-8 bg-brand-gold text-white rounded-full flex items-center justify-center font-bold">
              1
            </div>
            <div>
          ...
          <div className="flex items-start space-x-4 bg-white p-4 rounded-lg shadow border">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Comprehensive written estimate with material options, timeline, and warranty
                information. In-home consultation to review options and answer questions.
              </p>
            </div>
          </div>
        ...
        <p>
          Our reputation speaks for itself. We've built our business on honest communication,
          quality workmanship, and standing behind our work. When you choose 5 Star Roofing, you're
          choosing:
        </p>
        ...
        <p>
          Living in the Texas Panhandle means dealing with frequent hailstorms. Our team specializes
          in
          <a href="/hail-damage-repair-amarillo/" className="text-brand-gold hover:underline">
            {" "}
            hail damage repair
          </a>{" "}
          and insurance claims assistance. We'll thoroughly inspect your roof after any storm,
          document all damage with detailed reports and photographs, and work directly with your
          insurance adjuster to ensure you receive fair compensation.
        </p>

        <p>
          We understand the stress and confusion that can come with filing an insurance claim.
          That's why we handle all the paperwork and communication with your insurance company,
          making the process as smooth and stress-free as possible for you. Our goal is to restore
          your roof to perfect condition while maximizing your insurance settlement.
        </p>

        <h2 className="text-2xl font-bold mt-8 mb-4">Service Areas Throughout West Texas</h2>

        <p>
          While Amarillo is our home, we proudly serve the entire Texas Panhandle and West Texas
          region. Our service area includes{" "}
          ...
          , Lubbock, Canyon, Borger, Pampa, Dumas, and all surrounding communities. No matter where
          you're located in West Texas, you can count on us for prompt, professional roofing
          services.
        </p>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">
          Why Amarillo Trusts 5 Star Commercial Roofing
        </h2>

        <p>
          Building a reputation as Amarillo's best roofer doesn't happen overnight—it takes years of
          consistent excellence, honest communication, and standing behind every project we
          complete. Here's what sets us apart in the competitive Amarillo roofing market:
        </p>
        ...
        <div className="bg-gray-50 p-6 rounded-lg mb-6">
          <ul className="space-y-3">
            <li>
              <strong>Local Ownership:</strong> Family-owned business with deep roots in the
              Amarillo community
            </li>
            <li>
              <strong>Community Involvement:</strong> Active support of local schools, charities,
              and civic organizations
            </li>
            <li>
              <strong>Economic Impact:</strong> Local hiring practices and supplier relationships
              that support the regional economy
            </li>
            <li>
              <strong>Neighborhood Expertise:</strong> Detailed knowledge of local housing stock and
              common roofing challenges
            </li>
            <li>
              <strong>Long-term Relationships:</strong> Many customers become repeat clients for
              multiple properties
            </li>
          </ul>
        </div>
        ...
        <div className="space-y-4 mb-6">
          <div className="bg-gray-50 p-6 rounded-lg">
            <h4 className="font-bold mb-2">How do you handle roofing issues and storm damage?</h4>
            <p>
              We schedule inspections and storm-damage documentation across Amarillo once conditions
              are safe for crews to be on a roof. We are not an emergency-dispatch service — our
              value is thorough documentation, insurance-claim follow-through, and Class 4
              impact-resistant restoration. Call (806) 622-6041 to schedule a free inspection.
            </p>
          </div>
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <p>
              Absolutely. We're experts at working with insurance companies and will handle all
              aspects of your claim, from initial documentation to final settlement. We meet with
              adjusters, provide detailed damage reports, and advocate for fair compensation.
            </p>
          </div>

          <div className="bg-gray-50 p-6 rounded-lg">
            <h4 className="font-bold mb-2">
              What makes you different from other Amarillo roofers?
            </h4>
            <p>
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <p>
              Most residential roof replacements are completed in 1-3 days, depending on size,
              complexity, and weather conditions. We provide detailed project timelines during the
              estimate process and keep you updated throughout the project.
            </p>
          </div>
        </div>
        ...
        <p>
          ...
          as a homeowner or business owner. Your roof protects everything you value, and it deserves
          the attention of professionals who understand both the technical requirements and the
          local challenges specific to Amarillo and the Texas Panhandle.
        </p>

        <p>
          At 5 Star Commercial Roofing, we don't just install roofs—we build relationships. Every
          project is an opportunity to demonstrate why we've earned our reputation as Amarillo's
          best roofer. From the initial consultation through final cleanup, you'll experience the
          professionalism, expertise, and genuine care that has made us the preferred choice of
      ...
      <section className="mt-12 bg-gradient-to-r from-amber-50 to-orange-50 p-8 rounded-lg border-2 border-brand-gold/20 shadow-lg">
        <h2 className="text-2xl font-bold mb-4 text-brand-brown">
          Ready to Work with Amarillo's Best Roofer?
        </h2>
      ...
      <section className="mt-12">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          ...
          >
            ...
            <p className="text-sm text-gray-600">
              Expert home roofing services for Amarillo residents
            </p>
          </a>
          <a
