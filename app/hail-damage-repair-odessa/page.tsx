...
export const metadata: Metadata = {
  title: 'Hail Damage Repair Odessa TX | Permian Basin Storm Experts | 5 Star Roofing',
  description: "Odessa's trusted hail damage repair specialists. 24/7 emergency response, insurance claim assistance, Class 4 impact-resistant shingles. Serving Ector County since 2014. Free inspections. Call (806) 622-6041.",
};
