            ...
            <div className="bg-amber-50 p-8 rounded-xl">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center">
                  <div className="text-4xl mb-2"><Clock className="w-6 h-6 inline-block" /></div>
                ...
                <div className="text-center">
                  <div className="text-4xl mb-2"><BadgeCheck className="w-6 h-6 inline-block" /></div>
                ...
                <div className="text-center">
                  <div className="text-4xl mb-2"><ClipboardList className="w-6 h-6 inline-block" /></div>
