          ...
          <FadeIn>
            <div className="max-w-4xl">
              <h1 className="text-6xl font-bold mb-6 text-white leading-tight">
                Roof Replacement in <span className="text-brand-gold-light">Perryton, Texas</span>
              </h1>
              <p className="text-3xl mb-6 font-bold text-brand-gold-light">
                Agricultural Community Roofing Excellence
              </p>
              <p className="text-xl mb-8 text-white leading-relaxed">
                Professional roof replacement throughout Perryton and Ochiltree County. Specializing
                in agricultural and residential roofing systems engineered for North Texas Panhandle
                weather extremes. Expert installation, comprehensive warranties, and for America's
                wheat capital.
              </p>
