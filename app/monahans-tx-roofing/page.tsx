...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/completed/completed-perryton-24-1280w.webp",
        width: 1280,
        height: 720,
      ...
      >
        ...
        <FadeIn>
          <div className="hero-content">
            <h1 className="hero-title">Monahans Roofing Built for Extreme Permian Basin Heat</h1>
            <p className="hero-subtitle">
              Ward County&apos;s Trusted Roofing Contractor for Oil Field &amp; Residential
              Properties
            </p>
