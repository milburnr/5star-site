...
export const metadata: Metadata = {
  ...
  description:
    "Heavy rain damage roof repair in Amarillo TX. Water leak fixes, structural assessment, insurance help. Call (806) 622-6041 for a free quote",
  openGraph: {
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": ["LocalBusiness", "RoofingContractor"],
            "@id":
              "https://5starroofingpros.com/heavy-rain-damage-roof-repair-in-amarillo/#localbusiness",
            name: "5 Star Roofing",
            image:
      ...
      <aside className="container-custom mt-6 mb-8">
        <div className="max-w-5xl mx-auto bg-white border-l-4 border-brand-brown rounded-r-2xl p-5 text-sm text-gray-700">
          ...
          <p>For the next step, see <a href="/roof-repair/" className="text-brand-brown font-semibold hover:text-brand-gold underline">Texas Panhandle roof repair team</a> or <a href="/amarillo-tx-roofing/" className="text-brand-brown font-semibold hover:text-brand-gold underline">our Amarillo roofing crew</a>.</p>
        </div>
      </aside>
      {/* /auto-link */}
        ...
        <div className="content-block">
          ...
          <p className="text-lg">
            While hail gets most of the attention in Texas Panhandle and West Texas, heavy rain can
            be just as destructive to your roof—especially when combined with wind-driven rain,
            aging roofing materials, or existing storm damage. When flash floods and severe
            thunderstorms dump 2-4 inches of rain in an hour (common in Amarillo, Midland, and
            Odessa during spring and summer), even minor roof vulnerabilities can become major
            leaks.
          </p>
          <p className="text-lg mt-4">
            ...
            cover all aspects of storm damage repair throughout the region.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="check-item">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Brown or yellow discoloration indicates water penetration through the roof deck
              </p>
            </div>
          </div>
          <div className="check-item">
          ...
          <div className="check-item">
            <span className="check-icon text-2xl">
              <AlertTriangle className="w-6 h-6 inline-block" />
            </span>
            <div>
          ...
          <div className="check-item">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Missing shingles, damaged flashing, or open seams allowing water entry
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="card mb-8">
          <div className="card-body">
            ...
            <p className="mb-4">
              ...
              hailstorms per year. Combined with extreme temperature swings (from below 0°F in
              winter to over 100°F in summer), high winds averaging 12-14 mph, and intense UV
              exposure, roofs in this region face some of the harshest conditions in the United
              States. West Texas winds can drive rain horizontally under shingles, through vents,
              and around flashing. What appears to be a minor storm can cause significant water
              intrusion when wind speeds exceed 40 mph.
            </p>

            <h3 className="text-xl font-semibold text-brand-brown mb-3">Previous Hail Damage</h3>
            <p className="mb-4">
              Hail impacts create granule loss and micro-fractures in asphalt shingles. These
              damaged areas may not leak immediately, but heavy rain weeks or months later can
              penetrate through the weakened shingles. This is extremely common in Amarillo,
              Midland, and Odessa due to frequent hailstorms.
            </p>
            ...
            <p className="mb-4">
              Asphalt shingles in West Texas typically last 15-20 years due to intense UV exposure
              and temperature extremes. As shingles age, they become brittle and less waterproof,
              making heavy rain damage more likely.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-3 mb-8">
          ...
          <div className="process-step">
            ...
            <div className="step-content">
              ...
              <p className="step-text">
                Complete roof inspection using drone technology to document all damage for insurance
                purposes. We identify the source of leaks and extent of water damage to interior
                spaces.
              </p>
            </div>
          </div>
          <div className="process-step">
            ...
            <div className="step-content">
              ...
              <p className="step-text">
                We prepare detailed documentation with photos, drone footage, and written reports
                for your insurance adjuster. Most homeowners insurance policies in West Texas cover
                rain damage resulting from storm events.
              </p>
            </div>
          </div>
          <div className="process-step">
            ...
            <div className="step-content">
              ...
              <p className="step-text">
                Once insurance approves your claim, we complete professional repairs or full roof
                replacement using impact-resistant materials designed for West Texas weather.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="card">
            <div className="card-body">
              ...
              <p>
                ...
                and reduce the likelihood of granule loss that leads to water penetration.
              </p>
            </div>
          </div>
          <div className="card">
          ...
          <div className="card">
            <div className="card-body">
              ...
              <p>
                Use metal flashing with high-quality sealant rated for extreme temperature swings
                common in West Texas and the Texas Panhandle.
              </p>
            </div>
          </div>
          <div className="card">
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">
          Why Choose 5 Star Commercial Roofing for Rain Damage Repairs
        </h2>
        <div className="card mb-8">
          <div className="card-body">
            <p className="mb-4">
              When heavy rain damages your roof in Amarillo, Midland, Odessa, or Lubbock, you need a
              roofing contractor with proven experience in the unique challenges of West Texas
              weather. Our team has been serving the Texas Panhandle for years, and we understand
              the specific vulnerabilities that regional climate conditions create.
            </p>
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Insurance Expertise:</strong> We've worked with every major insurance
                carrier in Texas and know exactly what documentation is needed to get your claim
                approved quickly. Our{" "}
                <a
                  href="/hail-damage-repair-amarillo/"
                  className="text-brand-brown hover:text-brand-gold underline"
                >
                ...
                experience translates directly to rain damage claims.
              </li>
              <li>
                <strong>Advanced Technology:</strong> Drone inspections provide detailed
                documentation of roof damage that insurance adjusters trust, while also keeping our
                team safe during inspections of steep or dangerous roofs.
              </li>
              <li>
                <strong>Regional Coverage:</strong> From Amarillo to Midland, Odessa to Lubbock, we
                serve the entire West Texas region with the same fast, professional service.
              </li>
              <li>
                <strong>Quality Materials:</strong> We only install roofing materials rated for
                extreme West Texas conditions—intense UV, high winds, and dramatic temperature
                swings.
              </li>
            </ul>
          </div>
        ...
        <div className="card mb-8">
          <div className="card-body">
            ...
            <p className="mt-4">
              Our team provides detailed documentation that clearly demonstrates storm-related
              damage to support your insurance claim. We work directly with adjusters and can be
              present during their inspection to ensure all damage is properly noted. For
              comprehensive roofing solutions, explore our full range of{" "}
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">
          Frequently Asked Questions About Rain Damage
        </h2>
        <div className="space-y-4 mb-8">
          <div className="card">
            <div className="card-body">
              <h3 className="font-bold mb-2">
                How quickly should I call for service after heavy rain?
              </h3>
              <p>
          ...
          <div className="card">
            <div className="card-body">
              ...
              <p>
                Most insurance companies in Texas complete inspections within 7-14 days after
                filing. Once approved, repairs can typically begin within 1-2 weeks. We work to
                expedite this process and keep you informed at every step.
              </p>
            </div>
          </div>
          <div className="card">
            <div className="card-body">
              <h3 className="font-bold mb-2">
                Can you repair just the damaged section or do I need a full replacement?
              </h3>
              <p>
                This depends on the extent of damage, age of your current roof, and insurance
                coverage. If damage is isolated and your roof is relatively new, targeted repairs
                may be sufficient. However, if widespread damage exists or your roof is nearing the
                end of its lifespan, full replacement may be more cost-effective. We provide honest
