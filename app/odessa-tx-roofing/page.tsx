          ...
          <div className="space-y-12">
            ...
            <FadeIn delay={0.3}>
              <InteractiveCard className="bg-blue-50 border-2 border-blue-200">
                <div className="flex flex-col md:flex-row gap-6">
                  <div className="md:w-1/3">
                    <img src="/photos/tpo-sunset4.jpg" alt="Commercial and industrial roofing services in Odessa TX" className="w-full h-48 object-cover rounded-lg mb-4" />
                    <h3 className="text-2xl font-bold text-brand-brown mb-2">
                      Commercial & Industrial Roofing
                    </h3>
            ...
            <FadeIn delay={0.5}>
              <InteractiveCard className="bg-red-50 border-2 border-red-300">
                <div className="flex flex-col md:flex-row gap-6">
                  <div className="md:w-1/3">
                    <img src="/images/shutterstock_162724754.jpg" alt="24/7 emergency roof repair services in Odessa TX" className="w-full h-48 object-cover rounded-lg mb-4" />
