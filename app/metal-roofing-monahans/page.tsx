...
export const metadata: Metadata = {
  title: "Metal Roofing Monahans TX | 5 Star Commercial Roofing",
  ...
  return (
    <>      <Breadcrumb items={[
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "name": "5 Star Commercial Roofing - Monahans Metal Roofing",
        ...
        "description": "Expert metal roofing services in Monahans, TX. Free inspections, insurance claim assistance, 24/7 emergency response.",
      ...
      <div className="container-custom py-12">
        <FadeIn>
          <section className="mb-16 max-w-5xl mx-auto">
            <h2 className="text-4xl font-bold mb-6 text-brand-brown">
              Monahans's Metal Roofing Specialists
            </h2>
        ...
        <FadeIn>
          <section className="mb-16 max-w-5xl mx-auto">
            <h2 className="text-4xl font-bold mb-8 text-brand-brown">
              Premium Metal Roofing Materials for Monahans Properties
            </h2>
        ...
        <FadeIn>
          <section className="mb-16 max-w-5xl mx-auto">
            <h2 className="text-4xl font-bold mb-8 text-brand-brown">
              Energy Efficiency & Cost Savings in Desert Climate
            </h2>
        ...
        <FadeIn>
          <section className="mb-16 max-w-5xl mx-auto">
            <h2 className="text-4xl font-bold mb-8 text-brand-brown">
              Maintenance & Longevity in the Permian Basin
            </h2>
