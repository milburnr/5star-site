...
export const metadata: Metadata = {
  ...
  description: "Professional roof replacement in Big Spring TX. Expert installation, repair & insurance assistance. Free inspections. Call (806) 622-6041",
  openGraph: {
    title: "Roof Replacement Big Spring TX | 5 Star Roofing",
    description: "Professional roof replacement in Big Spring TX. Expert installation, repair & insurance assistance. Free inspections. Call (806) 622-6041",
...
export default function RoofReplacementBigSpringPage() {
  return (
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Professional roof replacement services in Big Spring, Texas. Expert installation, repair, and maintenance with prompt response.",
            "provider": {
              "@type": ["LocalBusiness", "RoofingContractor"],
              "name": "5 Star Roofing",
              "telephone": "(806) 622-6041",
      ...
      <section className="relative bg-cover bg-center text-white py-32 min-h-[700px] flex items-center" style={{ backgroundImage: 'url(https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/heroes/midland-hero.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <div className="container-custom relative z-10">
          <FadeIn>
            <div className="max-w-4xl">
              ...
              <p className="text-xl mb-8 text-white leading-relaxed">Professional roof replacement throughout Big Spring. Expert installation, comprehensive warranties, and . Free inspections and insurance assistance available.</p>
