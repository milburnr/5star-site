...
export const metadata: Metadata = {
  ...
  description:
    "Roofing advice for Texas homeowners. Guides on hail damage, roof costs, materials, maintenance. Call (806) 622-6041",
  openGraph: {
    title: "Roofing Blog & Resources | 5 Star Roofing",
    description:
      "Roofing advice for Texas homeowners. Guides on hail damage, roof costs, materials, maintenance. Call (806) 622-6041",
        ...
        <FadeIn>
          <div className="max-w-4xl mx-auto mb-16 text-center">
            <p className="text-2xl text-gray-700 mb-6">
              <strong>Everything you need to know about roofing in Texas.</strong> From choosing
              materials to filing insurance claims, our guides help you make informed decisions
              about your roof.
            </p>
            <p className="text-xl text-gray-600">
              Written by experienced West Texas roofers who understand the unique challenges of our
              climate.
            </p>
          </div>
        </FadeIn>
              ...
              {articles.map((article) => (
                ...
                >
                  <div className="p-6 flex-1 flex flex-col">
                    ...
                    <p className="text-gray-700 mb-4 flex-1">{article.frontmatter.description}</p>
