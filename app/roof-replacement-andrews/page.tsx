...
export const metadata: Metadata = {
  ...
  description: "Professional roof replacement in Andrews TX. Expert installation, repair & insurance assistance. Free inspections. Call (806) 622-6041",
  openGraph: {
    title: "Roof Replacement Andrews TX | 5 Star Roofing",
    description: "Professional roof replacement in Andrews TX. Expert installation, repair & insurance assistance. Free inspections. Call (806) 622-6041",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Professional roof replacement services in Andrews, Texas. Expert installation, repair, and maintenance with prompt response.",
            "provider": {
              "@type": ["LocalBusiness", "RoofingContractor"],
              "name": "5 Star Roofing",
              "telephone": "(806) 622-6041",
        ...
        <div className="container-custom relative z-10">
          <FadeIn>
            <div className="max-w-4xl">
              ...
              <p className="text-xl mb-8 text-white leading-relaxed">Professional roof replacement throughout Andrews. Expert installation, comprehensive warranties, and . Free inspections and insurance assistance available.</p>
