          ...
          <div className="space-y-12">
            ...
            <FadeIn delay={0.5}>
              <div className="card-hover p-8">
                <div className="flex flex-col md:flex-row gap-6">
                  <div className="md:w-1/3">
                    <img src="/images/shutterstock_473737921.jpg" alt="Free roof inspections for Claude TX" className="w-full h-48 object-cover rounded-lg mb-4" />
                    <h3 className="text-2xl font-bold text-brand-brown mb-2">
            ...
            <FadeIn delay={0.6}>
              <div className="card-hover p-8 bg-red-50 border-2 border-red-200">
                <div className="flex flex-col md:flex-row gap-6">
                  <div className="md:w-1/3">
                    <img src="/images/shutterstock_162724754.jpg" alt="24/7 emergency roofing service for Claude TX" className="w-full h-48 object-cover rounded-lg mb-4" />
