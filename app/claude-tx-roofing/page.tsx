...
export const metadata: Metadata = {
  ...
  description:
    "Roofing services in Claude, Texas Panhandle. Just 25 miles east of Amarillo on US-287. Hail damage repair, residential & commercial roofing. Call (806) 622-6041",
  openGraph: {
    title: "Roofing Claude TX | Hail Damage Specialists | 5 Star Roofing",
    description:
      "Roofing services in Claude, Texas Panhandle. Just 25 miles east of Amarillo on US-287. Hail damage repair, residential & commercial roofing. Call (806) 622-6041",
        ...
        <section className="container-custom mt-8">
          <div className="max-w-5xl mx-auto bg-amber-50 border-l-4 border-brand-gold rounded-r-2xl p-6">
            ...
            <ul className="space-y-2 text-gray-800 font-medium leading-relaxed">
              <li className="flex gap-2"><span className="text-brand-gold flex-shrink-0">•</span><span>What this page covers: full residential and commercial roofing services for Claude and the surrounding area.</span></li>
          ...
          <section className="section">
            <div className="max-w-4xl mx-auto text-center mb-12">
              ...
              <p className="text-xl text-gray-600 leading-relaxed mb-6">
                ...
                provides comprehensive roofing services to Claude, Texas - a charming community of
                1,200 residents along US Highway 287 in Armstrong County. Just 25 miles east of
                Amarillo, we're close enough for fast service while understanding the unique
                character of rural Texas communities.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                Claude sits at the gateway to Palo Duro Canyon and faces the full spectrum of Texas
                Panhandle weather: severe hail storms, powerful straight-line winds, dramatic
                temperature swings, and intense sunshine. Your roof is your first line of defense,
                and we're here to keep it strong.
              </p>
            </div>
          </section>
        </FadeIn>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Just 25 miles from Claude on US Highway 287. We make the drive regularly for
                  inspections, repairs, and post-storm documentation.
                </p>
              </div>
              <div className="text-center">
                <div className="text-5xl mb-4">
                ...
                <div className="flex flex-col md:flex-row gap-6">
                  <div className="md:w-1/3">
                    <img
                      ...
                      alt="Roof replacement completed after hail damage near Channing TX - New shingles installed"
                  ...
                  <div className="md:w-2/3">
                    <p className="text-gray-600 mb-4 leading-relaxed">
                      Claude is no stranger to severe hail storms. Located in Hail Alley with
                      minimal storm protection, the area experiences frequent damaging hail events.
                      From the historic downtown to homes along FM 1260, we've helped countless
                      Claude residents recover from hail damage.
                    </p>
                    <p className="text-gray-600 mb-4">
                      <strong>Our comprehensive service:</strong> Free post-storm inspections,
                      detailed photo documentation showing hail impact points, granule loss
                      analysis, insurance claim assistance, and complete roof replacement when
                      necessary. We handle the paperwork so you don't have to.
                    </p>
                    <a
                ...
                <div className="flex flex-col md:flex-row gap-6">
                  <div className="md:w-1/3">
                    <img
                      ...
                      alt="Residential shingle roof replacement completed in Amarillo area - Quality craftsmanship"
                      className="w-full h-48 object-cover rounded-lg mb-4"
                    />
                  ...
                  <div className="md:w-2/3">
                    <p className="text-gray-600 mb-4 leading-relaxed">
                      Whether you own a historic home near Claude's downtown square, a ranch
                      property along Tule Creek, or a newer home by Claude ISD, we provide complete
                      residential roofing services tailored to your needs. We understand the mix of
                      architectural styles in Claude and work with materials that match your home's
                      character.
                    </p>
                    <p className="text-gray-600 mb-4">
                      <strong>Residential services:</strong> Complete roof replacement, asphalt
                      shingle installation (including impact-resistant options), architectural
                      shingles, roof repair and maintenance, attic ventilation upgrades, and
            ...
            <FadeIn delay={0.3}>
              <div className="card-hover p-8">
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="md:w-2/3">
                    <p className="text-gray-600 mb-4 leading-relaxed">
                      Claude's business community - from Main Street shops to agricultural
                      facilities - relies on durable commercial roofing. We specialize in flat roof
                      systems, metal buildings, and low-slope roofs common in small-town Texas
                      commercial construction.
                    </p>
                    <p className="text-gray-600 mb-4">
                      <strong>Commercial expertise:</strong> TPO single-ply roofing, EPDM rubber
                      roofing, modified bitumen systems, metal roof installation and repair, roof
                      coating for extending roof life, preventive maintenance plans, and .
                    </p>
                    <a
                ...
                <div className="flex flex-col md:flex-row gap-6">
                  <div className="md:w-1/3">
                    <img
                      ...
                      alt="Standing seam metal roof on Claude TX area property - Durable hail-resistant roofing"
                      className="w-full h-48 object-cover rounded-lg mb-4"
                    />
                    <h3 className="text-2xl font-bold text-brand-brown mb-2">
                  ...
                  <div className="md:w-2/3">
                    <p className="text-gray-600 mb-4 leading-relaxed">
                      Metal roofing is increasingly popular in Claude for good reason. It handles
                      West Texas weather exceptionally well - high winds don't lift it, hail
                      typically doesn't penetrate it, and it can last 50+ years with minimal
                      maintenance. Perfect for both homes and agricultural buildings.
                    </p>
                    <p className="text-gray-600 mb-4">
                ...
                <div className="flex flex-col md:flex-row gap-6">
                  <div className="md:w-1/3">
                    <img
                      ...
                      alt="Completed roofing project in San Angelo TX demonstrating quality inspection standards"
                      className="w-full h-48 object-cover rounded-lg mb-4"
                    />
                    <h3 className="text-2xl font-bold text-brand-brown mb-2">
                  ...
                  <div className="md:w-2/3">
                    ...
                    <p className="text-gray-600 mb-4">
                      <strong>Inspection includes:</strong> Complete exterior roof assessment,
                      shingle condition analysis, flashing inspection, ventilation check, gutter
                      evaluation, detailed photo report, and written recommendations. 100% free with
                      no pressure.
                    </p>
                    <a
                ...
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="md:w-2/3">
                    ...
                    <p className="text-gray-700 mb-4">
                      ...
                      now for immediate professional assistance. We'll be on the road to Claude
                      within minutes.
                    </p>
                    <a
            ...
            <div className="max-w-4xl mx-auto space-y-6">
              <div>
                <h3 className="text-xl font-bold text-brand-brown mb-2">
                  <Tornado className="w-6 h-6 inline-block" /> Severe Thunderstorms & Hail
                </h3>
                <p className="text-gray-700">
                  Claude sits in the heart of Hail Alley where warm, moist air from the Gulf
                  collides with cool, dry air from the Rockies. This creates explosive thunderstorms
                  from March through September, often producing baseball-sized hail.
                  Impact-resistant shingles are strongly recommended for all Claude properties.
                </p>
              </div>
              <div>
                <h3 className="text-xl font-bold text-brand-brown mb-2">
                  <Wind className="w-6 h-6 inline-block" /> Powerful Straight-Line Winds
                </h3>
                <p className="text-gray-700">
                  Armstrong County's open terrain allows wind to build tremendous speed. Sustained
                  winds of 40+ mph are common, with gusts exceeding 70 mph during severe weather.
                  Proper roof securement with high-wind rated materials is critical - standard
                  installation methods simply won't hold up.
                </p>
              </div>
              <div>
                <h3 className="text-xl font-bold text-brand-brown mb-2">
                  <Thermometer className="w-6 h-6 inline-block" /> Extreme Temperature Variation
                </h3>
                <p className="text-gray-700">
                  Claude experiences some of Texas' most dramatic temperature swings. Summer days
                  regularly hit 100°F while winter nights can drop below zero. This 100+ degree
                  temperature range causes constant expansion and contraction, stressing shingles,
                  flashing, and fasteners. We use materials engineered for these extremes.
                </p>
              </div>
              <div>
                <h3 className="text-xl font-bold text-brand-brown mb-2">
                ...
                <p className="text-gray-700">
                  At nearly 3,000 feet elevation with over 265 days of sunshine annually, Claude
                  roofs face relentless UV exposure that degrades organic materials. Asphalt
                  shingles without UV inhibitors can fail prematurely. We recommend UV-stabilized
                  shingles or metal roofing for maximum longevity.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="section bg-gray-50 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 rounded-lg">
            ...
            <div className="grid md:grid-cols-2 gap-4 max-w-3xl mx-auto">
              ...
              <a href="/canyon-texas-roofing/" className="card-hover p-4 block">
                ...
                <p className="text-gray-600 text-sm">
                  Roofing services in Canyon near Palo Duro Canyon
                </p>
              </a>
          ...
          <section className="mb-16 bg-gradient-to-br from-amber-50 to-white p-8 md:p-12 rounded-3xl shadow-lg">
            ...
            <Accordion type="single" collapsible className="max-w-4xl mx-auto">
              ...
              >
                ...
                <AccordionContent className="text-gray-700 leading-relaxed">
                  Claude sits at the gateway to Palo Duro Canyon, where the landscape transitions
                  from flat plains to rugged canyon terrain. This creates unique wind patterns as
                  air flows between the open plains and the canyon. Armstrong County also
                  experiences extreme isolation from major supply chains, so we bring all materials
                  and equipment in a single trip to minimize project delays and additional travel
                  costs.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem
              ...
              >
                ...
                <AccordionContent className="text-gray-700 leading-relaxed">
                  Absolutely. Claude&apos;s historic downtown includes buildings dating back to the
                  early 1900s, including structures around the Armstrong County Courthouse. We have
                  experience working with older construction methods and can install modern roofing
                  systems that respect the architectural character while providing superior weather
                  protection. We use materials that complement historic aesthetics, including
                  architectural shingles and stone-coated steel that mimic traditional profiles.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem
                value="faq-4"
              ...
              >
                ...
                <AccordionContent className="text-gray-700 leading-relaxed">
                  Yes, ranch and agricultural roofing is common in Claude and Armstrong County.
                  Properties along Tule Creek and FM 1260 often include cattle barns, equipment
                  storage buildings, hay storage structures, and ranch headquarters. We install
                  metal roofing systems designed for agricultural use, including corrugated panels,
                  R-panel, and standing seam systems with enhanced corrosion resistance for
              ...
              >
                ...
                <AccordionContent className="text-gray-700 leading-relaxed">
                  Palo Duro Canyon, located just south of Claude, creates unique microclimate
                  effects. The canyon acts as a channel for winds, and storms approaching from the
                  southwest can intensify as they interact with the canyon&apos;s topography.
                  Properties on the south side of Claude facing the canyon experience more turbulent
                  wind patterns than those on the north side. We account for these directional wind
                  effects when selecting materials and planning installation.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem
                value="faq-6"
              ...
              >
                ...
                <AccordionContent className="text-gray-700 leading-relaxed">
                  At nearly 3,000 feet elevation with over 265 days of sunshine annually, Claude
                  roofs receive intense UV radiation that accelerates shingle degradation. Standard
                  asphalt shingles rated for 25-30 years may only last 15-20 years here. We
                  recommend UV-stabilized architectural shingles with enhanced granule adhesion, or
                  metal roofing with reflective coatings that resist UV damage and reduce cooling
                  costs.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Professional roofing contractor serving Claude, Texas from our Amarillo location. Expert hail damage repair, residential and commercial roofing services.",
            address: {
              "@type": "PostalAddress",
