...
export const metadata: Metadata = {
  ...
  description: "Professional roof inspections in Monahans TX. Permian Basin experiences 6-8 severe hailstorms annually. Complete insurance documentation and storm damage...",
};
