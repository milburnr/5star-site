...
export const metadata: Metadata = {
  ...
  description: "Amarillo's hail damage roofing experts. Free inspections, 95%+ insurance claim approval, complete permit handling. Amarillo experiences 8-12 hailstorms annually. 1,200+ hail claims handled. Call today (806) 622-6041",
};
