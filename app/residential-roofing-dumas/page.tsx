...
export const metadata: Metadata = {
  ...
  description:
    "Professional residential roofing in Dumas TX. Expert installation, repair & insurance assistance. Free inspections. Call (806) 622-6041",
  openGraph: {
    title: "Residential Roofing Dumas TX | 5 Star Roofing",
    description:
      "Professional residential roofing in Dumas TX. Expert installation, repair & insurance assistance. Free inspections. Call (806) 622-6041",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Professional residential roofing in Dumas TX. Expert installation, warranties, and insurance assistance.",
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "How much does roof replacement cost in Dumas?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Residential roof replacement in Dumas typically costs $8,000-$25,000. Most projects are insurance claims where homeowners pay only their deductible ($1,000-$2,500).",
                },
              },
              {
                "@type": "Question",
    ...
    />
        ...
        <section className="container-custom mt-8">
          <div className="max-w-5xl mx-auto bg-amber-50 border-l-4 border-brand-gold rounded-r-2xl p-6">
            ...
            <ul className="space-y-2 text-gray-800 font-medium leading-relaxed">
              <li className="flex gap-2"><span className="text-brand-gold flex-shrink-0">•</span><span>What this page covers: Residential Roofing for homes and businesses in Dumas, Texas.</span></li>
      ...
      <div className="container-custom py-12">
        <FadeIn>
          <section className="mb-16 max-w-5xl mx-auto">
            ...
            <p className="text-xl text-gray-700 mb-6 leading-relaxed">
              Professional residential roofing throughout Dumas and Moore County. We understand
              Texas Panhandle weather challenges and install roofing systems engineered for extreme
              conditions including hail storms, high winds, and dramatic temperature swings that
            ...
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
              ...
              developments in expanding neighborhoods.
            </p>

            <div className="bg-amber-50 p-8 rounded-xl mb-8">
              <h3 className="text-2xl font-bold text-brand-brown mb-4">
                Understanding Dumas Housing Market
              </h3>
              <p className="text-gray-700 leading-relaxed mb-4">
                Dumas, the county seat of Moore County, serves as a vital agricultural and
                industrial hub in the Texas Panhandle. With a population of approximately 14,500
                residents, the city features a diverse housing landscape that reflects its rich
                history and ongoing economic growth. The median home value in Dumas is approximately
                $120,000, making it an affordable market compared to Texas averages.
              </p>

              <p className="text-gray-700 leading-relaxed mb-4">
                The housing stock in Dumas includes a significant number of homes built between
                1950-1980, many requiring roof replacements as they reach the 25-30 year mark. Newer
                subdivisions like those near Dumas High School and along Highway 287 feature modern
                construction with updated roofing systems, while historic neighborhoods downtown
                showcase classic architecture dating to the early 1900s.
              </p>
            </div>
        ...
        <FadeIn>
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
                ...
                <p className="text-gray-700 mb-4">
                  Complete roof replacement for Dumas homes using premium materials designed for
                  Texas Panhandle conditions.
                </p>
            ...
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 p-8 rounded-xl mb-12">
              <h3 className="text-2xl font-bold text-brand-brown mb-4">
                Dumas-Specific Roofing Challenges
              </h3>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-gray-700 mb-4">
                    Dumas sits at 3,668 feet elevation on the High Plains, experiencing extreme
                    temperature variations and frequent severe weather. Our roofing systems are
                    specifically engineered to handle these conditions.
                  </p>
                  ...
                  <p className="text-gray-700">
                    The surrounding agricultural operations create unique environmental factors
                    including increased dust exposure and seasonal debris that require specialized
                ...
                <div>
                  ...
                  <p className="text-gray-700 mb-4">
                    Dumas's economy, centered on agriculture and manufacturing, influences housing
                    patterns and maintenance cycles. We work with homeowners to provide
                    cost-effective solutions that protect their investment.
                  </p>
                  ...
                  <p className="text-gray-700">
                    Many of Dumas's historic homes require specialized roofing approaches that
                    maintain architectural integrity while providing modern protection.
                  </p>
                </div>
              </div>
            </div>
        ...
        <FadeIn>
          <section className="mb-16">
            <h2 className="text-3xl font-bold mb-8 text-brand-brown">
              Why Do Dumas Homeowners Choose 5 Star Roofing?
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-semibold text-brand-brown mb-1">
                        Moore County Knowledge
                      </h4>
                      <p className="text-gray-700">
                        Deep understanding of local building codes, weather patterns, and
                        architectural styles unique to Dumas.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        Extensive experience with Texas insurance claims and adjuster relationships
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        Premium roofing materials specifically selected for High Plains conditions
                        and extreme weather resistance.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg">
                ...
                <p className="text-gray-700 mb-4">
                  Complete residential roofing services throughout Moore County and surrounding
                  areas:
                </p>
                <ul className="text-gray-700 space-y-2">
        ...
        <FadeIn>
          <section className="mb-16 bg-gradient-to-br from-amber-50 to-white p-12 rounded-3xl shadow-lg">
            <h2 className="text-3xl font-bold mb-8 text-center text-brand-brown">
              Frequently Asked Questions About Dumas Roofing
            </h2>
            <Accordion type="single" collapsible className="max-w-4xl mx-auto">
              ...
              >
                <AccordionTrigger className="text-lg font-semibold text-brand-brown hover:text-brand-gold">
                  How much does roof replacement cost in Dumas?
                </AccordionTrigger>
                <AccordionContent className="text-gray-700 leading-relaxed">
                  Residential roof replacement in Dumas typically costs $8,000-$25,000, depending on
                  home size and material selection. Most projects are insurance claims where
                  homeowners pay only their deductible ($1,000-$2,500). The median home in Dumas
                  (1,400-1,800 sq ft) averages $12,000-$16,000 for complete replacement with Class 4
              ...
              >
                <AccordionTrigger className="text-lg font-semibold text-brand-brown hover:text-brand-gold">
                  What are Class 4 shingles and why are they important in Dumas?
                </AccordionTrigger>
                <AccordionContent className="text-gray-700 leading-relaxed">
                  Class 4 shingles pass UL 2218 impact testing—the highest rating available. They
                  withstand 2-inch hail impacts and qualify for 10-30% insurance discounts in Texas.
                  Given Dumas's location in "Hail Alley" with 4-6 hail events annually, Class 4
                  shingles provide essential protection and significant long-term savings for
                  homeowners.
                </AccordionContent>
              </AccordionItem>
              ...
              >
                <AccordionTrigger className="text-lg font-semibold text-brand-brown hover:text-brand-gold">
                  How long does roof replacement take in Dumas?
                </AccordionTrigger>
                <AccordionContent className="text-gray-700 leading-relaxed">
                  Most homes complete in 1-3 days. Single-story homes under 2,000 sq ft: 1-2 days.
                  Two-story or complex roofs: 2-3 days. Weather delays are common in the Panhandle,
                  so we plan accordingly and communicate any schedule adjustments immediately.
                </AccordionContent>
              </AccordionItem>
              ...
              >
                <AccordionTrigger className="text-lg font-semibold text-brand-brown hover:text-brand-gold">
                  When is the best time to replace a roof in Dumas?
                </AccordionTrigger>
                <AccordionContent className="text-gray-700 leading-relaxed">
              ...
              >
                <AccordionTrigger className="text-lg font-semibold text-brand-brown hover:text-brand-gold">
                  Do you handle insurance claims for Dumas homeowners?
                </AccordionTrigger>
                <AccordionContent className="text-gray-700 leading-relaxed">
                  Yes, we provide complete insurance assistance including damage documentation,
                  adjuster meetings, and claim advocacy. Our team has extensive experience with
                  major insurers serving the Panhandle region and understands local claim processes.
                  We help maximize your settlement while ensuring quality repairs.
                </AccordionContent>
              </AccordionItem>
              ...
              >
                <AccordionTrigger className="text-lg font-semibold text-brand-brown hover:text-brand-gold">
                  What roofing materials work best in Dumas's climate?
                </AccordionTrigger>
                <AccordionContent className="text-gray-700 leading-relaxed">
                  Impact-resistant asphalt shingles perform exceptionally well in Dumas's climate,
                  handling hail, wind, and temperature extremes. Metal roofing is also excellent for
                  energy efficiency and longevity. We avoid materials that don't handle freeze-thaw
                  cycles well and recommend UV-resistant options for the high elevation and intense
                  sun exposure.
                </AccordionContent>
              </AccordionItem>
              ...
              >
                <AccordionTrigger className="text-lg font-semibold text-brand-brown hover:text-brand-gold">
                  How do I know if my Dumas home has hail damage?
                </AccordionTrigger>
                <AccordionContent className="text-gray-700 leading-relaxed">
                  Common signs include granule loss on shingles, dented gutters or air conditioning
                  units, cracked or missing shingles, and exposed nail heads. Given Dumas's frequent
                  hail activity, we recommend professional inspections after any significant storm.
                  Our free inspections can identify damage that might not be visible from the
                  ground.
                </AccordionContent>
              </AccordionItem>
              ...
              >
                <AccordionTrigger className="text-lg font-semibold text-brand-brown hover:text-brand-gold">
                  What warranties do you provide for Dumas installations?
                </AccordionTrigger>
                <AccordionContent className="text-gray-700 leading-relaxed">
                  We offer comprehensive warranty packages including manufacturer materials
                  warranties (25-50 years) and our workmanship guarantee (10 years minimum). For
                  Class 4 installations, many manufacturers provide enhanced warranties. All
                  warranty terms are clearly documented and we maintain detailed records for the
                  life of your roof.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
              ...
              <div>
                ...
                <div className="bg-red-50 p-6 rounded-xl mb-6">
                  <h4 className="font-bold text-brand-brown mb-2">
                    <AlertTriangle className="w-6 h-6 inline-block" /> When to call for service:
                  </h4>
        ...
        <InternalLinks currentCity="dumas" currentService="residential-roofing" />

        <section className="bg-gradient-to-r from-brand-brown to-brand-gold text-white p-12 rounded-3xl text-center">
          <h2 className="text-4xl font-bold mb-6">Ready to Protect Your Dumas Property?</h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Free inspections for Dumas property owners. Expert residential roofing with
        ...
        <RelatedArticles pageSlug="residential-roofing-dumas" />
      </div>
    </>
  );
}
