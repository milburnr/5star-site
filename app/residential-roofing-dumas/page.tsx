...
export default function ResidentialRoofingDumasPage() {
  return (
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Professional residential roofing services in Dumas, Texas. Expert installation, repair, and maintenance with 24/7 emergency response.",
            "provider": {
      ...
      <section className="relative bg-cover bg-center text-white py-32 min-h-[700px] flex items-center" style={{ backgroundImage: 'url(https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/shingle/shingle-stinnett-48-1280w.webp)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
