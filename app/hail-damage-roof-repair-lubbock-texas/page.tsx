...
export default function HailDamageLubbockPage() {
  return (
    <div className="min-h-screen">
      ...
      <section className="hero" style={{backgroundImage: 'url(https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/hail-damage/hail-damage-lubbock-45-1280w.webp)', backgroundPosition: 'center'}}>
        ...
        <FadeIn>
          <div className="max-w-4xl mx-auto mb-16">
            ...
            <p className="text-xl text-gray-600">
              5 Star Commercial Roofing specializes in hail damage detection, insurance documentation, and complete roof restoration for Lubbock properties. Located 2 hours south of our Amarillo headquarters, we respond within 2.5 hours for hail damage. Free inspections and full insurance claim assistance available.
            </p>
          </div>
        </FadeIn>
        ...
        <FadeIn>
          <section className="mt-16 pt-8 border-t border-gray-200">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <span className="text-gray-400">•</span>
              <a href="/commercial-roofing-lubbock/" className="text-brand-gold hover:text-brand-gold-vibrant font-medium">Commercial Roofing</a>
            </div>
          </section>
        </FadeIn>
      </div>

      <script type="application/ld+json" dangerouslySetInnerHTML={{__html: JSON.stringify({"@context":"https://schema.org","@type":"Service","serviceType":"Hail Damage Roof Repair","provider":{"@type":"LocalBusiness","name":"5 Star Commercial Roofing","telephone": "(806) 622-6041","parentOrganization":{"@id":"https://5starroofingpros.com/#organization"}},"areaServed":{"@type":"City","name":"Lubbock","containedInPlace":{"@type":"State","name":"Texas"}}})}}/>
    </div>
  );
}
