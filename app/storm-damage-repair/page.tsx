...
export default function Page() {
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "First, ensure everyone in the home is safe and move away from any areas with active leaks or ceiling sagging. Document the damage with photos and video from the ground level before anything gets cleaned up. Catch interior drips with buckets and weatherproof sheeting to limit water intrusion. Then call us to schedule a free inspection. Do not climb on your roof yourself, especially after a storm when surfaces are wet and potentially weakened. We schedule inspections across the Panhandle once conditions are safe for crews on a roof.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "How do you handle storm damage inspections and scheduling?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "We schedule storm-damage documentation and inspections across the Panhandle once conditions are safe for crews to be on a roof. We are not an emergency-dispatch service — we triage based on damage severity and document everything with photos and adjuster-ready reports. Inspections are typically scheduled within a few days of a major storm event. We never ask homeowners to sign contracts before the inspection is complete.",
        },
      },
      {
        "@type": "Question",
  ...
  return (
    <div className="container-custom py-12">
      ...
      <img
        src="https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/hail-damage/hail-damage-wichita-falls-17-1280w.webp"
        alt="Aerial view of storm-damaged asphalt shingle roof with missing sections — 5 Star Roofing West Texas"
      ...
      <div className="bg-amber-50 border-l-4 border-brand-gold rounded-r-2xl p-6 mb-8">
        ...
        <div className="flex flex-wrap gap-4 text-sm">
          ...
          <a href="/storm-damage-repair-lubbock/" className="text-brand-brown font-semibold hover:text-brand-gold transition-colors">Lubbock</a>
          <a href="/storm-damage-repair-midland/" className="text-brand-brown font-semibold hover:text-brand-gold transition-colors">Midland</a>
          <a href="/hail-damage-repair/" className="text-brand-brown font-semibold hover:text-brand-gold transition-colors">Hail Damage Hub →</a>
        </div>
      </div>
      ...
      <FadeIn>
        <div className="bg-brand-gold-light p-8 rounded-lg mb-8">
          ...
          <p className="text-lg mb-4">
            Texas storms do not follow a single playbook. From marble-sized hail in the Panhandle to
            straight-line winds across the Permian Basin, each type of storm creates different
            damage patterns that require different repair strategies.
          </p>
      ...
      <FadeIn>
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-8">
          <p className="mb-4">
            ...
            dealing with water in your home and a damaged roof overhead. We handle the documentation
            and coordination so you can focus on your family and property.
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-600 mb-3">
              When replacing a storm-damaged roof, upgrading to impact-resistant materials pays for
              itself over time through reduced damage and lower insurance premiums.
            </p>
            <ul className="list-disc list-inside space-y-1 text-gray-600 text-sm">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-600 mb-3">
              The best materials underperform when installed incorrectly or neglected. Proper
              technique and regular maintenance are the foundation of storm resilience.
            </p>
            <ul className="list-disc list-inside space-y-1 text-gray-600 text-sm">
      ...
      <FadeIn>
        ...
        <div className="bg-brand-gold-light p-6 rounded-lg mb-8">
          <p className="mb-4">
            West Texas storm season runs primarily from March through September, with the highest
            concentration of severe hail and wind events between April and June. Winter months bring
            their own risks, including{" "}
            <a
            ...
            from freezing conditions and ice dams. The Texas Panhandle, including Amarillo, Canyon,
            and Borger, sits in one of the most active hail corridors in the United States,
            averaging 3-4 significant hail events per year.
          </p>
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-white p-4 rounded-lg">
              <h3 className="font-bold text-brand-brown mb-1">Panhandle (Amarillo Area)</h3>
              <p className="text-sm text-gray-600">
                Peak season April-June. Frequent supercell thunderstorms producing large hail, high
                winds, and occasional tornadoes. Average of 8-10 severe weather days per year.
              </p>
            </div>
            <div className="bg-white p-4 rounded-lg">
      ...
      <FadeIn>
        <section className="mb-16">
          ...
          <p className="mb-4">
            Our storm damage repair crews serve communities across the Texas Panhandle, Permian
            Basin, and South Plains. Select your city for local availability and response times.
          </p>
      ...
      <section>
        ...
        <Accordion type="single" collapsible>
          <AccordionItem value="faq-1">
            ...
            <AccordionContent>
              First, ensure everyone in the home is safe and move away from any areas with active
              leaks or ceiling sagging. Document the damage with photos and video from the ground
              level before anything gets cleaned up. Catch interior drips with buckets and
              weatherproof sheeting to limit water intrusion. Then call us to schedule a free
              inspection. Do not climb on your roof yourself, especially after a storm when surfaces
              are wet and potentially weakened. We schedule inspections across the Panhandle once
              conditions are safe for crews on a roof.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="faq-2">
            <AccordionTrigger>
              How can I tell if storm damage is serious enough to need repairs?
            </AccordionTrigger>
            <AccordionContent>
              Some storm damage is obvious, such as missing shingles, dented gutters, or visible
              holes. Other damage is harder to spot from the ground. Look for granules collecting in
              your gutters or at the base of downspouts, dents on metal vents or flashing, cracked
              or bruised shingles (they may look intact but flex when pressed), and water stains on
              interior ceilings. After any significant hail event or high-wind storm, a professional
              inspection is worth the time even if no damage is visible from ground level.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="faq-3">
            <AccordionTrigger>Will my insurance cover storm damage roof repairs?</AccordionTrigger>
            <AccordionContent>
              Most homeowner insurance policies in Texas cover storm damage including hail, wind,
              and tornado damage, minus your deductible. The key is filing your claim promptly and
              providing thorough documentation. We photograph and document all damage before
              starting any work, provide detailed damage reports that match what insurance adjusters
              need, and can meet with your adjuster on-site to walk through findings together. We
              also file supplemental claims when adjusters miss damage during their initial
              inspection.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="faq-4">
            <AccordionTrigger>
              How do you handle storm damage inspections and scheduling?
            </AccordionTrigger>
            <AccordionContent>
              We schedule storm-damage documentation and inspections across the Panhandle once
              conditions are safe for crews to be on a roof. We are not an emergency-dispatch
              service — we triage based on damage severity and document everything with photos and
              adjuster-ready reports. Inspections are typically scheduled within a few days of a
              major storm event. We never ask homeowners to sign contracts before the inspection is
              complete.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="faq-5">
            <AccordionTrigger>
              What is the difference between wind damage and hail damage repairs?
            </AccordionTrigger>
            <AccordionContent>
              Wind damage typically tears, lifts, or removes shingles and flashing, creating visible
              gaps in the roof surface. Repairs focus on replacing missing components and re-sealing
              lifted edges. Hail damage is more subtle. It creates dents and bruises in shingles
              that compromise the granule layer and accelerate aging, even if no shingles are
              missing. Hail damage often requires full roof replacement because the impact weakens
              shingles across the entire surface, not just in isolated areas. Insurance adjusters
              assess these differently, which is why proper documentation matters.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="faq-6">
            <AccordionTrigger>
              Can storm damage cause hidden problems I cannot see?
            </AccordionTrigger>
            <AccordionContent>
              Yes. Storm damage often creates problems that do not become visible for weeks or
              months. Hail can crack shingles without displacing them, allowing slow moisture
              intrusion that leads to deck rot and mold growth in the attic. Wind-driven rain can
              push water under flashing and into wall cavities. Ice dams from winter storms can
              force water upward under shingles. A professional inspection after any storm checks
              for these hidden issues using both visual assessment and, when needed, moisture
              detection tools.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="faq-7">
            ...
            <AccordionContent>
              Complete storm-proofing is not possible in West Texas, but you can significantly
              reduce your risk. Choose Class 4 impact-resistant shingles rated for 130+ mph winds on
              your next replacement. Keep trees trimmed away from the roof line. Ensure flashing
              around vents, chimneys, and skylights is properly sealed. Schedule annual inspections
              to catch and fix minor wear before it becomes a vulnerability. For commercial
              buildings, ensure rooftop equipment is properly secured and drainage systems are clear
              before storm season.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      ...
      <section className="mt-12 bg-brand-gold text-white p-8 rounded-lg">
        ...
        <p className="mb-6 text-lg">
          Do not let a small leak become a bigger problem. Whether you need a free damage
          inspection, help documenting your claim, or a Class 4 restoration quote, we are here to
          help. Free storm damage inspections for homeowners and businesses across the Texas
          Panhandle.
        </p>
      ...
      <RelatedArticles pageSlug="storm-damage-repair" />
    </div>
  );
}
