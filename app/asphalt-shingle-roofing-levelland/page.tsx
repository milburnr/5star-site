  ...
  return (
    <>      <Breadcrumb items={[
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "description": "Expert asphalt shingle roofing services in Levelland, TX. Free inspections, insurance claim assistance, 24/7 emergency response.",
      ...
      <section
        ...
        style={{
          backgroundImage: 'url(https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/shingle/shingle-levelland-44-1280w.webp)',
