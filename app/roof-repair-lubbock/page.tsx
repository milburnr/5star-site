...
export const metadata: Metadata = {
  title: "Roof Repair Lubbock TX | Expert Service | Free Inspection",
  description: "Professional roof repair in Lubbock TX. Expert installation, 24/7 emergency service, insurance assistance. Free inspections. Call (806) 622-6041",
};
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "description": "Professional roof repair in Lubbock TX. Expert installation, warranties, and insurance assistance."
      }) }} />

      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org",
        "@type": "FAQPage",
        "mainEntity": [{"@type":"Question","name":"How much do roof repairs cost in Lubbock?","acceptedAnswer":{"@type":"Answer","text":"Minor repairs: $300-$800. Moderate damage: $800-$2,500. Extensive repairs: $2,500-$5,000. Many repairs covered by insurance. Free estimates provided."}},{"@type":"Question","name":"Can you repair just part of my roof?","acceptedAnswer":{"@type":"Answer","text":"Yes, if damage is localized. We assess whether spot repairs or full replacement makes more sense based on age, condition, and cost-effectiveness."}},{"@type":"Question","name":"How long do roof repairs last?","acceptedAnswer":{"@type":"Answer","text":"Professional repairs with quality materials last 5-10 years. However, if your roof is over 15 years old, replacement may be more cost-effective."}}]
      }) }} />
        ...
        <div className="container-custom relative z-10">
          <FadeIn>
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-6xl font-bold mb-6 text-white leading-tight">Fast Roof Repair in <span className="text-brand-gold-light">Lubbock</span></h1>
              <p className="text-3xl mb-6 font-bold text-brand-gold-light">Same-Day Service • Insurance Claims • 24/7 Emergency Response</p>
              <p className="text-xl mb-8 text-white leading-relaxed">Professional roof repair throughout Lubbock. Free inspections, comprehensive warranties, and insurance assistance available.</p>
        ...
        <FadeIn>
          <section id="lead-form" className="section -mt-16 relative z-20">
            <div className="max-w-2xl mx-auto">
              <HighLevelForm
                title="Get Your Free Roof Repair Estimate"
                subtitle="Fast Response. Insurance Claims Welcome. Fill out the form and we'll contact you within 24 hours."
              />
            </div>
          </section>
        </FadeIn>
      ...
      <div className="container-custom py-12">
        <FadeIn>
          <section className="mb-16 max-w-5xl mx-auto">
            <h2 className="text-4xl font-bold mb-6 text-brand-brown">Lubbock's Roof Repair Specialists</h2>
            <p className="text-xl text-gray-700 mb-6 leading-relaxed">Professional roof repair throughout Lubbock and surrounding areas. We understand Texas weather challenges and install roofing systems engineered for extreme conditions including hail, high winds, and temperature swings.</p>
          ...
          <section className="mb-16 bg-gradient-to-br from-blue-50 to-white p-12 rounded-3xl shadow-lg">
            ...
            <Accordion type="single" collapsible className="max-w-4xl mx-auto">
              <AccordionItem value="item-1" className="bg-white rounded-xl shadow-sm border border-gray-100 px-6 mb-4">
                <AccordionTrigger className="text-lg font-semibold text-brand-brown hover:text-brand-gold">How much do roof repairs cost in Lubbock?</AccordionTrigger>
        ...
        <section className="bg-gradient-to-r from-brand-brown to-brand-gold text-white p-12 rounded-3xl text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">Free inspections for Lubbock property owners. Expert roof repair with comprehensive warranties and insurance assistance.</p>
