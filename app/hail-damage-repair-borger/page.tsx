...
export const metadata: Metadata = {
  ...
  description: "Professional hail damage roof repair in Borger TX. Fast storm response, insurance assistance. Serving Hutchinson County. Call (806) 622-6041",
  openGraph: {
    title: "Hail Damage Repair Borger TX | 5 Star Roofing",
    description: "Professional hail damage roof repair in Borger TX. Fast storm response, insurance assistance. Serving Hutchinson County. Call (806) 622-6041",
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "name": "5 Star Roofing",
        "image": "https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/completed/completed-wichita-falls-29-1280w.jpg",
        ...
        "description": "Expert hail damage repair services in Borger, TX. Free inspections, insurance claim assistance, prompt response.",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Expert hail damage roof repair services in Borger, TX. prompt response, insurance claim assistance, and Class 4 impact-resistant roof replacements for Hutchinson County properties."
          })
        }}
      />
      ...
      <section
        ...
        style={{
          backgroundImage: 'url(https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/hail-damage/hail-damage-borger-29-1280w.webp)',
