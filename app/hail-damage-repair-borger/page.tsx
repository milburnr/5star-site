...
export const metadata: Metadata = {
  title: 'Hail Damage Repair Borger TX | Hutchinson County Storm Experts | 5 Star Roofing',
  description: "Borger's trusted hail damage repair specialists. 24/7 emergency response, insurance claim assistance, Class 4 impact-resistant shingles. Serving Hutchinson County since 2014. Free inspections. Call (806) 622-6041.",
};
