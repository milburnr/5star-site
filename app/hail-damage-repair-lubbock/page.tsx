          ...
          __html: JSON.stringify({
            ...
            mainEntity: [
              ...
              },
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Class 4 shingles are rated to withstand 2-inch diameter hail strikes under UL 2218 testing. For Lubbock homes facing frequent Tornado Alley storms, Class 4 shingles meet UL 2218 testing for 2-inch hail. Many Texas insurers offer 10-30% premium discounts for Class 4 roofs.",
                },
              },
              {
                "@type": "Question",
        ...
        <section className="container-custom mt-8">
          <div className="max-w-5xl mx-auto bg-amber-50 border-l-4 border-brand-gold rounded-r-2xl p-6">
            ...
            <ul className="space-y-2 text-gray-800 font-medium leading-relaxed">
              <li className="flex gap-2"><span className="text-brand-gold flex-shrink-0">•</span><span>What this page covers: Hail Damage Repair for homes and businesses in Lubbock, Texas.</span></li>
        ...
        <FadeIn>
          <section className="mb-16">
            <h2 className="text-3xl font-bold mb-8 text-center text-brand-brown">
              How Does the Lubbock Hail Damage Repair Process Work?
            </h2>
