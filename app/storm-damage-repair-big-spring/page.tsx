  ...
  return (
    <>      <Breadcrumb items={[
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "name": "5 Star Commercial Roofing - Big Spring Storm Damage Repair",
        ...
        "description": "Expert storm damage repair services in Big Spring, TX. Free inspections, insurance claim assistance, 24/7 emergency response.",
