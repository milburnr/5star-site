      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "Emergency Roof Repair in Monahans",
            "description": "Professional emergency roof repair services in Monahans, Texas. Expert installation, repair, and maintenance with 24/7 emergency response.",
            "provider": {
        ...
        <div className="container-custom relative z-10">
          <FadeIn>
            <div className="max-w-4xl">
              ...
              <p className="text-xl mb-8 text-white leading-relaxed">24/7 emergency roof repair throughout Monahans and Ward County. Located 3 hours south of our Amarillo headquarters, we maintain emergency response partnerships to serve West Texas oil country. Response time typically 2-3 hours depending on crew availability and weather conditions.</p>
