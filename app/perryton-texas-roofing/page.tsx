...
export default function PerrytonRoofingPage() {
  ...
  return (
    <div className="min-h-screen">      <Breadcrumb items={[
      ...
      <section className="hero" style={{backgroundImage: 'url(https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/heroes/perryton-hero.jpg)', backgroundPosition: 'center'}}>
