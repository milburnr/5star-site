    ...
    <>      {/* Sticky Contact Bar */}
      ...
      <section className="auto-linked-related my-8">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            <a href="/blog/certainteed-shingles/" className="text-blue-700 underline">
              What Are CertainTeed Shingles? A Homeowner's Guide
            </a>
          </li>
          {/* auto-link:what-are-architectural-shingles */}
          <li>
            <a href="/blog/what-are-architectural-shingles/" className="text-blue-700 underline">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Expert residential roofing services in Amarillo neighborhoods including Wolflin Historic District, Westcliff, and Vineyards-Hastings. Specializing in Class 4 impact-resistant shingles and hail damage insurance claims.",
        ...
        <section className="container-custom mt-8">
          <div className="max-w-5xl mx-auto bg-amber-50 border-l-4 border-brand-gold rounded-r-2xl p-6">
            ...
            <ul className="space-y-2 text-gray-800 font-medium leading-relaxed">
              <li className="flex gap-2"><span className="text-brand-gold flex-shrink-0">•</span><span>What this page covers: Residential Roofing for homes and businesses in Amarillo, Texas.</span></li>
      ...
      <div className="container-custom py-12">
        <FadeIn>
          <section className="mb-16 max-w-5xl mx-auto">
            ...
            <p className="text-xl text-gray-700 mb-6 leading-relaxed">
              ...
              weather. Amarillo sits in "Hail Alley" with 131 severe hail days recorded since 2000,
              intense UV exposure, temperature extremes from 13°F to 99°F, and sustained winds
              averaging 14.3 mph (highest in Texas). Standard shingles simply don't cut it here—you
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              ...
              of insurance claims paperwork, pull all City of Amarillo permits, secure HOA
              approvals, and deliver expert installation in 1-3 days. Most homeowners pay only their
              deductible when insurance covers hail damage—typically $1,000-$2,500 for a complete
              roof replacement worth $12,000-$18,000.
            </p>
          </section>
        </FadeIn>
        ...
        <FadeIn>
          <section className="mb-16 max-w-5xl mx-auto">
            ...
            <p className="text-lg text-gray-700 mb-8 leading-relaxed">
              We provide expert residential roofing throughout Amarillo's diverse neighborhoods,
              each with unique architectural character and roofing needs:
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-gradient-to-br from-amber-50 to-white p-6 rounded-xl shadow-md border-l-4 border-brand-gold">
                ...
                <p className="text-gray-700 leading-relaxed mb-2">
                  <strong>Median Home Price:</strong> $350,000
                  <br />
                  <strong>Established:</strong> 1920s
                  <br />
                  <strong>Homeownership:</strong> 73.4%
                </p>
                <p className="text-gray-600 text-sm leading-relaxed">
                  South-Central Amarillo's premier historic neighborhood features Tudor cottages,
                  Greek Revival estates, and Mediterranean-inspired homes with original National
                  Register properties. Towering elm trees and brick streets create distinctive
                  character. We've completed 100+ Wolflin projects matching architectural styles
                  while providing modern Class 4 hail protection.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-amber-50 to-white p-6 rounded-xl shadow-md border-l-4 border-brand-gold">
                ...
                <p className="text-gray-700 leading-relaxed mb-2">
                  <strong>Home Prices:</strong> $311K-$1.1M
                  <br />
                  <strong>Location:</strong> Northwest Amarillo
                  <br />
                  <strong>Style:</strong> Mixed Suburban to Luxury
                </p>
                <p className="text-gray-600 text-sm leading-relaxed">
                  Pedestrian-friendly golf cart community with green spaces and tennis courts. Mix
                  of ranch-style and modern homes featuring Spanish, Tudor, and contemporary
                  architecture. Upscale properties require premium roofing systems—we specialize in
                  high-end installations with extended warranties and superior materials.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-amber-50 to-white p-6 rounded-xl shadow-md border-l-4 border-brand-gold">
                ...
                <p className="text-gray-700 leading-relaxed mb-2">
                  <strong>Location:</strong> Northwest Amarillo
                  <br />
                  <strong>Architecture:</strong> Pueblo & Spanish Revival
                  <br />
                  <strong>Near:</strong> Thompson Park, Zoo
                </p>
                <p className="text-gray-600 text-sm leading-relaxed">
                  Distinctive Pueblo design influences and Spanish Revival architecture near
                  Amarillo Zoo and Wonderland Amusement Park. These specialized architectural styles
                  may require clay tile alternatives or Spanish-style shingles. We match existing
                  aesthetics while upgrading to impact-resistant materials engineered for Panhandle
                  hail.
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gradient-to-br from-amber-50 to-white p-8 rounded-xl shadow-lg border-l-4 border-brand-gold">
                <h3 className="text-2xl font-bold text-brand-brown mb-4">
                  Local Texas Panhandle Experts
                </h3>
                <p className="text-gray-700 leading-relaxed">
                  Headquartered at 2909 S Western St in Amarillo—not storm chasers from out of
                  state. We've roofed homes in every neighborhood from historic Wolflin to southwest
                  developments near Bell Helicopter, from Sleepy Hollow to properties along the
                  Historic Route 66 district. We understand Texas Panhandle weather patterns, local
                  HOA requirements, and City of Amarillo building codes. When you need warranty
              ...
              <div className="bg-gradient-to-br from-amber-50 to-white p-8 rounded-xl shadow-lg border-l-4 border-brand-gold">
                <h3 className="text-2xl font-bold text-brand-brown mb-4">
                  Complete Permit & HOA Service
                </h3>
                <p className="text-gray-700 leading-relaxed">
                  We handle all City of Amarillo building permits ($50-150), HOA architectural
                  committee approvals, and code compliance at no extra charge. We stock shingles
                  pre-approved by Wolflin, Sleepy Hollow, Westcliff, and Colonies HOAs. All
                  paperwork, inspections, and final approvals managed seamlessly while you focus on
                  color selection.
                </p>
              </div>
            </div>
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-amber-50 to-white p-8 rounded-xl shadow-lg border-l-4 border-brand-gold-vibrant">
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                All residential roofing projects in Amarillo must comply with local building codes
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-gray-700">
                    <li className="flex items-start gap-1">
                      ...
                      <strong>2015 IRC compliance required</strong>
                    </li>
                    <li className="flex items-start gap-1">
                      <Check className="w-5 h-5 text-brand-gold flex-shrink-0 mt-0.5" />
                    ...
                    <li className="flex items-start gap-1">
                      <Check className="w-5 h-5 text-brand-gold flex-shrink-0 mt-0.5" />
                      Wind resistance: 110-125 mph standards
                    </li>
                    <li className="flex items-start gap-1">
                      <Check className="w-5 h-5 text-brand-gold flex-shrink-0 mt-0.5" />
                      UL 2218 Class 4 highly recommended
                    </li>
                    <li className="flex items-start gap-1">
                      <Check className="w-5 h-5 text-brand-gold flex-shrink-0 mt-0.5" />
                      Permit display visible from street
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <p className="text-gray-600 italic">
                We handle all permit applications at no extra charge, ensuring code compliance and
        ...
        <FadeIn>
          <section className="mb-16 max-w-5xl mx-auto">
            ...
            <p className="text-lg text-gray-700 mb-6 leading-relaxed">
              Potter County's location in the Texas Panhandle creates one of America's most
              challenging roofing environments. Your home must withstand extreme conditions
              year-round:
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-red-50 p-6 rounded-xl shadow-md border-t-4 border-red-600">
                ...
                <p className="text-gray-700 leading-relaxed mb-3">
                  ...
                  hail frequency. Amarillo ranks in the Top 10 most hail-prone cities in America,
                  with 438 hail reports within 10 miles in just 12 months.
                </p>
                <p className="text-gray-600 text-sm">
                  Peak season: March-May with secondary fall peak. Standard shingles fail within 5-7
                  years. Class 4 impact-resistant shingles are essential, not optional.
                </p>
              </div>
              ...
              <div className="bg-amber-50 p-6 rounded-xl shadow-md border-t-4 border-brand-gold-vibrant">
                ...
                <p className="text-gray-700 leading-relaxed mb-3">
                  <strong>14.3 mph average winds</strong> - highest in Texas, #2 in America. At
                  3,600 feet elevation, Amarillo is exposed to clashing air masses causing extreme
                  gusts exceeding 50 mph annually.
                </p>
                <p className="text-gray-600 text-sm">
                  Peak winds March-April. Improper installation causes shingle blow-offs and water
                  infiltration. We use 6-nail pattern and high-wind rated materials.
                </p>
              </div>
              ...
              <div className="bg-amber-50 p-6 rounded-xl shadow-md border-t-4 border-amber-600">
                ...
                <p className="text-gray-700 leading-relaxed mb-3">
                  <strong>86°F temperature swings</strong> - from 13°F winter lows to 99°F summer
                  highs. This constant thermal cycling causes shingle granule loss and premature
                  aging.
                </p>
                <p className="text-gray-600 text-sm">
                  January averages 38.6°F; July averages 79.6°F. Quality underlayment and proper
                  ventilation critical to extend roof lifespan to 20-25 years.
                </p>
              </div>
            </div>
          </section>
            ...
            <Accordion type="single" collapsible className="max-w-4xl mx-auto">
              ...
              >
                ...
                <AccordionContent className="text-gray-700 leading-relaxed">
                  ...
                  However, most Amarillo projects are insurance-covered hail damage claims where
                  homeowners pay only their deductible ($1,000-$2,500). We provide free estimates
                  and maximize insurance coverage to minimize out-of-pocket costs.
                </AccordionContent>
              </AccordionItem>
              ...
              >
                ...
                <AccordionContent className="text-gray-700 leading-relaxed">
                  Yes. The Wolflin Historic District features 1920s-era homes with diverse
                  architectural styles including Tudor cottages, Greek Revival, and Mediterranean
                  designs. While historic designation doesn't restrict roofing materials, we match
                  original roof lines and select shingles that complement each home's architectural
                  character. We've completed 100+ Wolflin roofing projects maintaining neighborhood
                  aesthetics while providing modern hail protection.
                </AccordionContent>
              </AccordionItem>
              ...
              >
                ...
                <AccordionContent className="text-gray-700 leading-relaxed">
                  All residential roofing projects require City of Amarillo building permits per IRC
                  Section 105.1. Contact Building Safety at (806) 378-3041. We handle all permit
                  applications at no extra charge. Requirements include drip edge installation,
                  proper attic ventilation (1 sq ft per 150 sq ft), and wind resistance standards
                  for 110-125 mph design speeds. Permits typically cost $50-150.
                </AccordionContent>
              </AccordionItem>
              ...
              >
                ...
                <AccordionContent className="text-gray-700 leading-relaxed">
                  Most Amarillo homes are completed in 1-3 days depending on size and roof
                  complexity. Single-story homes under 2,000 sq ft take 1-2 days. Two-story homes
                  with steeper pitches require 2-3 days. We work efficiently while maintaining
                  strict quality standards. The insurance claim process typically takes 2-4 weeks
              ...
              >
                ...
                <AccordionContent className="text-gray-700 leading-relaxed">
                  Yes, we serve all Amarillo neighborhoods. We've completed projects throughout the
                  city, from historic Wolflin ($350K median homes) and upscale Westcliff
                  ($311K-$1.1M) to Vineyards-Hastings with Spanish Revival architecture. We're
                  familiar with specific HOA requirements in each area and maintain relationships
                  with local architectural review boards.
                </AccordionContent>
              </AccordionItem>
              ...
              >
                ...
                <AccordionContent className="text-gray-700 leading-relaxed">
                  Absolutely. We handle all HOA architectural committee submissions for
                  neighborhoods like Wolflin, Sleepy Hollow, Westcliff, and The Colonies. We stock
                  pre-approved shingle colors and styles for most Amarillo HOAs and manage the
                  entire approval process, so you don't have to deal with paperwork delays.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </section>
        ...
        <section className="bg-gradient-to-r from-brand-brown to-brand-gold text-white p-12 rounded-3xl text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Free inspections for Amarillo homeowners. Most hail damage repairs covered by
        ...
        <RelatedArticles pageSlug="residential-roofing-amarillo" />
      </div>
    </>
  );
}
