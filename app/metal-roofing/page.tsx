...
export const metadata: Metadata = {
  ...
  description:
    "Metal roofing installation and repair across West Texas. Standing seam, corrugated, and metal shingle options. Call (806) 622-6041 for a free estimate.",
  openGraph: {
    title: "Metal Roofing West Texas | 5 Star Roofing",
    description:
      "Metal roofing installation and repair across West Texas. Standing seam, corrugated, and metal shingle options. Call (806) 622-6041 for a free estimate.",
    ...
    images: [
      {
        url: "https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/metal/metal-plainview-35-1280w.webp",
        width: 1280,
        height: 720,
        alt: "Standing seam metal roof installation on industrial facility in West Texas — 5 Star Roofing",
      },
    ],
    locale: "en_US",
    type: "website",
...
export default function Page() {
  const serviceSchema = {
    ...
    description:
      "Metal roofing installation and repair across West Texas. Standing seam, corrugated, metal shingle, and R-panel systems for residential and commercial buildings.",
    hasOfferCatalog: {
      "@type": "OfferCatalog",
      ...
      itemListElement: [
        {
          "@type": "Offer",
          itemOffered: { "@type": "Service", name: "Standing Seam Metal Roofing" },
        },
...
{/* FAQPage schema removed — faqSchema variable kept as dead code */}
      ...
      <FadeIn>
        <section className="mb-10 max-w-5xl mx-auto bg-amber-50 border-l-4 border-brand-gold rounded-r-2xl p-6">
          ...
          <p className="text-gray-800 font-medium leading-relaxed">
            5 Star Roofing specializes in metal roofing throughout the Texas Panhandle and Permian Basin — R-panel, standing seam, and corrugated metal systems for residential and commercial buildings.
          </p>
          <div className="mt-4 flex flex-wrap gap-4 text-sm">
            <a href="/metal-roofing-amarillo/" className="text-brand-brown font-semibold hover:text-brand-gold transition-colors">Amarillo Metal Roofing</a>
            <a href="/metal-roofing-lubbock/" className="text-brand-brown font-semibold hover:text-brand-gold transition-colors">Lubbock Metal Roofing</a>
            <a href="/metal-roofing-midland/" className="text-brand-brown font-semibold hover:text-brand-gold transition-colors">Midland Metal Roofing</a>
            <a href="/metal-roofing-odessa/" className="text-brand-brown font-semibold hover:text-brand-gold transition-colors">Odessa Metal Roofing</a>
          </div>
        </section>
      </FadeIn>
      ...
      <FadeIn>
        <div className="bg-brand-gold-light p-8 rounded-lg mb-8">
          ...
          <p className="text-lg mb-4">
            Metal roofing has moved from agricultural buildings and commercial warehouses into
            mainstream residential use across West Texas, and the reasons are practical. In a region
            where hail storms, high winds, and extreme heat test every roof, metal outperforms other
            materials on durability, energy efficiency, and long-term cost.
          </p>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
            <div className="bg-white p-4 rounded-lg">
              <h3 className="font-bold text-brand-brown mb-2">40-50 Year Lifespan</h3>
              <p className="text-sm text-gray-600">
                Metal roofs last two to three times longer than asphalt shingles. Many standing seam
                installations from the 1970s and 1980s are still performing across the Panhandle
            ...
            <div className="bg-white p-4 rounded-lg">
              ...
              <p className="text-sm text-gray-600">
                Interlocking standing seam panels resist wind uplift far beyond the 60-70 mph
                threshold where shingle tabs begin to lift. Metal roofing is rated for 140+ mph
                winds in most configurations.
              </p>
            </div>
            <div className="bg-white p-4 rounded-lg">
              <h3 className="font-bold text-brand-brown mb-2">Energy Efficiency</h3>
              <p className="text-sm text-gray-600">
                Reflective metal surfaces bounce solar heat away from the building, reducing cooling
                costs by 20-25% in Texas summers. Light-colored metal roofs with Kynar 500 finishes
                maintain their reflectivity for decades.
              </p>
            </div>
            <div className="bg-white p-4 rounded-lg">
              <h3 className="font-bold text-brand-brown mb-2">Low Maintenance</h3>
              <p className="text-sm text-gray-600">
                No granule loss, no shingle tabs to replace, and no moss or algae growth. The main
                maintenance items are periodic fastener checks and sealant replacement at
                penetrations, typically every 10-15 years.
              </p>
            </div>
          </div>
        </div>
      ...
      <FadeIn>
        ...
        <p className="mb-6">
          We install every major type of metal roofing system, each suited to different buildings,
          budgets, and aesthetic preferences. Here is how they compare.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-2xl hover:scale-105 transition-all duration-300">
            <div className="p-6">
              ...
              <p className="mb-3">
                The highest-performing metal roofing system available. Raised seams with concealed
                fasteners create a clean, modern profile that eliminates the most common failure
                points.
              </p>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-2xl hover:scale-105 transition-all duration-300">
            <div className="p-6">
              ...
              <p className="mb-3">
                A proven, economical option with decades of performance history across Texas. The
                classic ribbed profile works on everything from homes and barns to commercial
                storage buildings.
              </p>
              <ul className="list-disc list-inside space-y-1 text-gray-600">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-2xl hover:scale-105 transition-all duration-300">
            <div className="p-6">
              ...
              <p className="mb-3">
                Metal panels stamped to replicate the appearance of traditional shingles, slate, or
                wood shake. Ideal for homeowners who want metal durability without changing their
                home&apos;s curb appeal.
              </p>
              <ul className="list-disc list-inside space-y-1 text-gray-600">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-2xl hover:scale-105 transition-all duration-300">
            <div className="p-6">
              ...
              <p className="mb-3">
                The workhorse of commercial and agricultural metal roofing. R-panel systems offer
                reliable, economical performance for large-area coverage.
              </p>
              <ul className="list-disc list-inside space-y-1 text-gray-600">
          ...
          <table className="w-full bg-white rounded-lg shadow">
            ...
            <tbody>
              <tr className="border-b">
                ...
                <td className="p-4">
                  Concealed fasteners, best wind/hail performance, modern look
                </td>
      ...
      <FadeIn>
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-8">
          <p className="mb-4">
            Commercial metal roofing is one of our core specialties. From Permian Basin warehouses
            to Panhandle retail centers, metal roofing systems deliver the durability and low
            maintenance that building owners and facility managers need.
          </p>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 text-gray-600 text-sm">
                <li>
                  <strong>Warehouses:</strong> R-panel and corrugated for large footprints at low
                  cost per square foot
                </li>
                <li>
                  <strong>Retail:</strong> Standing seam for modern appearance and concealed
                  fasteners
                </li>
                <li>
                  <strong>Agricultural:</strong> Corrugated and R-panel for barns, equipment sheds,
                  and livestock facilities
                </li>
                <li>
                  <strong>Flat-to-low-slope:</strong> Standing seam with proper slope (minimum
                  1/4:12) and sealant at laps
                </li>
              </ul>
            </div>
            <div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-600 mb-3">
              Metal roofs require less repair than other systems, but they are not maintenance-free.
              The most common issues we address include:
            </p>
            <ul className="list-disc list-inside space-y-1 text-gray-600 text-sm">
              <li>
                <strong>Fastener tightening:</strong> Exposed fasteners loosen over time from
                thermal cycling and can allow water entry
              </li>
              <li>
                <strong>Sealant replacement:</strong> Butyl tape and caulk at laps, penetrations,
                and transitions deteriorate after 10-15 years
              </li>
              <li>
                <strong>Panel repair:</strong> Isolated dents from large hail or fallen branches can
                sometimes be repaired without full panel replacement
              </li>
              <li>
                <strong>Rust treatment:</strong> Edge cuts, scratches, and fastener points on steel
                panels may develop rust spots that need treatment
              </li>
            </ul>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-600 mb-3">
              After 20-30 years, metal roof coatings can be refreshed to extend the system&apos;s
              life by another 10-15 years at a fraction of the replacement cost.
            </p>
            <ul className="list-disc list-inside space-y-1 text-gray-600 text-sm">
      ...
      <FadeIn>
        <section className="mb-16">
          ...
          <p className="mb-4">
            We install and repair metal roofing systems for homes and businesses throughout the
            Texas Panhandle, Permian Basin, and South Plains. Select your city for local details.
          </p>
          <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-4">
            {cities.map((city) => (
              ...
              >
                <span className="font-semibold text-brand-brown">Metal Roofing in {city.name}</span>
              </a>
            ))}
          </div>
        </section>
      ...
      <section>
        ...
        <Accordion type="single" collapsible>
          <AccordionItem value="faq-1">
            ...
            <AccordionContent>
              A properly installed metal roof in West Texas lasts 40-50 years, and some standing
              seam systems exceed 60 years with minimal maintenance. This is roughly double the
              lifespan of asphalt shingles in the same climate. Metal handles the region&apos;s
              intense UV exposure, temperature extremes (from below freezing to over 110 degrees),
              and high winds far better than asphalt or composite materials. The main maintenance
              items are periodic fastener checks and sealant replacement at penetrations, typically
              every 10-15 years.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="faq-2">
            <AccordionTrigger>
              Are metal roofs louder than shingle roofs during rain and hail?
            </AccordionTrigger>
            <AccordionContent>
              Modern metal roof installations are no louder than shingle roofs when properly
              installed with solid decking and underlayment beneath the panels. The metal sits on
              top of plywood sheathing and synthetic underlayment, which dampens sound effectively.
              Metal roofs installed directly over open purlins (common on older barns and
              agricultural buildings) are louder, but residential and commercial installations over
              solid deck are comparable to any other roofing material in terms of interior noise.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="faq-3">
            ...
            <AccordionContent>
              Metal roofing typically costs $9-$14 per square foot installed for standing seam and
              $6-$9 per square foot for corrugated or R-panel systems. Compare that to $4.50-$6.50
              per square foot for quality architectural shingles. For a 2,000-square-foot home, that
              means $18,000-$28,000 for standing seam metal versus $9,000-$13,000 for shingles.
              However, when you factor in the 40-50 year metal lifespan versus 20-25 years for
              shingles, plus lower cooling costs and insurance discounts, metal often costs less per
              year of service.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="faq-4">
            ...
            <AccordionContent>
              In many cases, yes. Metal roofing can be installed over one layer of existing asphalt
              shingles using a batten or furring strip system that creates an air gap between the
              old shingles and the new metal. This approach saves on tear-off and disposal costs and
              can reduce the project cost by $1,000-$3,000. However, it only works if the existing
              deck is in sound condition and local building codes permit it. We inspect the existing
              roof structure before recommending an overlay versus a full tear-off.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="faq-5">
            <AccordionTrigger>Do metal roofs attract lightning?</AccordionTrigger>
            <AccordionContent>
              No. Metal roofing does not attract lightning any more than other roofing materials.
              Lightning strikes the highest point in an area regardless of material. In fact, metal
              roofing is one of the safest options during a lightning storm because it is
              non-combustible. If lightning does strike a metal roof, the energy disperses across
              the surface rather than concentrating at the impact point. Metal roofs carry the same
              lightning risk as asphalt, tile, or wood roofs on the same structure.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="faq-6">
            ...
            <AccordionContent>
              Metal roofing is available in virtually any color you can imagine, from traditional
              earth tones and grays to bold reds, blues, and greens. Kynar 500 (PVDF) paint finishes
              resist fading for 30+ years. Style options include standing seam (clean, modern
              lines), corrugated (classic agricultural look), metal shingles (mimicking traditional
              shingle or slate appearance), and R-panel (economical ribbed profile for commercial
              use). We bring color samples and style guides to every estimate appointment.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="faq-7">
            <AccordionTrigger>
              Is metal roofing a good choice for flat commercial buildings?
            </AccordionTrigger>
            <AccordionContent>
              Metal roofing works well on low-slope commercial buildings when the slope meets
              minimum requirements, typically 1/4:12 or greater for standing seam systems with
              proper sealant. R-panel and standing seam are common on commercial warehouses, retail
              buildings, and agricultural structures throughout West Texas. For true flat roofs with
              slopes below 1/4:12, TPO or EPDM membrane systems are generally more appropriate. We
              assess your building&apos;s slope and recommend the best system for the specific
              application.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      ...
      <section className="mt-12 bg-brand-gold text-white p-8 rounded-lg">
        ...
        <p className="mb-6 text-lg">
          Whether you are building new, replacing an aging roof, or exploring metal as an upgrade
          from shingles, we provide honest comparisons and transparent pricing. Call us or schedule
