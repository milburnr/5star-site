      ...
      >
        ...
        <FadeIn>
          <div className="hero-content">
            <h1 className="hero-title">Dumas Roofing Services for Moore County Ag &amp; Industrial</h1>
            <p className="hero-subtitle">
              Metal-building expertise for beef-plant facilities, feedlots, and residential storm recovery
            </p>
