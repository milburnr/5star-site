      ...
      >
        ...
        <FadeIn>
          <div className="hero-content">
            <h1 className="hero-title">Dumas Roofing Contractor You Can Count On</h1>
            <p className="hero-subtitle">
              Moore County Hail Damage Experts &amp; Complete Roofing Services
            </p>
          ...
          <section className="section">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-6 text-center">
                Your Trusted Roofing Partner in Dumas, Texas
              </h2>
