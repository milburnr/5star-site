...
export const metadata: Metadata = {
  ...
  description: "Professional asphalt shingle installation in Lubbock TX. Wind-rated systems for South Plains weather. Class 4 hail protection. Call (806) 622-6041",
  openGraph: {
    title: "Asphalt Shingle Roofing Lubbock TX | 5 Star Roofing",
    description: "Professional asphalt shingle installation in Lubbock TX. Wind-rated systems for South Plains weather. Class 4 hail protection. Call (806) 622-6041",
        ...
        <section className="py-16 bg-gradient-to-b from-amber-50 to-white">
          <div className="container-custom">
            <div className="grid md:grid-cols-4 gap-8 text-center">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg"><div className="text-3xl mb-3"><Tornado className="w-6 h-6 inline-block" /></div><div className="text-brand-brown font-semibold text-lg">Storm Specialists</div></div>
            </div>
          </div>
        </section>
      </FadeIn>
