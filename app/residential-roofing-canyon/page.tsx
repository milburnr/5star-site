      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Professional residential roofing services in Canyon, Texas. Expert installation, repair, and maintenance with 24/7 emergency response.",
            "provider": {
        ...
        <div className="container-custom relative z-10">
          <FadeIn>
            <div className="max-w-4xl">
              ...
              <p className="text-xl mb-8 text-white leading-relaxed">Professional residential roofing serving Canyon and Randall County. Expert protection for university families, faculty, and local residents with comprehensive warranties and 24/7 emergency service near West Texas A&M University.</p>
