  ...
  return (
    <>      <Breadcrumb items={[
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "description": "Expert storm damage repair services in Dumas, TX. Free inspections, insurance claim assistance, 24/7 emergency response.",
            ...
            <Accordion type="single" collapsible className="max-w-4xl mx-auto">
              <AccordionItem value="item-1" className="bg-white rounded-xl shadow-sm border border-gray-100 px-6 mb-4">
                ...
                <AccordionContent className="text-gray-700 leading-relaxed">
                  We maintain 24/7 emergency teams throughout the Texas Panhandle including Dumas with 2-4 hour response times for critical situations. During major storm events affecting the region, we mobilize additional crews to handle high call volumes. Emergency tarping and temporary repairs are typically completed same-day or next-day depending on severity and weather conditions.
                </AccordionContent>
              </AccordionItem>
