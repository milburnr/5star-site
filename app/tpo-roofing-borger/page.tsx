      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Expert tpo roofing services in Borger, TX. Free inspections, insurance claim assistance, prompt response.",
          ...
          <FadeIn>
            <div className="max-w-4xl">
              ...
              <p className="text-xl mb-8 text-white leading-relaxed">
                Expert tpo roofing in Borger TX. Texas Panhandle experiences 7-9 hailstorms
                annually. Refinery town. Free inspections. Call (806) 622-6041
              </p>
