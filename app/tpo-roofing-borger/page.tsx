  ...
  return (
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Expert tpo roofing services in Borger, TX. Free inspections, insurance claim assistance",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Expert TPO roofing in Borger TX. Texas Panhandle refinery town experiences 7-9 hailstorms annually. Energy-efficient commercial systems.",
          }),
        }}
      />
      <script
    ...
    />
        ...
        <section className="container-custom mt-8">
          <div className="max-w-5xl mx-auto bg-amber-50 border-l-4 border-brand-gold rounded-r-2xl p-6">
            ...
            <ul className="space-y-2 text-gray-800 font-medium leading-relaxed">
              <li className="flex gap-2"><span className="text-brand-gold flex-shrink-0">•</span><span>What this page covers: TPO Roofing for homes and businesses in Borger, Texas.</span></li>
      ...
      <div className="container-custom py-12">
        ...
        <FadeIn>
          <section className="mb-16 max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="bg-white p-8 rounded-2xl shadow-lg border">
                <h3 className="text-2xl font-bold mb-4 text-brand-brown">
                  <BarChart3 className="w-6 h-6 inline-block" /> Commercial Performance
                </h3>
                <ul className="text-lg text-gray-700 space-y-3">
                  <li className="flex items-start gap-1">
                    <Check className="w-5 h-5 text-brand-gold flex-shrink-0 mt-0.5" />
                    20-30 year lifespan in Panhandle weather
                  </li>
                  <li className="flex items-start gap-1">
                    <Check className="w-5 h-5 text-brand-gold flex-shrink-0 mt-0.5" />
                    Class A fire resistance for industrial zones
                  </li>
                  <li className="flex items-start gap-1">
                    <Check className="w-5 h-5 text-brand-gold flex-shrink-0 mt-0.5" />
                  ...
                  <li className="flex items-start gap-1">
                    <Check className="w-5 h-5 text-brand-gold flex-shrink-0 mt-0.5" />
                    Energy savings up to 30% annually
                  </li>
                  <li className="flex items-start gap-1">
                    <Check className="w-5 h-5 text-brand-gold flex-shrink-0 mt-0.5" />
                    OSHA-compliant walkways available
                  </li>
                </ul>
              </div>
              <div className="bg-white p-8 rounded-2xl shadow-lg border">
                <h3 className="text-2xl font-bold mb-4 text-brand-brown">
                  <Factory className="w-6 h-6 inline-block" /> Industrial Applications
                </h3>
                <ul className="text-lg text-gray-700 space-y-3">
                  <li className="flex items-start gap-1">
                    <Check className="w-5 h-5 text-brand-gold flex-shrink-0 mt-0.5" />
            ...
            <div className="bg-gradient-to-r from-amber-50 to-white p-8 rounded-2xl">
              <h3 className="text-2xl font-bold mb-4 text-brand-brown">
                Borger's Commercial Roofing Challenges
              </h3>
              <p className="text-lg text-gray-700 mb-4">
                Borger's unique industrial environment creates specific roofing demands. The city's
                petrochemical operations, combined with Texas Panhandle weather extremes, require
                roofing systems that can withstand chemical exposure, extreme temperature
                fluctuations, and severe weather events including frequent hailstorms and high
                winds.
              </p>
              <p className="text-lg text-gray-700">
                TPO roofing excels in these conditions due to its chemical resistance, UV stability,
                and proven performance in industrial environments. Our commercial-grade TPO systems
                are specifically designed for Borger's challenging climate and industrial
                atmosphere.
              </p>
            </div>
          </section>
            ...
            <div className="grid md:grid-cols-1 gap-6">
              <div className="bg-white p-6 rounded-xl shadow-lg border">
                ...
                <p className="text-gray-700 mb-3">
                  Complete building analysis including structural capacity evaluation, existing roof
                  condition assessment, and energy efficiency analysis. We coordinate with Borger
                  building officials to ensure all permits are secured before work begins.
                </p>
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg border">
                <h3 className="text-xl font-bold mb-3 text-brand-brown">
                  Phase 2: Deck Preparation & Insulation
                </h3>
                <p className="text-gray-700 mb-3">
                  Professional deck preparation ensures optimal TPO performance. Our team installs
                  high-R-value insulation systems designed for Borger's extreme temperature
                  variations, maximizing energy efficiency for commercial operations.
                </p>
                <ul className="text-gray-600 space-y-1 ml-4">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg border">
                <h3 className="text-xl font-bold mb-3 text-brand-brown">
                  Phase 3: TPO Membrane Installation
                </h3>
                <p className="text-gray-700 mb-3">
                  Heat-welded TPO installation using commercial-grade equipment. Our certified
                  installers ensure every seam meets manufacturer specifications for maximum
                  durability in Borger's challenging industrial environment.
                </p>
                <ul className="text-gray-600 space-y-1 ml-4">
            ...
            <div className="bg-gradient-to-br from-amber-50 to-orange-50 p-8 rounded-2xl mb-8">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="bg-white p-6 rounded-xl shadow">
                  ...
                  <p className="text-gray-700">
                    Continuous insulation layer eliminates thermal bridging, maintaining consistent
                ...
                <div className="bg-white p-6 rounded-xl shadow">
                  ...
                  <p className="text-gray-700">
                    Energy-efficient TPO systems qualify for local utility rebates and federal tax
                    credits.
                  </p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-gray-700 mb-4">
                    Borger experiences 7-9 hailstorms annually. Our reinforced TPO systems with
                    impact-resistant membranes (60-80 mil thickness) provide superior protection
                    against hail damage.
                  </p>
                ...
                <div>
                  ...
                  <p className="text-gray-700 mb-4">
                    Texas Panhandle winds regularly exceed 60 mph. Our TPO systems are engineered
                    for UL-580 Class 90 wind uplift resistance, ensuring membrane security during
                    severe weather.
                  </p>
                  <ul className="text-gray-600 space-y-1">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="border-l-4 border-brand-gold pl-4">
                      ...
                      <p className="text-gray-700">
                        Spring and fall inspections identify potential issues before they become
                        costly problems.
                      </p>
                    </div>
                    <div className="border-l-4 border-brand-gold pl-4">
                      ...
                      <p className="text-gray-700">
                        Immediate inspection after hailstorms or severe wind events to document any
                    ...
                    <div className="border-l-4 border-brand-gold pl-4">
                      ...
                      <p className="text-gray-700">
                        Annual cleaning maintains reflectivity and extends membrane life in Borger's
                        dusty environment.
                      </p>
                    </div>
                  </div>
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                ...
                <AccordionContent className="text-lg text-gray-700 leading-relaxed">
                  TPO roofing excels in Borger's Texas Panhandle climate due to its white reflective
                  ...
                  seams create watertight bonds critical for Borger's severe weather and industrial
                  environment.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-2">
                ...
                <AccordionContent className="text-lg text-gray-700 leading-relaxed">
                  Quality TPO roofing systems typically last 20-30 years in Borger when properly
                  installed and maintained. The Texas Panhandle's intense sun, temperature
                  fluctuations, and industrial environment can stress roofing materials, but TPO's
              ...
              <AccordionItem value="item-3">
                ...
                <AccordionContent className="text-lg text-gray-700 leading-relaxed">
                  ...
                  Borger's hot climate. The membrane reflects sunlight and heat, keeping building
                  interiors cooler. Many Borger commercial property owners see 20-30% reductions in
              ...
              <AccordionItem value="item-4">
                ...
                <AccordionContent className="text-lg text-gray-700 leading-relaxed">
                  TPO roofing in Borger typically costs $4-8 per square foot installed, depending on
                  ...
                  estimates for Borger commercial properties.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-5">
                ...
                <AccordionContent className="text-lg text-gray-700 leading-relaxed">
                  ...
                  provides excellent hail resistance for Borger's 7-9 annual hailstorms. TPO's
        ...
        <InternalLinks currentCity="borger" currentService="tpo-roofing" />

        <section className="bg-gradient-to-r from-brand-brown to-brand-gold text-white p-12 rounded-3xl text-center">
          <h2 className="text-4xl font-bold mb-6">Ready to Protect Your Borger Property?</h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Free inspections for Borger property owners. Expert tpo roofing with comprehensive
        ...
        <RelatedArticles pageSlug="tpo-roofing-borger" />
      </div>
    </>
  );
}
