...
export const metadata: Metadata = {
  ...
  description: "Expert residential roofing in Lubbock TX. Specializing in hail damage claims and Class 4 impact-resistant shingles. Free inspections. Call (806) 622-6041",
};
          ...
          <FadeIn>
            <div className="max-w-4xl">
              ...
              <p className="text-xl mb-8 text-white leading-relaxed">
                Expert residential roofing in Lubbock. Class 4 impact-resistant shingles reduce future damage by 90%. Free inspections and insurance claim assistance included.
              </p>
      ...
      <div className="container-custom py-12">
        <FadeIn>
          <section className="mb-16 max-w-5xl mx-auto">
            <h2 className="text-4xl font-bold mb-6 text-brand-brown">
              Lubbock's Residential Roofing Specialists
            </h2>
            <p className="text-xl text-gray-700 mb-6 leading-relaxed">
              Expert residential roofing in Lubbock. Class 4 impact-resistant shingles reduce future damage by 90%. Free inspections and insurance claim assistance included.
            </p>
            <p className="text-lg text-gray-600 leading-relaxed">
              Since 2014, we've served Lubbock with expert residential roofing. We handle all permits, insurance claims, and warranty documentation. Free inspections and estimates available.
            </p>
          </section>
        </FadeIn>
        ...
        <section className="bg-gradient-to-r from-brand-brown to-brand-gold text-white p-12 rounded-3xl text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Free inspections for Lubbock property owners. Expert residential roofing with comprehensive warranties.
          </p>
