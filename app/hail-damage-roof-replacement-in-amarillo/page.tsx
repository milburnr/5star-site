  ...
  return (
    <div className="container-custom py-12">      <Breadcrumb items={[
      ...
      <div className="content-block">
        ...
        <p className="text-lg">
          When <a href="/roofing-amarillo-tx/" className="text-brand-gold hover:underline">Amarillo hailstorms</a> cause extensive damage, a complete <a href="/roof-replacement-amarillo/" className="text-brand-gold hover:underline">roof replacement</a> is often the only solution. The good news? Most homeowners insurance policies in the Texas Panhandle cover <a href="/hail-damage-repair-amarillo/" className="text-brand-gold hover:underline">hail damage</a>. We work directly with all major insurance companies to maximize your coverage. We've helped thousands of Amarillo homeowners navigate the insurance process and get brand new roofs at little to no out-of-pocket cost.
        </p>
      </div>
        ...
        <section className="mb-16">
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <img src="https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/hail-damage/hail-damage-perryton-20-1280w.jpg" alt="Hail damage roof repair in Amarillo, TX - Class 4 impact-resistant asphalt shingles - Hail protection roofing - 5 Star Commercial Roofing" className="w-full h-64 object-cover rounded-lg mb-6" />
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <img src="/images/SteelRoofing-1280w.jpg" alt="Standing seam metal roof - Ultimate hail protection - Ultimate hail protection - 5 Star Commercial Roofing" className="w-full h-64 object-cover rounded-lg mb-6" />
