...
export const metadata: Metadata = {
  ...
  description: "Professional roof inspections in Midland TX. Expert installation, repair & insurance assistance. Free inspections. Call (806) 622-6041",
  openGraph: {
    title: "Roof Inspections Midland TX | 5 Star Roofing",
    description: "Professional roof inspections in Midland TX. Expert installation, repair & insurance assistance. Free inspections. Call (806) 622-6041",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Professional roof inspections services in Midland, Texas. Expert installation, repair, and maintenance with prompt response.",
            "provider": {
              "@type": ["LocalBusiness", "RoofingContractor"],
              "name": "5 Star Roofing",
              "telephone": "(806) 622-6041",
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg">
                ...
                <div className="mt-4 p-4 bg-amber-100 rounded-lg">
                  <p className="text-sm text-brand-brown"><strong>Timing Advantage:</strong> Contractor availability improves as summer work demand decreases.</p>
                </div>
              </div>
              <div className="bg-white p-8 rounded-2xl shadow-lg">
