  ...
  return (
    <div className="container-custom py-12">      <Breadcrumb items={[
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "name": "5 Star Roofing",
        "image": "https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/commercial/commercial-pampa-7-1280w.jpg",
        "telephone": "(806) 622-6041",
        "email": "admin@5starroofingpros.com",
        "priceRange": "$",
      ...
      <div className="content-block">
        ...
        <p className="text-lg">
          Asphalt-based flat roofing systems—including built-up roofing (BUR) and modified bitumen—are common on older <a href="/commercial-roofing-amarillo/" className="text-brand-gold hover:underline">commercial buildings</a> in <a href="/amarillo-texas-roofing/" className="text-brand-gold hover:underline">Amarillo</a>, <a href="/midland-tx-roofing/" className="text-brand-gold hover:underline">Midland</a>, <a href="/odessa-tx-roofing/" className="text-brand-gold hover:underline">Odessa</a>, and throughout West Texas. While these systems are durable, they require proper maintenance and timely <a href="/roof-repair-amarillo/" className="text-brand-gold hover:underline">repairs</a> to prevent leaks and extend their lifespan in our harsh climate where <a href="/hail-damage-repair-amarillo/" className="text-brand-gold hover:underline">hailstorms</a> occur 6-12 times annually.
        </p>
...
<section className="bg-gray-50 rounded-lg p-6 mb-8">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          ...
          <a href="/canyon-texas-roofing/" className="text-brand-gold hover:underline">• Canyon Flat Roofing</a>
