...
export const metadata: Metadata = {
  ...
  description:
    "Roofing services in Pampa, Texas Panhandle. Commercial, residential, and storm roofing. Serving Gray County. Free inspections available.",
  openGraph: {
    title: "Roofing Pampa, TX | Hail Damage Specialists | 5 Star Roofing",
    description:
      "Roofing services in Pampa, Texas Panhandle. Commercial, residential, and storm roofing. Serving Gray County. Free inspections available.",
...
export default function PampaRoofingPage() {
  const schema = {
    ...
    description:
      "Professional roofing contractor serving Pampa, Texas and Gray County with commercial, residential, emergency roofing, and specialized chemical plant and industrial facility roofing solutions.",
    url: "https://5starroofingpros.com/pampa-texas-roofing/",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Specialized roofing for chemical manufacturing facilities including Celanese Corporation and Cabot Corporation with chemical-resistant materials",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Industrial roofing for oil and gas facilities, manufacturing plants, and heavy industry with specialized materials",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Commercial roofing services for Pampa businesses and Gray County facilities",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Residential roof repair and replacement for Pampa homes with impact-resistant and pollution-resistant materials",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            "@type": "Service",
            description:
              "storm damage roof repair services for residential and industrial facilities in Gray County",
          },
        },
      ],
    },
      ...
      <div className="container-custom py-12">
        <FadeIn>
          <section className="content-block">
            ...
            <p className="text-lg mb-4">
              ...
              the entire Texas Panhandle. Whether you need commercial roofing for Pampa's chemical
              plants, residential roofing for your home, or storm damage repairs, our expert team
              delivers reliable, high-quality roofing solutions.
            </p>
            <p className="text-lg mb-4">
              Pampa's climate—with severe hailstorms, high winds, and extreme temperature
              swings—combined with the city's industrial base demands roofing systems built to
              withstand the harshest conditions and chemical exposure. We specialize in{" "}
              <a href="/hail-damage-repair-amarillo/" className="text-brand-gold hover:underline">
                hail-resistant roofing materials
              </a>{" "}
              and chemical-resistant roofing systems proven to protect Gray County properties year
              after year.
            </p>
          </section>
        </FadeIn>
        ...
        <FadeIn>
          <section className="content-block mb-12">
            <h2 className="text-2xl font-bold mb-6">
              About Pampa: Industrial Heart of Gray County
            </h2>
            <div className="grid md:grid-cols-2 gap-8 mb-6">
              <div>
                ...
                <ul className="space-y-2">
                  <li>
                    <strong>Population:</strong> 16,867 (2020 census)
                  </li>
                  <li>
                    <strong>County:</strong> Gray County (County Seat)
                  </li>
                  <li>
                    <strong>Distance from Amarillo:</strong> 55 miles northeast
                  </li>
                  <li>
                    <strong>Founded:</strong> 1902 (incorporated 1912)
                  </li>
                  <li>
                    <strong>Named After:</strong> Quechua word "pampa" meaning "plain"
                  </li>
                  <li>
                    <strong>Economic Base:</strong> Chemical manufacturing, oil/gas, agriculture
                  </li>
                </ul>
              </div>
              <div>
                ...
                <p className="text-gray-600 mb-4">
                  Pampa's economy transformed from agriculture to industry following the
                  Worley-Reynolds #1 oil well discovery that launched the local oil boom. Today,
                  major chemical manufacturers like Celanese Corporation and Cabot Corporation
                  anchor the city's industrial base.
                </p>
                <p className="text-gray-600">
                  The city's strategic location and access to petroleum feedstocks made it a natural
                  hub for petrochemical manufacturing, creating a robust industrial economy that
                  requires specialized commercial and industrial roofing solutions.
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-6">
              <div className="bg-gray-50 p-4 rounded">
                ...
                <p className="text-sm text-gray-600">
                  Major petrochemical manufacturer producing synthetic fibers, plastics, and
                  industrial chemicals requiring specialized chemical-resistant roofing
                </p>
              </div>
              <div className="bg-gray-50 p-4 rounded">
                <h4 className="font-bold text-brand-brown mb-2">Cabot Corporation</h4>
                <p className="text-sm text-gray-600">
                  Carbon black manufacturing facility producing essential petroleum byproducts for
                  tires and inks, operating since 1927
                </p>
              </div>
              <div className="bg-gray-50 p-4 rounded">
                <h4 className="font-bold text-brand-brown mb-2">National Oilwell Varco</h4>
                <p className="text-sm text-gray-600">
                  Oilfield equipment manufacturing requiring large-span industrial roofing for
              ...
              <div className="bg-gray-50 p-4 rounded">
                ...
                <p className="text-sm text-gray-600">
                  Multiple petroleum companies including Phillips, Shell, and Kerr-McGee with
                  facilities requiring specialized industrial roofing
                </p>
              </div>
              <div className="bg-gray-50 p-4 rounded">
                <h4 className="font-bold text-brand-brown mb-2">Gray County Government</h4>
                <p className="text-sm text-gray-600">
                  County courthouse, offices, and municipal facilities needing durable commercial
                  roofing systems
                </p>
              </div>
              <div className="bg-gray-50 p-4 rounded">
                ...
                <p className="text-sm text-gray-600">
                  Educational facilities requiring institutional-grade roofing systems for
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-gray-600 mb-3">
                  The massive chemical manufacturing complex housing Celanese, Cabot, and other
                  industrial facilities. These properties require specialized roofing systems
                  designed to handle chemical exposure, high temperatures, and industrial processes
                  while meeting strict safety and environmental regulations.
                </p>
              </div>
              <div>
                <h4 className="font-bold mb-2">Downtown Pampa</h4>
                <p className="text-gray-600 mb-3">
                  The historic city center and county courthouse area, featuring commercial
                  buildings and government facilities that need reliable commercial roofing systems
                  capable of protecting valuable records and providing long-term durability for
                  public buildings.
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-600 mb-3">
                  Family neighborhoods throughout Pampa where chemical plant workers, oil field
                  employees, and local professionals live. These homes require impact-resistant
                  roofing systems that can protect families and property from severe Texas Panhandle
                  weather.
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-600 mb-3">
                  Agricultural and oil field properties throughout Gray County, including ranches,
                  farms, and petroleum operations that require large metal building roofing,
                  equipment storage facilities, and agricultural building systems designed for
            ...
            <FadeIn delay={0.1}>
              <div className="card-hover p-6">
                ...
                <p className="text-gray-600 mb-4">
                  ...
                  facilities throughout Gray County.
                </p>
            ...
            <FadeIn delay={0.2}>
              <div className="card-hover p-6">
                ...
                <p className="text-gray-600 mb-4">
                  ...
                  services for Pampa homeowners. Our Class 4 impact-resistant shingles protect
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h3 className="font-bold text-lg mb-2">
                  <Check className="w-5 h-5 text-brand-gold inline-block" /> Gray County Experts
                </h3>
                <p className="text-gray-600">
                  We understand Pampa's weather patterns, from spring hailstorms to winter freezes.
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Serving Pampa and communities throughout the Texas Panhandle with specialized
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Every Pampa property receives a complimentary roof inspection with detailed
        ...
        <FadeIn>
          <section className="content-block mb-12">
            ...
            <p className="text-lg mb-4">
              While we're proud to serve Pampa and Gray County, our roofing expertise extends across
              the entire region:
            </p>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-700">
                  We inspect your Pampa property, document damage with photos, and provide a
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-700">
                  ...
                  residential roofs in Pampa are completed in 1-2 days.
                </p>
              </div>
            </div>
            <div className="flex items-start">
        ...
        <section className="content-block mb-12">
          <h2 className="text-2xl font-bold mb-6">
            Specialized Roofing Solutions for Pampa's Industrial Base
          </h2>

          <h3 className="text-xl font-bold mb-4 text-brand-brown">
            Chemical Manufacturing Facility Roofing
          </h3>
          <p className="text-lg mb-4">
            Pampa's chemical plants, including Celanese Corporation and Cabot Corporation, require
            specialized roofing systems designed for chemical manufacturing environments:
          </p>
          <ul className="space-y-2 mb-6">
            <li className="flex items-start">
              <span className="text-brand-gold mr-2">▸</span>
              <div>
                <strong>Chemical-Resistant Membranes:</strong> TPO, EPDM, and specialty coatings
                designed to withstand chemical exposure and emissions
              </div>
            </li>
            <li className="flex items-start">
              <span className="text-brand-gold mr-2">▸</span>
              <div>
                <strong>High-Temperature Performance:</strong> Roofing systems rated for extreme
                heat generated by industrial processes
              </div>
            </li>
            <li className="flex items-start">
              <span className="text-brand-gold mr-2">▸</span>
              <div>
                <strong>Vapor Barrier Protection:</strong> Advanced systems preventing chemical
                vapors from compromising structural integrity
              </div>
            </li>
            <li className="flex items-start">
              <span className="text-brand-gold mr-2">▸</span>
              <div>
                <strong>Environmental Compliance:</strong> Roofing solutions that meet EPA and OSHA
          ...
          <p className="text-lg mb-4">
            Pampa's petroleum industry facilities require rugged roofing systems capable of handling
            oil field and processing environments:
          </p>
          <ul className="space-y-2 mb-6">
            <li className="flex items-start">
              <span className="text-brand-gold mr-2">▸</span>
              <div>
                <strong>Hydrocarbon-Resistant Systems:</strong> Roofing materials specifically
                designed for petroleum exposure
              </div>
            </li>
            <li className="flex items-start">
              <span className="text-brand-gold mr-2">▸</span>
              <div>
                <strong>Large-Span Coverage:</strong> Metal and membrane systems for equipment
            ...
            <li className="flex items-start">
              <span className="text-brand-gold mr-2">▸</span>
              <div>
                <strong>Fire-Resistant Materials:</strong> Class A fire-rated roofing for enhanced
                safety in petroleum environments
              </div>
            </li>
            <li className="flex items-start">
              <span className="text-brand-gold mr-2">▸</span>
              <div>
                <strong>Explosion-Resistant Design:</strong> Engineered systems that can handle
                pressure differentials safely
              </div>
            </li>
          </ul>

          <h3 className="text-xl font-bold mb-4 text-brand-brown">
            Residential & Community Roofing
          </h3>
          <p className="text-lg mb-4">
            For Pampa's families and community buildings, we provide roofing solutions that handle
            both weather extremes and the unique challenges of living in an industrial town:
          </p>
          <ul className="space-y-2 mb-6">
            <li className="flex items-start">
              <span className="text-brand-gold mr-2">▸</span>
              <div>
                <strong>Impact-Resistant Shingles:</strong> Class 4 rated materials for maximum hail
                protection
              </div>
            </li>
            <li className="flex items-start">
              <span className="text-brand-gold mr-2">▸</span>
              <div>
                <strong>Pollution-Resistant Coatings:</strong> Systems designed to resist industrial
                pollutants and maintain appearance
              </div>
            </li>
            <li className="flex items-start">
              <span className="text-brand-gold mr-2">▸</span>
              <div>
                <strong>Energy-Efficient Solutions:</strong> Cool roofing to reduce energy costs and
                improve comfort
              </div>
            </li>
          </ul>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-bold mb-2">
                Do you have experience working with Celanese Corporation and other chemical plants
                in Pampa?
              </h3>
              <p className="text-gray-700">
                Yes, we specialize in chemical facility roofing and have extensive experience with
                petrochemical plants throughout the Texas Panhandle. We understand the unique
                requirements including chemical resistance, environmental compliance, and safety
                protocols. Our crews are trained in industrial safety procedures and carry the high
                liability insurance required for work in chemical manufacturing environments.
              </p>
            </div>

            <div>
              <h3 className="text-lg font-bold mb-2">
                What roofing systems work best for oil and gas facilities in Gray County?
              </h3>
              <p className="text-gray-700">
                For petroleum facilities, we typically recommend metal roofing systems or
                specialized TPO membranes that resist hydrocarbon exposure. These materials are
                designed to handle the unique challenges of oil field environments including
                chemical exposure, temperature extremes, and potential fire hazards. We also ensure
                all systems meet petroleum industry safety standards and local fire codes.
              </p>
            </div>

            <div>
              <h3 className="text-lg font-bold mb-2">
                How does living near chemical plants affect residential roofing choices in Pampa?
              </h3>
              <p className="text-gray-700">
                Homes near industrial facilities benefit from roofing materials that resist
                industrial pollutants and maintain their appearance longer. We recommend
                impact-resistant shingles with enhanced UV and chemical resistance, plus regular
                maintenance to ensure optimal performance. These systems protect your investment
                while providing superior weather protection compared to standard materials.
              </p>
            </div>
            ...
            <div>
              <h3 className="text-lg font-bold mb-2">
                What's involved in roof replacement for Pampa's historic downtown buildings?
              </h3>
              <p className="text-gray-700">
                Pampa's historic downtown includes buildings dating to the oil boom era that require
                careful restoration approaches. We work with local preservation guidelines and can
                install modern roofing systems designed to maintain historical appearance while
                providing superior protection. This often involves custom fabrication and specialty
                materials to match original designs while meeting current building codes.
              </p>
            </div>

            <div>
              <h3 className="text-lg font-bold mb-2">
                How quickly can you complete roofing projects for businesses that can't afford
                downtime?
              </h3>
              <p className="text-gray-700">
                We understand that industrial operations can't afford extended shutdowns. We work
                with facility managers to schedule installations during planned maintenance windows,
                work in phases to keep operations running, or use rapid-installation systems when
                appropriate. Most commercial projects in Pampa are completed efficiently with
        ...
        <FadeIn>
          <section className="cta-section my-16">
            ...
            <p className="cta-text mb-6">
              Serving Pampa, Gray County, and the entire Texas Panhandle. Contact us today for your
              free inspection.
            </p>
