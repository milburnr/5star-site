...
export default function PampaRoofingPage() {
  ...
  return (
    <div className="min-h-screen">      <Breadcrumb items={[
      ...
      <section className="hero" style={{backgroundImage: 'url(https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/hail-damage/hail-damage-canyon-1-1280w.jpg)', backgroundPosition: 'center'}}>
      ...
      <div className="container-custom py-12">
        ...
        <FadeIn>
          <section className="content-block bg-gray-50 rounded-lg p-8 mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h3 className="font-bold text-lg mb-2"><Check className="w-5 h-5 text-brand-gold inline-block" /> Gray County Experts</h3>
