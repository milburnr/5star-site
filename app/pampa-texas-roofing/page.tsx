    ...
    <div className="min-h-screen">
      ...
      <aside className="container-custom mt-10 mb-10">
        <div className="max-w-5xl mx-auto bg-amber-50/60 border border-brand-gold/30 rounded-2xl p-6">
          <h2 className="text-xl font-bold text-brand-brown mb-3">Pampa Roofing Services</h2>
          <ul className="grid sm:grid-cols-2 gap-2 list-disc list-inside">
            ...
            <li><a href="/roof-replacement-pampa/" className="text-brand-brown hover:text-brand-gold underline">Roof Replacement in Pampa</a></li>
            <li><a href="/metal-roofing-pampa/" className="text-brand-brown hover:text-brand-gold underline">Metal Roofing in Pampa</a></li>
            ...
            <li><a href="/roof-repair-pampa/" className="text-brand-brown hover:text-brand-gold underline">Roof Repair in Pampa</a></li>
            <li><a href="/roof-inspections-pampa/" className="text-brand-brown hover:text-brand-gold underline">Roof Inspections in Pampa</a></li>
            ...
            <li><a href="/storm-damage-repair-pampa/" className="text-brand-brown hover:text-brand-gold underline">Storm Damage Repair in Pampa</a></li>
          </ul>
        </div>
      </aside>
      {/* /auto-link */}
