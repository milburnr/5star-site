...
export default function PampaRoofingPage() {
  const schema = {
    ...
    "description": "Professional roofing contractor serving Pampa, Texas and Gray County with commercial, residential, and emergency roofing services.",
    ...
    "areaServed": [
      { "@type": "City", "name": "Pampa", "containedInPlace": { "@type": "AdministrativeArea", "name": "Gray County" } },
    ...
    "hasOfferCatalog": {
      ...
      "itemListElement": [
        { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Commercial Roofing", "description": "Commercial roofing for Pampa businesses" } },
        { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Residential Roofing", "description": "Residential roofing for Pampa homes" } },
        { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Hail Damage Repair", "description": "Storm and hail damage repair in Pampa, TX" } },
        { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Emergency Roofing", "description": "24/7 emergency roofing in Gray County" } }
      ]
    }
  };
        ...
        <FadeIn>
          <section className="content-block">
            ...
            <p className="text-lg mb-4">
              As Pampa's premier <a href="/roofing-amarillo-tx/" className="text-brand-gold hover:underline">professional roofing contractor</a>, 5 Star Commercial Roofing brings over a decade of experience serving Gray County and the entire Texas Panhandle. Whether you need commercial roofing, residential roofing for your home, or emergency storm damage repairs, our expert team delivers reliable, high-quality roofing solutions.
            </p>
            <p className="text-lg mb-4">
              Pampa's climate—with severe hailstorms, high winds, and extreme temperature swings—demands roofing systems built to withstand the harshest conditions. We specialize in <a href="/hail-damage-repair-amarillo-tx/" className="text-brand-gold hover:underline">hail-resistant roofing materials</a> and installation techniques proven to protect Gray County properties year after year.
            </p>
          </section>
        </FadeIn>
            ...
            <FadeIn delay={0.3}>
              <div className="card-hover p-6 bg-red-50">
                ...
                <p className="text-gray-700 mb-4">
                  When severe weather strikes Pampa, we respond 24/7 with emergency tarping and rapid roof repairs. Call us immediately for storm damage assessment.
                </p>
