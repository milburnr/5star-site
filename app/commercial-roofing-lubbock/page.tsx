...
export const metadata: Metadata = {
  ...
  description: 'commercial roofing in Lubbock TX. TPO, EPDM, and metal roofing systems for businesses. 24/7 emergency service. Free inspections. Call (806) 622-6041',
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Professional commercial roofing in Lubbock TX. TPO, EPDM, and metal roofing systems for businesses. 24/7 emergency service. Free inspections. Call (806) 622-6041",
          ...
          <FadeIn>
            <div className="max-w-4xl">
              ...
              <p className="text-xl mb-8 text-white leading-relaxed">
                Expert commercial roofing for Lubbock businesses. TPO, EPDM, and metal roofing systems engineered for harsh weather. Minimize operational disruption with our after-hours installation. 24/7 emergency response available.
              </p>
        ...
        <FadeIn>
          <section className="mb-16 max-w-5xl mx-auto">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              Since 2014, we've served Lubbock with expert commercial roofing. We handle all permits, insurance claims, and warranty documentation. Free inspections and estimates available.
            </p>
          </section>
        </FadeIn>
          ...
          <section className="mb-16 bg-gradient-to-br from-blue-50 to-white p-12 rounded-3xl shadow-lg">
            ...
            <Accordion type="single" collapsible className="max-w-4xl mx-auto">
              ...
              <AccordionItem value="item-2" className="bg-white rounded-xl shadow-sm border border-gray-100 px-6 mb-4">
                ...
                <AccordionContent className="text-gray-700 leading-relaxed">
                  Yes. We schedule commercial installations during evenings, weekends, or planned closure periods to minimize operational impact. Many Lubbock businesses prefer after-hours work for retail locations or facilities that cannot shut down during business hours.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-3" className="bg-white rounded-xl shadow-sm border border-gray-100 px-6 mb-4">
                <AccordionTrigger className="text-lg font-semibold text-brand-brown hover:text-brand-gold">
                  What makes TPO roofing ideal for Lubbock's commercial buildings?
                </AccordionTrigger>
                <AccordionContent className="text-gray-700 leading-relaxed">
