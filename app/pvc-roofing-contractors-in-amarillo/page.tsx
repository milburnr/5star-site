    ...
    <div className="container-custom py-12">
        ...
        <section className="container-custom mt-4 mb-8">
          <div className="max-w-5xl mx-auto bg-amber-50 border-l-4 border-brand-gold rounded-r-2xl p-6">
            ...
            <ul className="space-y-2 text-gray-800 font-medium leading-relaxed">
              <li className="flex gap-2"><span className="text-brand-gold flex-shrink-0">•</span><span>What this page covers: PVC membrane roofing for commercial buildings in Amarillo and the West Texas region.</span></li>
              <li className="flex gap-2"><span className="text-brand-gold flex-shrink-0">•</span><span>Why PVC here: PVC stands up to Panhandle UV, hail, and ponding water better than most single-ply systems.</span></li>
              <li className="flex gap-2"><span className="text-brand-gold flex-shrink-0">•</span><span>Scope of work: full installs, partial reroofs, and warranty-backed repairs for flat and low-slope buildings.</span></li>
              <li className="flex gap-2"><span className="text-brand-gold flex-shrink-0">•</span><span>Next step: free site assessments available. Call (806) 622-6041 to schedule.</span></li>
            </ul>
          </div>
        </section>
      </FadeIn>
      ...
      <aside className="container-custom mt-6 mb-8">
        <div className="max-w-5xl mx-auto bg-white border-l-4 border-brand-brown rounded-r-2xl p-5 text-sm text-gray-700">
          ...
          <p>For the next step, see <a href="/commercial-roofing/" className="text-brand-brown font-semibold hover:text-brand-gold underline">our commercial roofing team</a> or <a href="/amarillo-tx-roofing/" className="text-brand-brown font-semibold hover:text-brand-gold underline">our Amarillo roofing crew</a>.</p>
        </div>
      </aside>
      {/* /auto-link */}
