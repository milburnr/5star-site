...
export const metadata: Metadata = {
  ...
  description: "Professional hail damage repair in Snyder TX. Expert installation, repair & insurance assistance. Free inspections. Call (806) 622-6041",
};
...
export default function HailDamageRepairSnyderPage() {
  return (
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Professional hail damage repair services in Snyder, Texas. Expert installation, repair, and maintenance with prompt response.",
            "provider": {
      ...
      <section className="relative bg-cover bg-center text-white py-32 min-h-[700px] flex items-center" style={{ backgroundImage: 'url(https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/hail-damage/hail-damage-midland-15-1280w.webp)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
