...
export const metadata: Metadata = {
  ...
  description: "Heavy-duty asphalt shingle roofing in Midland TX. Built for Permian Basin weather and industrial conditions. Desert-rated materials. Call (806) 622-6041",
  openGraph: {
    title: "Asphalt Shingle Roofing Midland TX | 5 Star Roofing",
    description: "Heavy-duty asphalt shingle roofing in Midland TX. Built for Permian Basin weather and industrial conditions. Desert-rated materials. Call (806) 622-6041",
        ...
        <section className="py-16 bg-gradient-to-b from-amber-50 to-white">
          <div className="container-custom">
            <div className="grid md:grid-cols-4 gap-8 text-center">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg"><div className="text-3xl mb-3"><Fuel className="w-6 h-6 inline-block" /></div><div className="text-brand-brown font-semibold text-lg">Oil Field Tested</div></div>
            </div>
          </div>
        </section>
      </FadeIn>
