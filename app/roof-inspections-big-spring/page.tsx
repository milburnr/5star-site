        ...
        <section className="container-custom mt-8">
          <div className="max-w-5xl mx-auto bg-amber-50 border-l-4 border-brand-gold rounded-r-2xl p-6">
            ...
            <ul className="space-y-2 text-gray-800 font-medium leading-relaxed">
              <li className="flex gap-2"><span className="text-brand-gold flex-shrink-0">•</span><span>What this page covers: Roof Inspections for homes and businesses in Big Spring, Texas.</span></li>
        ...
        <FadeIn>
          <section className="mb-16 max-w-5xl mx-auto">
            ...
            <div className="w-full h-[450px] rounded-2xl overflow-hidden shadow-2xl mb-8">
              <MapEmbed unwrapped widthAttr="100%" heightAttr="100%" city="Spring, TX" />
            </div>
            <div className="bg-white rounded-2xl shadow-lg p-8">
