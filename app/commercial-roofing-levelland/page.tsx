...
export const metadata: Metadata = {
  ...
  description: "Professional commercial roofing in Levelland TX. Expert installation, repair & insurance assistance. Free inspections. Call (806) 622-6041",
  openGraph: {
    title: "Commercial Roofing Levelland TX | 5 Star Roofing",
    description: "Professional commercial roofing in Levelland TX. Expert installation, repair & insurance assistance. Free inspections. Call (806) 622-6041",
...
export default function CommercialRoofingLevellandPage() {
  return (
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Professional commercial roofing services in Levelland, Texas. Expert installation, repair, and maintenance with prompt response.",
            "provider": {
              "@type": ["LocalBusiness", "RoofingContractor"],
              "name": "5 Star Roofing",
              "telephone": "(806) 622-6041",
      ...
      <section className="relative bg-cover bg-center text-white py-32 min-h-[700px] flex items-center" style={{ backgroundImage: 'url(https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/heroes/hero-commercial-1920w.webp)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 text-sm">repair capability during peak harvest when facilities cannot shut down</p>
                    </div>
                  </div>
                </div>
              </div>
