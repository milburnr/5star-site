  ...
  return (
    <>      <Breadcrumb items={[
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "name": "5 Star Commercial Roofing - Perryton Metal Roofing",
        ...
        "description": "Expert metal roofing services in Perryton, TX. Free inspections, insurance claim assistance, 24/7 emergency response.",
