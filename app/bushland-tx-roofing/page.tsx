  ...
  return (
    <div className="min-h-screen">
      <InteriorHeroSection
        ...
        city="Bushland"
        citySlug="amarillo"
        h1="Professional Roofing Services in Bushland, Texas"
        eyebrow="Proudly serving Bushland from our Amarillo location — just 10 miles away"
        image="/images/heroes/cities/amarillo-hero-1200.webp"
        breadcrumbItems={[
          { name: "Home", url: "/" },
          { name: "Service Areas", url: "/service-areas/" },
          { name: "Bushland", url: "/bushland-tx-roofing/" },
        ]}
      />
        ...
        <section className="container-custom mt-8">
          <div className="max-w-5xl mx-auto bg-amber-50 border-l-4 border-brand-gold rounded-r-2xl p-6">
            ...
            <ul className="space-y-2 text-gray-800 font-medium leading-relaxed">
              <li className="flex gap-2"><span className="text-brand-gold flex-shrink-0">•</span><span>What this page covers: full residential and commercial roofing services for Bushland and the surrounding area.</span></li>
