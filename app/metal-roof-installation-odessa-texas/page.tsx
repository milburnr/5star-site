  ...
  return (
    <div className="min-h-screen">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "name": "5 Star Commercial Roofing - Odessa Roofing",
        ...
        "description": "Expert roofing services in Odessa, TX. Free inspections, insurance claim assistance, 24/7 emergency response.",
