  ...
  return (
    <div className="min-h-screen">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "description": "Expert roofing services in Odessa, TX. Free inspections, insurance claim assistance, prompt response.",
        ...
        <FadeIn>
          <section className="mt-16 pt-8 border-t border-gray-200">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <span className="text-gray-400">•</span>
              <a href="/commercial-roofing-odessa/" className="text-brand-gold hover:text-brand-gold-vibrant font-medium">Commercial Roofing</a>
            </div>
          </section>
        </FadeIn>
      </div>
