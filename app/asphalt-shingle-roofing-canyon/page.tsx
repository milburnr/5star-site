  ...
  return (
    <>
          ...
          __html: JSON.stringify({
            ...
            mainEntity: [
              ...
              },
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Quality architectural shingles typically last 20-30 years in Canyon when properly installed and maintained. Palo Duro Canyon area's intense UV exposure, temperature extremes, and hailstorms stress roofing materials. Class 4 impact-resistant shingles last longer than standard shingles. Regular inspections after storms and efficient repairs extend lifespan. Premium shingles with enhanced UV protection perform better in Canyon's climate.",
                },
              },
              {
                "@type": "Question",
      ...
      />
        ...
        h1="Asphalt Shingle Roofing in Canyon, TX"
        ...
        <section className="container-custom mt-8">
          <div className="max-w-5xl mx-auto bg-amber-50 border-l-4 border-brand-gold rounded-r-2xl p-6">
            ...
            <ul className="space-y-2 text-gray-800 font-medium leading-relaxed">
              <li className="flex gap-2"><span className="text-brand-gold flex-shrink-0">•</span><span>What this page covers: Asphalt Shingle Roofing for homes and businesses in Canyon, Texas.</span></li>
        ...
        <FadeIn>
          <section className="mb-16 max-w-5xl mx-auto">
            <h2 className="text-4xl font-bold mb-8 text-brand-brown">
              What Quality roof system for Canyon Families Do We Offer in Canyon?
            </h2>
