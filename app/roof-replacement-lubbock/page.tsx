      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "FAQPage",
            "mainEntity": [{"@type":"Question","name":"When should I replace my Lubbock roof?","acceptedAnswer":{"@type":"Answer","text":"Replace when you have widespread hail damage (10+ impacts per 100 sq ft), roof age over 20 years, multiple leaks, extensive granule loss, or failed previous repairs."}},{"@type":"Question","name":"How much does roof replacement cost in Lubbock?","acceptedAnswer":{"@type":"Answer","text":"Residential: $8,000-$25,000 depending on size and materials. Commercial: $15,000-$100,000+ depending on building size. 85% of replacements are insurance-covered hail damage where property owners pay only their deductible."}},{"@type":"Question","name":"What are the best roofing materials for Lubbock's climate?","acceptedAnswer":{"@type":"Answer","text":"Class 4 impact-resistant asphalt shingles (residential), TPO or metal roofing (commercial). These materials are engineered for extreme Texas weather conditions including hail, high winds, and temperature swings."}}]
          })
        }}
      />
        ...
        <FadeIn>
          <section className="mb-16 max-w-5xl mx-auto">
            <h2 className="text-4xl font-bold mb-6 text-brand-brown">
              Lubbock's Roof Replacement Specialists
            </h2>
            <p className="text-xl text-gray-700 mb-6 leading-relaxed">
              Complete roof replacement for Lubbock homes and businesses. We install Class 4 impact-resistant roofing with 50-year warranties.
            </p>
            <p className="text-lg text-gray-600 leading-relaxed">
              Since 2014, we've served Lubbock with expert roof replacement. We handle all permits, insurance claims, and warranty documentation. Free inspections and estimates available.
            </p>
          </section>
        </FadeIn>
          ...
          <section className="mb-16 bg-gradient-to-br from-blue-50 to-white p-12 rounded-3xl shadow-lg">
            ...
            <Accordion type="single" collapsible className="max-w-4xl mx-auto">
              ...
              <AccordionItem value="item-3" className="bg-white rounded-xl shadow-sm border border-gray-100 px-6 mb-4">
                <AccordionTrigger className="text-lg font-semibold text-brand-brown hover:text-brand-gold">
                  What are the best roofing materials for Lubbock's climate?
                </AccordionTrigger>
                <AccordionContent className="text-gray-700 leading-relaxed">
