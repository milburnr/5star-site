  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage: 'url(https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/heroes/hero-commercial-9-1920w.webp)',
      ...
      <div className="container-custom py-12">
        ...
        <FadeIn>
          <section className="mb-16 max-w-5xl mx-auto">
            ...
            <h3 className="text-2xl font-bold mb-4 text-brand-brown">storm response and Maintenance Services for Critical Operations</h3>
            <p className="text-lg text-gray-700 mb-4 leading-relaxed">
              prompt response capabilities specifically designed for petroleum industry environments include specialized safety equipment and coordination with industrial storm response protocols. Rapid response times minimize business interruption for facilities that cannot tolerate weather-related operational disruptions during critical petroleum industry activities including drilling, completion, and production operations.
            </p>
            <p className="text-lg text-gray-700 mb-4 leading-relaxed">
