...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/metal/metal-memphis-42-1280w.webp",
        width: 1280,
        height: 720,
        alt: "Commercial metal roofing installation in West Texas — 5 Star Roofing",
      },
    ],
    locale: "en_US",
    type: "website",
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Expert metal roofing services in Dumas, TX. Free inspections, insurance claim assistance",
      ...
      <div className="container-custom py-12">
        ...
        <FadeIn>
          <section className="mb-10 max-w-5xl mx-auto bg-amber-50 border-l-4 border-brand-gold rounded-r-2xl p-6">
            ...
            <div className="mt-4 flex flex-wrap gap-4 text-sm">
              ...
              <a href="/metal-roofing-amarillo/" className="text-brand-brown font-semibold hover:text-brand-gold transition-colors">Amarillo Metal</a>
              <a href="/metal-roofing-borger/" className="text-brand-brown font-semibold hover:text-brand-gold transition-colors">Borger Metal</a>
        ...
        <FadeIn>
          <section className="mb-16 max-w-5xl mx-auto">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              5 Star Roofing has protected Dumas properties for over a decade with premium materials engineered
        ...
        <FadeIn>
          <section className="mb-16 max-w-5xl mx-auto">
            <h2 className="text-4xl font-bold mb-8 text-brand-brown">
              What Agricultural & Industrial Metal Roofing for Dumas?
            </h2>
        ...
        <FadeIn>
          <section className="mb-16 max-w-5xl mx-auto">
            <h2 className="text-4xl font-bold mb-8 text-brand-brown">
              What Chemical & Weather Resistance for Agricultural Operations?
            </h2>
            <div className="bg-white p-8 rounded-2xl shadow-lg border">
        ...
        <FadeIn>
          <section className="mb-16 max-w-5xl mx-auto">
            ...
            <p className="text-lg text-gray-700 mb-6 leading-relaxed">
              ...
              For facilities operating continuously without downtime, metal roofing&apos;s low maintenance
