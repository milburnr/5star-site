...
export const metadata: Metadata = {
  ...
  description: "Wind damage repair in Midland. Permian Basin sustained winds with gusts over 65+ mph.  and insurance claim assistance. Call (806) 622-6041",
  openGraph: {
    title: "Wind Damage Repair Midland | 5 Star Roofing",
    description: "Wind damage repair in Midland. Permian Basin sustained winds with gusts over 65+ mph.  and insurance claim assistance. Call (806) 622-6041",
  ...
  return (
    <>      <Breadcrumb items={[
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "description": "Expert wind damage repair services in Midland, TX. Free inspections, insurance claim assistance, prompt response.",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Wind damage repair in Midland. Permian Basin sustained winds with gusts over 65+ mph.  and insurance claim assistance."
          })
        }}
      />
      ...
      <section
        ...
        style={{
          backgroundImage: 'url(https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/hail-damage/hail-damage-midland-15-1280w.webp)',
