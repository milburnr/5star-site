...
export const metadata: Metadata = {
  ...
  description: "Professional roof inspections in Amarillo TX. Expert installation, repair & insurance assistance. Free inspections. Call (806) 622-6041",
  openGraph: {
    title: "Roof Inspections Amarillo TX | 5 Star Roofing",
    description: "Professional roof inspections in Amarillo TX. Expert installation, repair & insurance assistance. Free inspections. Call (806) 622-6041",
...
export default function RoofInspectionsAmarilloPage() {
  return (
    <>
      ...
      <section className="relative bg-cover bg-center text-white py-32 min-h-[700px] flex items-center" style={{ backgroundImage: 'url(https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/hail-damage/hail-damage-canyon-1-1280w.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
