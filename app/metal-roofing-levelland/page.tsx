  ...
  return (
    <>      <Breadcrumb items={[
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "name": "5 Star Commercial Roofing - Levelland Metal Roofing",
        ...
        "description": "Expert metal roofing services in Levelland, TX. Free inspections, insurance claim assistance, 24/7 emergency response.",
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <div className="mt-8 p-6 bg-amber-50 rounded-xl">
                ...
                <p className="text-gray-700">
                  Our comprehensive maintenance program ensures your metal roofing investment continues to protect your Levelland property for decades. We provide annual inspections, preventive maintenance, and priority emergency response to keep your roofing system performing at peak efficiency through all of the South Plains's weather challenges.
                </p>
              </div>
            </div>
          </section>
