          ...
          <div className="space-y-12">
              ...
              <div className="card-hover p-8">
                <div className="flex flex-col md:flex-row gap-6">
                  <div className="md:w-1/3">
                    <img loading="lazy" src="/images/hail-damage-3.jpg" alt="Hail damage repair services for Wildorado TX" className="w-full h-48 object-cover rounded-lg mb-4" />
            ...
            <FadeIn delay={0.2}>
              <div className="card-hover p-8">
                <div className="flex flex-col md:flex-row gap-6">
                  <div className="md:w-1/3">
                    <img loading="lazy" src="/images/ResidentialServices.jpeg" alt="Residential roofing services for Wildorado TX" className="w-full h-48 object-cover rounded-lg mb-4" />
                    <h3 className="text-2xl font-bold text-brand-brown mb-2">
                      Residential Roofing
                    </h3>
                  </div>
            ...
            <FadeIn delay={0.3}>
              <div className="card-hover p-8">
                <div className="flex flex-col md:flex-row gap-6">
                  <div className="md:w-1/3">
                    <img loading="lazy" src="/images/cover-background-roofing-sunset-1024x683.jpg" alt="Metal roofing systems for Wildorado TX" className="w-full h-48 object-cover rounded-lg mb-4" />
                    <h3 className="text-2xl font-bold text-brand-brown mb-2">
            ...
            <FadeIn delay={0.4}>
              <div className="card-hover p-8">
                <div className="flex flex-col md:flex-row gap-6">
                  <div className="md:w-1/3">
                    <img loading="lazy" src="/images/CommercialRoofing.jpeg" alt="Agricultural roofing services for Wildorado TX" className="w-full h-48 object-cover rounded-lg mb-4" />
                    <h3 className="text-2xl font-bold text-brand-brown mb-2">
            ...
            <FadeIn delay={0.5}>
              <div className="card-hover p-8">
                <div className="flex flex-col md:flex-row gap-6">
                  <div className="md:w-1/3">
                    <img loading="lazy" src="/images/roof-inspection-texas.jpg" alt="Free roof inspections for Wildorado TX" className="w-full h-48 object-cover rounded-lg mb-4" />
                    <h3 className="text-2xl font-bold text-brand-brown mb-2">
            ...
            <FadeIn delay={0.6}>
              <div className="card-hover p-8 bg-red-50 border-2 border-red-200">
                <div className="flex flex-col md:flex-row gap-6">
                  <div className="md:w-1/3">
                    <img loading="lazy" src="/images/storm-damage-roof-repair.jpg" alt="24/7 emergency roofing service for Wildorado TX" className="w-full h-48 object-cover rounded-lg mb-4" />
