  ...
  return (
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Expert metal roofing services in Big Spring, TX. Free inspections, insurance claim assistance, prompt response.",
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url(https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/metal/metal-memphis-44-1280w.webp)",
          ...
          <FadeIn>
            <div className="max-w-4xl">
              ...
              <p className="text-xl mb-8 text-white leading-relaxed">
                Durable metal roofing systems in Big Spring TX. West Texas experiences 7-9
