  ...
  return (
    <>      {/* Sticky Contact Bar */}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            name: "5 Star Roofing",
            image:
              "https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/commercial/commercial-pampa-2-1280w.jpg",
            ...
            description:
              "Professional commercial roofing in Pampa TX. Expert installation, warranties, and insurance assistance.",
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "How much does commercial roofing cost in Pampa?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Commercial roofing costs in Pampa vary by size, type, and complexity. TPO: $4-$8/sq ft, Metal: $7-$12/sq ft, EPDM: $3-$6/sq ft. We provide free estimates with transparent pricing.",
                },
              },
              {
                "@type": "Question",
                name: "Do you work after hours in Pampa?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Yes. We schedule installations during evenings, weekends, or planned closures to minimize business disruption in Pampa.",
                },
              },
              {
                "@type": "Question",
      ...
      />
        ...
        h1="Commercial Roofing in Pampa, TX"
    ...
    />
        ...
        <section className="container-custom mt-8">
          <div className="max-w-5xl mx-auto bg-amber-50 border-l-4 border-brand-gold rounded-r-2xl p-6">
            ...
            <ul className="space-y-2 text-gray-800 font-medium leading-relaxed">
              <li className="flex gap-2"><span className="text-brand-gold flex-shrink-0">•</span><span>What this page covers: Commercial Roofing for homes and businesses in Pampa, Texas.</span></li>
      ...
      <div className="container-custom py-12">
        <FadeIn>
          <section className="mb-16 max-w-5xl mx-auto">
            ...
            <p className="text-xl text-gray-700 mb-6 leading-relaxed">
              Professional commercial roofing throughout Pampa and surrounding areas. We understand
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div>
                <h3 className="text-2xl font-bold mb-4 text-brand-brown">
                  Understanding Pampa's Unique Climate Challenges
                </h3>
                <p className="text-gray-700 mb-4">
                  Pampa, located in Gray County in the Texas Panhandle, experiences a semi-arid
                  climate with extreme temperature variations and severe weather events that present
                  unique challenges for commercial roofing systems. Average annual rainfall of 21
                  inches, combined with intense summer heat reaching 100°F+ and winter lows dropping
                  to 20°F, creates thermal expansion and contraction cycles that stress commercial
                  roofing materials.
                </p>
                <p className="text-gray-700 mb-4">
                  The region's position in "Hail Alley" means commercial properties face significant
                  hail damage risks, particularly during spring and early summer storm seasons. Wind
                  speeds regularly exceed 25 mph, with severe storms producing gusts over 70 mph.
                  These conditions require specialized roofing systems designed for the unique Texas
                  Panhandle environment.
                </p>
              </div>
              <div>
                <h3 className="text-2xl font-bold mb-4 text-brand-brown">
                  Pampa's Commercial Landscape
                </h3>
                <p className="text-gray-700 mb-4">
                  As a historic oil and gas hub, Pampa hosts diverse commercial and industrial
                  facilities requiring specialized roofing solutions. From agricultural processing
                  facilities and manufacturing plants to retail centers and office buildings, each
                  structure demands roofing systems tailored to specific operational requirements.
                </p>
                <p className="text-gray-700 mb-4">
                  The city's economic diversity, including healthcare facilities, educational
                  institutions, and energy sector operations, means our commercial roofing expertise
                  spans multiple industries with varying requirements for durability, energy
                  efficiency, and specialized installations.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-16 bg-gradient-to-br from-gray-50 to-white p-12 rounded-3xl shadow-lg">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
                ...
                <p className="text-gray-700 mb-4">
                  Thermoplastic Polyolefin (TPO) roofing offers exceptional performance for Pampa's
                  climate with superior heat reflection, reducing cooling costs by up to 30%. TPO's
                  welded seams provide superior water protection against severe weather events.
                </p>
              ...
              <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
                ...
                <p className="text-gray-700 mb-4">
                  Standing seam metal roofing provides unmatched durability for Pampa commercial
                  properties with 50+ year lifespans. Advanced coating systems offer superior
                  corrosion resistance and energy efficiency benefits crucial for Texas climate
                  conditions.
                </p>
                <ul className="text-sm text-gray-600 space-y-2">
              ...
              <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
                ...
                <p className="text-gray-700 mb-4">
                  Ethylene Propylene Diene Monomer (EPDM) rubber roofing delivers reliable
                  performance and cost-effectiveness for Pampa commercial applications. Exceptional
                  temperature resistance and proven 30+ year track record.
                </p>
                <ul className="text-sm text-gray-600 space-y-2">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  ...
                  <p className="text-gray-700 mb-4">
                    Cool roofing systems reflect solar energy and emit absorbed heat, reducing roof
                    temperatures by up to 50°F compared to traditional roofing. This translates to
                    significant energy savings for Pampa businesses, particularly during intense
                    summer months.
                  </p>
        ...
        <FadeIn>
          <section className="mb-16">
            <h2 className="text-3xl font-bold mb-8 text-center text-brand-brown">
              How Do We Ensure Quality on Every Project?
            </h2>
            <div className="max-w-4xl mx-auto">
              <p className="text-xl text-gray-700 mb-8 text-center">
                Our comprehensive quality assurance program ensures every Pampa commercial roofing
                project meets the highest standards for workmanship and performance.
              </p>
              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">
                    Comprehensive structural analysis, moisture surveys, and building code
                    compliance verification before project initiation.
                  </p>
                </div>
                <div className="text-center">
                  <div className="bg-brand-gold text-white w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-bold">
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-600">
                    Comprehensive quality inspections, performance testing, and warranty
                    documentation to ensure long-term system performance.
                  </p>
                </div>
              </div>
            </div>
            ...
            <Accordion type="single" collapsible className="max-w-4xl mx-auto">
              ...
              >
                <AccordionTrigger className="text-lg font-semibold text-brand-brown hover:text-brand-gold">
                  How much does commercial roofing cost in Pampa?
                </AccordionTrigger>
                <AccordionContent className="text-gray-700 leading-relaxed">
                  Commercial roofing costs in Pampa vary by size, type, and complexity. TPO:
                  $4-$8/sq ft, Metal: $7-$12/sq ft, EPDM: $3-$6/sq ft. Additional factors include
                  insulation upgrades, structural modifications, and specialized equipment
                  requirements. We provide free estimates with transparent pricing and detailed
                  project breakdowns.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem
              ...
              >
                <AccordionTrigger className="text-lg font-semibold text-brand-brown hover:text-brand-gold">
                  Do you work after hours in Pampa?
                </AccordionTrigger>
                <AccordionContent className="text-gray-700 leading-relaxed">
                  Yes. We schedule installations during evenings, weekends, or planned closures to
                  minimize business disruption in Pampa. Many retail and industrial facilities
                  require off-hours work to maintain operations. We coordinate closely with facility
                  managers to ensure minimal impact on daily operations.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem
                value="item-3"
              ...
              >
                ...
                <AccordionContent className="text-gray-700 leading-relaxed">
                  ...
                  (cost-effective) perform excellently in Texas climate. TPO and metal roofing with
                  cool roofing technologies provide significant energy savings in Pampa's hot
                  summers, while all three systems offer excellent hail and wind resistance.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem
                value="item-4"
              ...
              >
                <AccordionTrigger className="text-lg font-semibold text-brand-brown hover:text-brand-gold">
                  How long does a commercial roof replacement take in Pampa?
                </AccordionTrigger>
                <AccordionContent className="text-gray-700 leading-relaxed">
                  Project duration depends on building size, roofing system complexity, and weather
                  conditions. Typical timelines: Small commercial buildings (5,000-10,000 sq ft):
                  3-5 days. Medium facilities (10,000-25,000 sq ft): 1-2 weeks. Large industrial
                  buildings (25,000+ sq ft): 2-4 weeks. We provide detailed project schedules and
              ...
              >
                ...
                <AccordionContent className="text-gray-700 leading-relaxed">
                  Yes, we provide comprehensive insurance claim assistance for Pampa commercial
                  properties. Our certified inspectors document storm damage, prepare detailed
                  reports, and work directly with insurance adjusters. We handle all communication
                  with insurance companies and ensure claims are processed efficiently and fairly.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem
                value="item-6"
              ...
              >
                <AccordionTrigger className="text-lg font-semibold text-brand-brown hover:text-brand-gold">
                  What warranties do you provide on commercial roofing?
                </AccordionTrigger>
                <AccordionContent className="text-gray-700 leading-relaxed">
                  We offer comprehensive warranty coverage including manufacturer material
                  warranties (10-30+ years depending on system), workmanship warranties (5-10
                  years), and optional extended warranty programs. All warranties are transferable
                  and include regular maintenance requirements to ensure continued coverage.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem
                value="item-7"
              ...
              >
                ...
                <AccordionContent className="text-gray-700 leading-relaxed">
                  We handle all permitting and inspection requirements for commercial roofing
                  projects in Pampa and Gray County. Our team coordinates with local building
                  officials, schedules required inspections, and ensures all work meets current
                  building codes and manufacturer specifications. Permit costs are included in
                  project estimates.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem
              ...
              >
                ...
                <AccordionContent className="text-gray-700 leading-relaxed">
                  Yes, we specialize in occupied building renovations with minimal disruption to
                  business operations. We implement dust containment systems, noise reduction
                  protocols, and coordinate work schedules with building occupants. Safety barriers
                  and clear communication ensure occupied spaces remain functional during roofing
                  projects.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
        ...
        <FadeIn>
          <section className="mb-16">
            ...
            <div className="max-w-4xl mx-auto">
              <p className="text-xl text-gray-700 mb-8 text-center">
                Safety is our top priority on every Pampa commercial roofing project, with
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
                  ...
                  <p className="text-gray-700 mb-4">
                    Fully licensed, bonded, and insured commercial roofing contractor serving Pampa
                    with comprehensive liability coverage and workers' compensation insurance
                    protecting both our team and your property.
                  </p>
                  <ul className="text-gray-600 space-y-2">
        ...
        <FadeIn>
          <section className="mb-16 bg-gradient-to-br from-gray-50 to-white p-12 rounded-3xl shadow-lg">
            <h2 className="text-3xl font-bold mb-8 text-center text-brand-brown">
              Why Choose 5 Star Roofing for Your Pampa Commercial Project?
            </h2>
            <div className="max-w-4xl mx-auto">
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        Hundreds of successful commercial roofing projects throughout the Texas
                        Panhandle with consistent 5-star customer reviews and referrals.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
        ...
        <InternalLinks currentCity="pampa" currentService="commercial-roofing" />

        <section className="bg-gradient-to-r from-brand-brown to-brand-gold text-white p-12 rounded-3xl text-center">
          <h2 className="text-4xl font-bold mb-6">Ready to Protect Your Pampa Property?</h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Free inspections for Pampa property owners. Expert commercial roofing with comprehensive
        ...
        <RelatedArticles pageSlug="commercial-roofing-pampa" />
      </div>
    </>
  );
}
