  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url(https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/hail-damage/hail-damage-levelland-3-1280w.webp)",
          ...
          <FadeIn>
            <div className="max-w-4xl">
              <h1 className="text-6xl font-bold mb-6 text-white leading-tight">
                Hail Damage Repair in <span className="text-brand-gold-light">Levelland</span>
              </h1>
              <p className="text-3xl mb-6 font-bold text-brand-gold-light">
                Expert Service for Texas Properties
              </p>
              <p className="text-xl mb-8 text-white leading-relaxed">
                Professional hail damage repair throughout Levelland. Expert installation,
              ...
              <div>
                ...
                <div className="bg-gray-50 p-6 rounded-xl">
                  ...
                  <ul className="text-gray-700 space-y-1 text-sm">
                    ...
                    <li>
                      • <strong>97% approval rate</strong> for wind-driven hail damage in Hockley
                      County
                    </li>
                    <li>
