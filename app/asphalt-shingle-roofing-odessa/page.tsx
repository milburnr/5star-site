...
import { BadgeCheck, Check, Factory, Phone } from "lucide-react";
import RelatedArticles from "@/components/RelatedArticles";
import { InteriorHeroSection } from "@/components/InteriorHeroSection";

export const metadata: Metadata = {
  alternates: { canonical: "https://5starroofingpros.com/asphalt-shingle-roofing-odessa/" },
  title: "Asphalt Shingle Roofing Odessa TX | 5 Star Roofing",
  description:
    "Industrial-grade asphalt shingle roofing in Odessa TX. Chemical-resistant materials for petrochemical environment. Call (806) 622-6041",
  openGraph: {
    title: "Asphalt Shingle Roofing Odessa TX | 5 Star Roofing",
    description:
      "Industrial-grade asphalt shingle roofing in Odessa TX. Chemical-resistant materials for petrochemical environment. Call (806) 622-6041",
  ...
  return (
    <>      {/* Sticky Contact Bar */}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Industrial-grade asphalt shingle roofing in Odessa TX. Chemical-resistant materials for petrochemical environment.",
            parentOrganization: { "@id": "https://5starroofingpros.com/#organization" },
            serviceArea: {
              "@type": "GeoCircle",
              geoMidpoint: { "@type": "GeoCoordinates", latitude: 31.8457, longitude: -102.3676 },
              geoRadius: "50000",
            },
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Chemical-resistant asphalt shingle installation for Odessa's petrochemical environment",
            ...
            hasOfferCatalog: {
              ...
              itemListElement: [
                {
                  "@type": "Offer",
                  itemOffered: { "@type": "Service", name: "Chemical-Resistant Shingle Systems" },
                },
                {
                  "@type": "Offer",
                  itemOffered: {
                    "@type": "Service",
                    name: "Budget-Friendly Architectural Shingles",
                  },
                },
                {
                  "@type": "Offer",
                  itemOffered: { "@type": "Service", name: "Working Family Roof Financing" },
                },
                {
                  "@type": "Offer",
                  itemOffered: { "@type": "Service", name: "Industrial Air Quality Roofing" },
                },
                {
                  "@type": "Offer",
                  itemOffered: { "@type": "Service", name: "Permian Basin Storm Protection" },
                },
              ],
            },
          }),
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "How do petrochemicals affect asphalt shingles in Odessa?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Odessa's petrochemical emissions can accelerate shingle deterioration. We use chemical-resistant granules and enhanced sealants designed for industrial exposure. Proper ventilation prevents chemical accumulation in attic spaces.",
                },
              },
              {
                "@type": "Question",
                name: "What's the most affordable asphalt shingle option for Odessa homes?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Quality architectural shingles start at $10,000-$14,000 in Odessa. We offer financing options for working families. Standard architectural provides 20+ years with proper installation and is much better than basic 3-tab for local conditions.",
                },
              },
              {
                "@type": "Question",
                name: "Do Odessa homes need special air quality protection in roofing?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Yes! Enhanced attic ventilation and sealed roofing systems prevent industrial pollutants from entering living spaces. We install air barriers and filtration systems as standard practice in Odessa's industrial environment.",
                },
              },
              {
                "@type": "Question",
                name: "How much does asphalt shingle roofing cost in Odessa?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Odessa pricing: Architectural $10,000-$14,000, chemical-resistant premium $12,500-$17,500, Class 4 impact-resistant $15,000-$21,000. We offer financing and work with insurance for storm damage claims.",
                },
              },
              {
                "@type": "Question",
                name: "What shingle colors hide Odessa's industrial dust best?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Medium tones like Desert Beige, Weathered Wood, and Oyster Shell hide industrial dust while reflecting heat. Avoid pure white (shows dirt immediately) and very dark colors (excessive heat in desert climate).",
                },
              },
              {
                "@type": "Question",
                name: "How do I protect my Odessa home from industrial air pollution?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Sealed roofing systems with enhanced ventilation and filtration. We install synthetic underlayment barriers, sealed penetrations, and properly designed attic airflow to maintain indoor air quality in industrial environments.",
                },
              },
            ],
          }),
      ...
      />
        ...
        h1="Asphalt Shingle Roofing in Odessa, TX"
        ...
        <section className="container-custom mt-8">
          <div className="max-w-5xl mx-auto bg-amber-50 border-l-4 border-brand-gold rounded-r-2xl p-6">
            ...
            <ul className="space-y-2 text-gray-800 font-medium leading-relaxed">
              <li className="flex gap-2"><span className="text-brand-gold flex-shrink-0">•</span><span>What this page covers: Asphalt Shingle Roofing for homes and businesses in Odessa, Texas.</span></li>
      ...
      <div className="container-custom py-12">
        <FadeIn>
          <section className="mb-16 max-w-5xl mx-auto">
            <h2 className="text-4xl font-bold mb-8 text-brand-brown">
              What Should You Know About Odessa's Industrial Environment?
            </h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-lg text-gray-700 mb-4 leading-relaxed">
                  Odessa's position as a petrochemical processing center creates unique roofing
                  challenges that require specialized solutions:
                </p>
                <ul className="space-y-2 text-gray-700">
                  <li>
                    • <strong>Chemical emissions:</strong> Airborne petrochemicals affecting
                    material integrity
                  </li>
                  <li>
                    • <strong>Industrial particulates:</strong> Fine particles from processing
                    operations
                  </li>
                  <li>
                    • <strong>Air quality concerns:</strong> Need for enhanced home sealing
                  </li>
                  <li>
                    • <strong>Desert heat:</strong> 105°F+ summers with intense UV exposure
                  </li>
                  <li>
                    • <strong>Economic considerations:</strong> Working-family budgets requiring
                    value
                  </li>
                </ul>
              </div>
              <div>
                ...
                <p className="text-lg text-gray-700 mb-4 leading-relaxed">
                  Over 200 installations in Odessa have taught us to balance performance with
                  affordability:
                </p>
                <ul className="space-y-2 text-gray-700">
        ...
        <FadeIn>
          <section className="mb-16 bg-gradient-to-br from-amber-50 to-white p-12 rounded-3xl shadow-lg">
            <h2 className="text-4xl font-bold mb-8 text-center text-brand-brown">
              Asphalt Shingle Options for Every Odessa Family?
            </h2>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div className="bg-white p-8 rounded-2xl shadow-lg border-2 border-green-500 relative">
                ...
                <p className="text-gray-700 mb-6">
                  Solid performance for working families. Chemical-resistant granules and proper
                  installation for 20+ years.
                </p>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg border-2 border-brand-gold relative">
                ...
                <p className="text-gray-700 mb-6">
                  Enhanced chemical protection and air quality features. Recommended for families
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg border border-brand-gold-vibrant relative">
                ...
                <p className="text-gray-700 mb-6">
                  Maximum protection for investment properties and families wanting the best
                  performance.
                </p>
                <ul className="space-y-2 text-gray-600 text-sm">
            ...
            <div className="bg-gradient-to-r from-brand-brown to-brand-gold text-white p-8 rounded-2xl">
              ...
              <p className="text-lg mb-4">
                We understand roofing is a major investment for working families. Our flexible
                financing makes quality roofing affordable without compromising protection.
              </p>
        ...
        <FadeIn>
          <section className="mb-16">
            <h2 className="text-4xl font-bold mb-8 text-center text-brand-brown">
              Chemical Resistance & Air Quality Protection?
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-12 mb-12">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-6 text-brand-brown">
                  Odessa Color & Style Recommendations
                </h3>
                <div className="space-y-6">
                  <div>
                    <h4 className="text-lg font-bold mb-3 text-brand-brown">
                      Recommended Colors for Industrial Areas
                    </h4>
                    <ul className="space-y-2 text-gray-700">
                      <li>
            ...
            <div className="bg-gradient-to-br from-red-50 to-orange-50 p-8 rounded-2xl">
              <h3 className="text-2xl font-bold mb-4 text-brand-brown">
                Odessa Environmental Impact Data
              </h3>
          ...
          <section className="mb-16 bg-gradient-to-br from-green-50 to-white p-12 rounded-3xl shadow-lg">
            ...
            <div className="space-y-8">
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  ...
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex items-start">
                      ...
                      <span>
                        <strong>Air Quality Evaluation:</strong> Assessing proximity to industrial
                        operations
                      </span>
                    </li>
                    <li className="flex items-start">
                      ...
                      <span>
                        <strong>Chemical Exposure Analysis:</strong> Determining optimal material
                        specifications
                      </span>
                    </li>
                    <li className="flex items-start">
                      ...
                      <span>
                        <strong>Ventilation Planning:</strong> Designing healthy airflow systems
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  <h3 className="text-2xl font-bold mb-4 text-brand-brown">
                    Enhanced Protection Installation
                  </h3>
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex items-start">
                      <span className="bg-brand-gold text-white rounded-full w-6 h-6 flex items-center justify-center text-sm mr-3 mt-1">
                      ...
                      <span>
                        <strong>Air Barrier Systems:</strong> Complete envelope sealing against
                        infiltration
                      </span>
                    </li>
                    <li className="flex items-start">
                      ...
                      <span>
                        <strong>Chemical-Resistant Materials:</strong> Premium sealants and barriers
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="bg-brand-gold text-white rounded-full w-6 h-6 flex items-center justify-center text-sm mr-3 mt-1">
                      ...
                      <span>
                        <strong>Enhanced Ventilation:</strong> Balanced fresh air with filtration
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="grid md:grid-cols-4 gap-6">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-600">
                      Tear-off, air quality assessment, and deck preparation.
                    </p>
                  </div>
                  <div className="text-center">
                    <div className="bg-brand-gold text-white rounded-full w-16 h-16 flex items-center justify-center text-xl font-bold mx-auto mb-3">
                    ...
                    <p className="text-sm text-gray-600">
                      Air barrier installation and enhanced underlayment.
                    </p>
                  </div>
                  <div className="text-center">
                    <div className="bg-brand-gold text-white rounded-full w-16 h-16 flex items-center justify-center text-xl font-bold mx-auto mb-3">
                    ...
                    <p className="text-sm text-gray-600">
                      Chemical-resistant shingle installation with sealed fastening.
                    </p>
                  </div>
                  <div className="text-center">
                    <div className="bg-brand-gold text-white rounded-full w-16 h-16 flex items-center justify-center text-xl font-bold mx-auto mb-3">
                    ...
                    <p className="text-sm text-gray-600">
                      Ventilation installation, sealing verification, and quality control.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <Accordion type="single" collapsible className="max-w-4xl mx-auto">
              ...
              >
                <AccordionTrigger className="text-lg font-semibold text-brand-brown hover:text-brand-gold">
                  How do petrochemicals affect asphalt shingles in Odessa?
                </AccordionTrigger>
                <AccordionContent className="text-gray-700 leading-relaxed">
                  Odessa's petrochemical emissions can accelerate shingle deterioration. We use
                  chemical-resistant granules and enhanced sealants designed for industrial
                  exposure. Proper ventilation prevents chemical accumulation in attic spaces.
                </AccordionContent>
              </AccordionItem>
              ...
              >
                <AccordionTrigger className="text-lg font-semibold text-brand-brown hover:text-brand-gold">
                  What's the most affordable asphalt shingle option for Odessa homes?
                </AccordionTrigger>
                <AccordionContent className="text-gray-700 leading-relaxed">
                  Quality architectural shingles start at $10,000-$14,000 in Odessa. We offer
                  financing options for working families. Standard architectural provides 20+ years
                  with proper installation and is much better than basic 3-tab for local conditions.
                </AccordionContent>
              </AccordionItem>
              ...
              >
                <AccordionTrigger className="text-lg font-semibold text-brand-brown hover:text-brand-gold">
                  Do Odessa homes need special air quality protection in roofing?
                </AccordionTrigger>
                <AccordionContent className="text-gray-700 leading-relaxed">
                  Yes! Enhanced attic ventilation and sealed roofing systems prevent industrial
                  pollutants from entering living spaces. We install air barriers and filtration
                  systems as standard practice in Odessa's industrial environment.
                </AccordionContent>
              </AccordionItem>
              ...
              >
                <AccordionTrigger className="text-lg font-semibold text-brand-brown hover:text-brand-gold">
                  How much does asphalt shingle roofing cost in Odessa?
                </AccordionTrigger>
                <AccordionContent className="text-gray-700 leading-relaxed">
                  Odessa pricing: Architectural $10,000-$14,000, chemical-resistant premium
                  $12,500-$17,500, Class 4 impact-resistant $15,000-$21,000. We offer financing and
                  work with insurance for storm damage claims.
                </AccordionContent>
              </AccordionItem>
              ...
              >
                <AccordionTrigger className="text-lg font-semibold text-brand-brown hover:text-brand-gold">
                  What shingle colors hide Odessa's industrial dust best?
                </AccordionTrigger>
                <AccordionContent className="text-gray-700 leading-relaxed">
                  Medium tones like Desert Beige, Weathered Wood, and Oyster Shell hide industrial
                  dust while reflecting heat. Avoid pure white (shows dirt immediately) and very
                  dark colors (excessive heat in desert climate).
                </AccordionContent>
              </AccordionItem>
              ...
              >
                <AccordionTrigger className="text-lg font-semibold text-brand-brown hover:text-brand-gold">
                  How do I protect my Odessa home from industrial air pollution?
                </AccordionTrigger>
                <AccordionContent className="text-gray-700 leading-relaxed">
                  Sealed roofing systems with enhanced ventilation and filtration. We install
                  synthetic underlayment barriers, sealed penetrations, and properly designed attic
                  airflow to maintain indoor air quality in industrial environments.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </section>
        </FadeIn>
        <InternalLinks currentCity="odessa" currentService="asphalt-shingle-roofing" />

        <section className="bg-gradient-to-r from-brand-brown to-brand-gold text-white p-12 rounded-3xl text-center">
          <h2 className="text-4xl font-bold mb-6">Protect Your Odessa Family Today?</h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Chemical-resistant asphalt shingle roofing designed for Odessa's industrial environment.
            Family-affordable options with financing available. Quality installation protecting your
            home and health.
          </p>
        ...
        <RelatedArticles pageSlug="asphalt-shingle-roofing-odessa" />
      </div>
    </>
  );
}
