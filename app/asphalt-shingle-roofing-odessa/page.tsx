          ...
          <FadeIn>
            <div className="max-w-4xl">
              <h1 className="text-6xl font-bold mb-6 text-white leading-tight">
                Asphalt Shingle Roofing in <span className="text-brand-gold-light">Odessa</span>
              </h1>
              <p className="text-3xl mb-6 font-bold text-brand-gold-light">
                Industrial Tough & Family Affordable
              </p>
              <p className="text-xl mb-8 text-white leading-relaxed">
                Professional asphalt shingle roofing built for Odessa's petrochemical environment.
                Chemical-resistant materials, budget-friendly options, and financing available for
                working families.
              </p>
