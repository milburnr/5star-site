...
export const metadata: Metadata = {
  ...
  description: "Industrial-grade asphalt shingle roofing in Odessa TX. Chemical-resistant materials for petrochemical environment. Call (806) 622-6041",
  openGraph: {
    title: "Asphalt Shingle Roofing Odessa TX | 5 Star Roofing",
    description: "Industrial-grade asphalt shingle roofing in Odessa TX. Chemical-resistant materials for petrochemical environment. Call (806) 622-6041",
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "name": "5 Star Roofing",
        "image": "https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/shingle/shingle-borger-8-1280w.jpg",
      ...
      <section className="relative bg-cover bg-center text-white py-32 min-h-[700px] flex items-center" style={{ backgroundImage: 'url(https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/hail-damage/hail-damage-canyon-4-1280w.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <section className="py-16 bg-gradient-to-b from-amber-50 to-white">
          <div className="container-custom">
            <div className="grid md:grid-cols-4 gap-8 text-center">
              <div className="bg-white p-8 rounded-2xl shadow-lg"><div className="text-4xl font-bold text-brand-gold mb-3"><BadgeCheck className="w-6 h-6 inline-block" /></div><div className="text-brand-brown font-semibold text-lg">Chemical Resistant</div></div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg"><div className="text-3xl mb-3"><Factory className="w-6 h-6 inline-block" /></div><div className="text-brand-brown font-semibold text-lg">Industrial Rated</div></div>
            </div>
          </div>
        </section>
      </FadeIn>
