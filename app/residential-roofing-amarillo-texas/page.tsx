...
export default function ResidentialAmarilloPage() {
  return (
    <div className="min-h-screen">      <Breadcrumb items={[
      ...
      <section className="hero" style={{backgroundImage: 'url(https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/shingle/shingle-amarillo-41-1280w.webp)', backgroundPosition: 'center'}}>
