          ...
          <section className="section">
            <div className="max-w-4xl mx-auto text-center mb-12">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                Located at 2909 S Western St in Amarillo, 5 Star Commercial Roofing has been
                protecting homes and businesses throughout the Texas Panhandle for over a decade.
                From the historic neighborhoods of Wolflin to the growing developments near Coulter
                Street, we understand Amarillo&apos;s unique roofing challenges. Compare{" "}
                <a
                  href="/roofing-methods-in-amarillo/"
                  className="text-brand-brown hover:text-brand-gold underline"
                >
                  roofing methods suited for Amarillo
                </a>{" "}
          ...
          <section className="section bg-gray-50 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 rounded-lg mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Headquartered in Amarillo with deep familiarity in every neighborhood from Soncy
                  Road to Loop 335. No travel delays from out-of-state crews.
                </p>
              </div>
              <div className="text-center">
                <div className="text-5xl mb-4">
                ...
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="md:w-2/3">
                    <p className="text-gray-600 mb-4 leading-relaxed">
                      Amarillo experiences some of the most severe hail storms in Texas. From the
                      Wolflin neighborhood to Southwest Amarillo, we&apos;ve repaired thousands of
                      hail-damaged roofs. Our experts can spot even subtle granule loss and help you
                      document damage for your insurance claim.
                    </p>
                    <p className="text-gray-600 mb-4">
                      <strong>What we do:</strong> Free hail damage inspections, comprehensive photo
                      documentation, insurance claim assistance, and full roof replacement if
                      needed. We work with all major insurance companies.
                    </p>
                    <a
            ...
            <FadeIn delay={0.2}>
              <div className="card-hover p-8">
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="md:w-2/3">
                    <p className="text-gray-600 mb-4 leading-relaxed">
                      Whether you own a historic home near San Jacinto or a new build in Sleepy
                      Hollow, we provide complete residential roofing services. From asphalt shingle
                      replacement to complete tear-offs, we handle projects of all sizes throughout
                      Amarillo.
                    </p>
                    <p className="text-gray-600 mb-4">
                      <strong>Services include:</strong> Roof replacement, roof repair, shingle
                      installation, ventilation upgrades, and warranty work. We use only premium
                      materials designed for Amarillo&apos;s extreme weather.
                    </p>
                    <p className="text-gray-600 mb-4">
                      Explore our full range of{" "}
                      <a
                        href="/amarillo-homes-roofing-services/"
                        className="text-brand-gold hover:text-brand-gold-vibrant underline"
                      >
                        roofing services for Amarillo homes
                      </a>
                      , or learn why homeowners call us{" "}
                      <a
            ...
            <FadeIn delay={0.3}>
              <div className="card-hover p-8">
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="md:w-2/3">
                    <p className="text-gray-600 mb-4 leading-relaxed">
                      Serving Amarillo&apos;s business community from the Amarillo Medical Center to
                      industrial facilities near the airport. We specialize in flat roof systems,
                      TPO, EPDM, and modified bitumen installations that stand up to Amarillo&apos;s
                      harsh climate.
                    </p>
                    <p className="text-gray-600 mb-4">
            ...
            <FadeIn delay={0.4}>
              <div className="card-hover p-8">
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="md:w-2/3">
                    <p className="text-gray-600 mb-4 leading-relaxed">
                      Metal roofing is an excellent choice for Amarillo homes. It handles our
                      extreme temperature swings, high winds, and hail better than traditional
                      shingles. Plus, it can last 50+ years with minimal maintenance.
                    </p>
                    <p className="text-gray-600 mb-4">
                      <strong>Metal roofing options:</strong> Standing seam, corrugated panels,
                      metal shingles, and commercial metal roofing systems. Energy-efficient and
                      beautiful.
                    </p>
                    <a
            ...
            <FadeIn delay={0.5}>
              <div className="card-hover p-8">
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="md:w-2/3">
                    <p className="text-gray-600 mb-4 leading-relaxed">
                      Don&apos;t wait for a leak to find out your roof is damaged. Our free roof
                      inspections throughout Amarillo can catch problems early, saving you thousands
                      in repair costs. We&apos;ll check for hail damage, wind damage, and normal
                      wear.
                    </p>
                    <p className="text-gray-600 mb-4">
                      <strong>Inspection includes:</strong> Complete roof assessment, attic
                      ventilation check, shingle condition analysis, flashing inspection, and
                      detailed photo report. 100% free, no obligation.
                    </p>
                    <a
          ...
          <section className="section">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg text-gray-600 leading-relaxed mb-6">
                The Amarillo metropolitan area has a population exceeding 200,000 across Potter and
                Randall Counties. As the largest city in the Texas Panhandle and a regional hub for
                healthcare, agriculture, and energy, Amarillo has diverse housing stock ranging from
                historic early-1900s homes near downtown to modern construction in master-planned
                communities along Coulter Road and Soncy Road.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed mb-6">
                At 3,605 feet elevation with over 260 days of sunshine annually, Amarillo roofs face
                UV exposure significantly more intense than lower-elevation Texas cities. This is
                compounded by temperature swings from 100&deg;F+ summer days to below-zero winter
                nights&mdash;sometimes within the same week. Standard shingles rated for 25&ndash;30
                year lifespans typically last 15&ndash;20 years in Amarillo&apos;s demanding
                climate. Proper material selection and expert installation are the difference
                between a roof that fails prematurely and one that delivers its full expected
                lifespan.
              </p>
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-gray-50 p-5 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">
                    200,000+ metro population spanning two counties, with Amarillo&apos;s city
                    limits crossing both. Building codes and permit requirements differ by
                    county&mdash;we handle both.
                  </p>
                </div>
                <div className="bg-gray-50 p-5 rounded-lg">
                  <h3 className="font-bold text-brand-brown mb-2">Housing Age Mix</h3>
                  <p className="text-sm text-gray-600">
                    From historic San Jacinto Heights homes built in the 1920s to newer Sleepy
                    Hollow and Bishopsgate developments. Each era presents different roofing
                    challenges.
                  </p>
                </div>
                <div className="bg-gray-50 p-5 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">
                    Many Amarillo neighborhoods including Bishopsgate, Barrington Place, and the
                    Colonies have HOA guidelines for roofing materials and colors. We ensure
                    compliance.
                  </p>
                </div>
              </div>
            ...
            <div className="max-w-4xl mx-auto space-y-6">
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="text-lg font-bold text-red-700 mb-2">
                  May 18, 2023 &mdash; 2.5-Inch Hail North of Amarillo
                </h3>
                <p className="text-gray-700">
                  Severe hail measuring 2.50 inches struck 14 miles north of Amarillo in Potter
                  County, with additional 2-inch hail near Pantex in Carson County. NWS damage
                  reports documented windows blown out on the north side of homes and trees stripped
                  by the storm system. Multiple Potter County locations reported hail ranging from 1
                  to 2.5 inches.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="text-lg font-bold text-brand-brown mb-2">
                  May 20, 2019 &mdash; Hail Hits Sleepy Hollow
                </h3>
                <p className="text-gray-700">
                  Quarter-sized hail struck multiple Amarillo neighborhoods on May 20, 2019, with
                  NWS storm reports specifically documenting hail in the Sleepy Hollow neighborhood.
                  Randall County recorded 1.27-inch hail near Timbercreek Canyon, while multiple
                  locations across both Potter and Randall Counties reported quarter-sized stones
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <p className="text-gray-700">
                  Hail measuring 1.75 inches struck northern Potter County, adding to what was
                  already a severe 2019 hail season for the Amarillo metro area. The Texas
                  Panhandle&apos;s position in &quot;Hail Alley&quot; means these events recur
                  regularly between March and September.
                </p>
              </div>
              <p className="text-center text-gray-500 text-sm mt-4">
                Texas leads the nation with 900+ reported hail events annually. The Panhandle&apos;s
                position in &quot;Hail Alley&quot; means Potter and Randall Counties experience
                significant hail events every 1&ndash;3 years.
              </p>
            </div>
          </section>
        </FadeIn>
            ...
            <div className="max-w-4xl mx-auto space-y-6">
              <div>
                <h3 className="text-xl font-bold text-brand-brown mb-2">
                  <Tornado className="w-6 h-6 inline-block" /> Severe Hail Storms
                </h3>
                <p className="text-gray-700">
                  Amarillo sits in &quot;Hail Alley&quot; and experiences frequent severe
                  thunderstorms from March through September. The May 2023 storm brought 2.5-inch
                  hail north of the city, while the May 2019 event hit the Sleepy Hollow
                  neighborhood directly. Even quarter-sized hail can cause significant granule loss
                  on asphalt shingles, leading to premature aging and leaks.
                </p>
              </div>
              <div>
                <h3 className="text-xl font-bold text-brand-brown mb-2">
                ...
                <p className="text-gray-700">
                  The Texas Panhandle is one of the windiest regions in the United States. Sustained
                  winds of 30-40 mph and gusts over 60 mph can lift shingles, tear off flashing, and
                  damage roof edges. Proper installation with wind-rated materials is critical.
                </p>
              </div>
              <div>
                <h3 className="text-xl font-bold text-brand-brown mb-2">
                ...
                <p className="text-gray-700">
                  Amarillo can see 100°F summer days and below-zero winter nights, sometimes within
                  the same week. This expansion and contraction puts tremendous stress on roofing
                  materials, accelerating wear and causing cracking. Winter conditions also create
                  risk for{" "}
                  <a
                    href="/roof-snow-and-ice-damage-in-amarillo/"
                    className="text-brand-brown hover:text-brand-gold underline"
                  >
                    snow and ice damage
                  </a>
                  , while moisture intrusion can lead to{" "}
                  <a
              ...
              <div>
                ...
                <p className="text-gray-700">
                  At 3,605 feet elevation with over 260 days of sunshine annually, Amarillo roofs
                  face intense UV radiation that breaks down organic materials. This is why we
                  recommend impact-resistant, UV-stabilized shingles for maximum longevity.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="section">
            ...
            <div className="max-w-5xl mx-auto">
              <p className="text-center text-gray-600 mb-8 text-lg">
                From historic neighborhoods near downtown to new developments along Soncy Road, we
                provide expert roofing services throughout Amarillo:
              </p>
              ...
              <p className="text-center text-gray-600 mt-8">
                Wolflin&apos;s tree-lined streets and mid-century homes require different roofing
                approaches than the newer two-story construction in Bishopsgate or Barrington Place.
                San Jacinto Heights features some of Amarillo&apos;s oldest homes, many with
                original roofing structures that demand specialized repair. We understand the unique
                requirements of every Amarillo neighborhood.
              </p>
            </div>
          </section>
        </FadeIn>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-brand-brown mb-4">
                      Serving All of Amarillo
                    </h3>
                    <p className="text-gray-700 mb-4">
                      Located on South Western Street, we&apos;re centrally positioned to serve all
                      of Amarillo — from the northern neighborhoods near Tascosa to South Amarillo
                      near I-27. Local crews, no out-of-state contractors.
                    </p>
                    <p className="text-gray-700 mb-4">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Professional roofing contractor serving Amarillo, Texas. Expert hail damage repair, residential and commercial roofing services.",
            address: {
              "@type": "PostalAddress",
              ...
              itemListElement: [
                {
                  ...
                  itemOffered: {
                    ...
                    description:
                      "Expert hail damage assessment, documentation, and repair services",
                  },
                },
                {
                  "@type": "Offer",
