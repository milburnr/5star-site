  ...
  return (
    <div className="container-custom py-12">      <Breadcrumb items={[
      ...
      <div className="card mb-8">
        <img loading="lazy" src="/images/asphaltshingles.jpg" alt="Roofing services in Amarillo, TX - Class 4 impact-resistant asphalt shingles - Hail protection roofing - 5 Star Commercial Roofing" className="card-image" />
      ...
      <div className="card mb-8">
        <img loading="lazy" src="/images/SteelRoofing.jpg" alt="Roofing services in Amarillo, TX - Standing seam metal roof - Ultimate hail protection - 5 Star Commercial Roofing" className="card-image" />
        <div className="card-body">
      ...
      <div className="card mb-8">
        <img loading="lazy" src="/images/TPO1.jpg" alt="Roofing services in Amarillo, TX - TPO commercial roofing installation - White membrane flat roof system - 5 Star Commercial Roofing" className="card-image" />
        <div className="card-body">
      ...
      <div className="card mb-8">
        <img loading="lazy" src="/images/commercial-roofing-2.jpg" alt="Modified bitumen roofing installation - Commercial flat roof systems - 5 Star Commercial Roofing Amarillo" className="card-image" />
        <div className="card-body">
