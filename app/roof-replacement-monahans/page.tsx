          ...
          <FadeIn>
            <div className="max-w-4xl">
              <h1 className="text-6xl font-bold mb-6 text-white leading-tight">
                Roof Replacement in <span className="text-brand-gold-light">Monahans, Texas</span>
              </h1>
              <p className="text-3xl mb-6 font-bold text-brand-gold-light">
                Expert Desert Climate Roofing Solutions
              </p>
              <p className="text-xl mb-8 text-white leading-relaxed">
                Professional roof replacement throughout Monahans and West Texas. Specializing in
                desert climate roofing systems engineered for extreme heat, windblown sand, and
                temperature fluctuations. Expert installation, comprehensive warranties, and .
              </p>
