  ...
  return (
    <>      <Breadcrumb items={[
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "name": "5 Star Commercial Roofing - Borger Asphalt Shingle Roofing",
        ...
        "description": "Expert asphalt shingle roofing services in Borger, TX. Free inspections, insurance claim assistance, 24/7 emergency response.",
      ...
      <section
        ...
        style={{
          backgroundImage: 'url(https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/shingle/shingle-borger-24-1280w.webp)',
