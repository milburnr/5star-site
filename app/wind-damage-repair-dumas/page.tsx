  ...
  return (
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Expert wind damage repair services in Dumas, TX. Free inspections, insurance claim assistance, prompt response.",
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url(https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/hail-damage/hail-damage-canyon-5-1280w.webp)",
          ...
          <FadeIn>
            <div className="max-w-4xl">
              ...
              <p className="text-xl mb-8 text-white leading-relaxed">
                Expert wind damage roof repair in Dumas TX. Texas Panhandle experiences 6-8
