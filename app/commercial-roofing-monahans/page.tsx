...
export const metadata: Metadata = {
  ...
  description: "Professional commercial roofing in Monahans TX. Expert installation, repair & insurance assistance. Free inspections. Call (806) 622-6041",
  openGraph: {
    title: "Commercial Roofing Monahans TX | 5 Star Roofing",
    description: "Professional commercial roofing in Monahans TX. Expert installation, repair & insurance assistance. Free inspections. Call (806) 622-6041",
...
export default function CommercialRoofingMonahansPage() {
  return (
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Professional commercial roofing services in Monahans, Texas. Expert installation, repair, and maintenance with prompt response.",
            "provider": {
              "@type": ["LocalBusiness", "RoofingContractor"],
              "name": "5 Star Roofing",
              "telephone": "(806) 622-6041",
      ...
      <section className="relative bg-cover bg-center text-white py-32 min-h-[700px] flex items-center" style={{ backgroundImage: 'url(https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/shingle/shingle-san-angelo-26-1280w.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <div className="container-custom relative z-10">
          <FadeIn>
            <div className="max-w-4xl">
              ...
              <p className="text-xl mb-8 text-white leading-relaxed">Professional commercial roofing throughout Monahans. Expert installation, comprehensive warranties, and . Free inspections and insurance assistance available.</p>
      ...
      <div className="container-custom py-12">
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white p-8 rounded-2xl shadow-lg border-l-4 border-black">
                <h3 className="text-2xl font-bold text-brand-brown mb-4"><Fuel className="w-6 h-6 inline-block" /> Petroleum Marketing Center</h3>
                ...
                <p className="text-gray-700 mt-4 leading-relaxed">Petroleum industry roofing must provide chemical resistance, fire safety compliance, and structural capacity for heavy equipment while supporting operations critical to regional oil production.</p>
              </div>
              
              <div className="bg-white p-8 rounded-2xl shadow-lg border-l-4 border-green-500">
                <h3 className="text-2xl font-bold text-brand-brown mb-4"><Leaf className="w-6 h-6 inline-block" /> Hydroponic Agriculture</h3>
            ...
            <div className="grid md:grid-cols-2 gap-8 mt-8">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg border-l-4 border-yellow-500">
                <h3 className="text-2xl font-bold text-brand-brown mb-4"><Palmtree className="w-6 h-6 inline-block" /> Sand Mining & Tourism</h3>
        ...
        <FadeIn>
          <section className="mb-16 bg-gradient-to-br from-gray-50 to-orange-50 p-10 rounded-3xl">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="text-center">
                <div className="bg-brand-gold w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-white text-2xl"><Waves className="w-6 h-6 inline-block" /></span>
                </div>
        ...
        <FadeIn>
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white p-8 rounded-2xl shadow-lg">
                <h3 className="text-2xl font-bold text-brand-brown mb-4"><Factory className="w-6 h-6 inline-block" /> Economic Development Financing</h3>
