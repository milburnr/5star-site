...
export default function CommercialRoofingMonahansPage() {
  return (
    <>
      ...
      <section className="relative bg-cover bg-center text-white py-32 min-h-[700px] flex items-center" style={{ backgroundImage: 'url(https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/heroes/hero-commercial-11-1920w.webp)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
