        ...
        <section className="container-custom mt-8">
          <div className="max-w-5xl mx-auto bg-amber-50 border-l-4 border-brand-gold rounded-r-2xl p-6">
            ...
            <ul className="space-y-2 text-gray-800 font-medium leading-relaxed">
              <li className="flex gap-2"><span className="text-brand-gold flex-shrink-0">•</span><span>What this page covers: TPO Roofing for homes and businesses in Snyder, Texas.</span></li>
          ...
          <section className="mb-16 bg-white p-12 rounded-3xl shadow-2xl">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="text-center p-6">
                ...
                <p className="text-gray-600 text-sm">Municipal facilities, scheduling</p>
              </div>
            </div>
