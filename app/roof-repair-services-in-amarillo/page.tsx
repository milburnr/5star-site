...
export const metadata: Metadata = {
  ...
  description: "Trusted roof repair services in Amarillo TX since 2014. Emergency storm damage repair, hail damage restoration, leak repair, insurance claims assistance.",
};
