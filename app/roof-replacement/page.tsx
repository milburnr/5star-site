...
export const metadata: Metadata = {
  ...
  description:
    "Full roof replacement across West Texas. Shingles, metal, TPO, and flat roof options with financing and insurance claim coordination. Free estimates.",
  openGraph: {
    title: "Roof Replacement West Texas | 5 Star Roofing",
    description:
      "Full roof replacement across West Texas. Shingles, metal, TPO, and flat roof options with financing and insurance claim coordination. Free estimates.",
...
export default function Page() {
  const serviceSchema = {
    ...
    description:
      "Complete roof replacement services across West Texas. Asphalt shingle, metal, TPO, and flat roof systems with full tear-off, material selection, and warranty coverage.",
    hasOfferCatalog: {
      "@type": "OfferCatalog",
    ...
    />
        ...
        <section className="container-custom mt-8">
          <div className="max-w-5xl mx-auto bg-amber-50 border-l-4 border-brand-gold rounded-r-2xl p-6">
            ...
            <ul className="space-y-2 text-gray-800 font-medium leading-relaxed">
              <li className="flex gap-2"><span className="text-brand-gold flex-shrink-0">•</span><span>What this page covers: Roof Replacement across the Texas Panhandle and West Texas, including Amarillo, Lubbock, Midland, and Odessa.</span></li>
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-6">
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-700">
                <li>
                  <strong>Asphalt shingles:</strong> 20-25 years is the typical lifespan in West
                  Texas, often shorter due to intense UV exposure and hail
                </li>
                <li>
                  <strong>Metal roofing:</strong> 40-50 years before panels need replacing, though
                  fasteners and sealants may need attention sooner
                </li>
                <li>
                  <strong>Flat roofs (TPO/EPDM):</strong> 15-20 years depending on maintenance and
                  membrane quality
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-700">
                <li>
                  Multiple repair bills in the same year adding up to more than half the cost of
                  replacement
                </li>
      ...
      <FadeIn>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-2xl hover:scale-105 transition-all duration-300">
            <div className="p-6">
              ...
              <p className="mb-3">
                The most popular residential roofing choice in Texas. Available in three tiers to
                match different budgets and performance needs.
              </p>
              <ul className="list-disc list-inside space-y-1 text-gray-600">
                <li>
                  <strong>3-Tab shingles:</strong> Entry-level, flat profile, 15-20 year warranty
                </li>
                <li>
                  <strong>Architectural (dimensional):</strong> Thicker, layered look, 25-30 year
                  warranty, better wind resistance
                </li>
                <li>
                  <strong>Designer shingles:</strong> Premium appearance mimicking slate or wood
                  shake, 30-50 year warranty
                </li>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-2xl hover:scale-105 transition-all duration-300">
            <div className="p-6">
              ...
              <p className="mb-3">
                Premium durability for homeowners who want a roof that outlasts the mortgage.
                Increasingly popular across West Texas for its hail resistance and energy savings.
              </p>
              <ul className="list-disc list-inside space-y-1 text-gray-600">
                <li>
                  <strong>Standing seam:</strong> Concealed fasteners, clean modern lines, 40-50
                  year lifespan
                </li>
                <li>
                  <strong>Corrugated metal:</strong> Budget-friendly with proven performance for
                  decades
                </li>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-2xl hover:scale-105 transition-all duration-300">
            <div className="p-6">
              <h3 className="text-xl font-semibold text-brand-brown mb-3">
                TPO, PVC, and EPDM (Flat Roofs)
              </h3>
              <p className="mb-3">
                Single-ply membrane systems designed for low-slope and flat roofs common on
                commercial buildings and some residential additions.
              </p>
              <ul className="list-disc list-inside space-y-1 text-gray-600">
                <li>
                  <strong>TPO:</strong> White reflective surface, heat-welded seams, energy
                  efficient
                </li>
                <li>
                  <strong>PVC:</strong> Superior chemical resistance, ideal for restaurants and
                  industrial buildings
                </li>
                <li>
                  <strong>EPDM:</strong> Proven rubber membrane, flexible in temperature extremes
                </li>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-2xl hover:scale-105 transition-all duration-300">
            <div className="p-6">
              ...
              <p className="mb-3">
                Multiple-layer systems that have protected flat-roofed buildings for over a century.
                Built-up roofing stacks alternating layers of bitumen and reinforcing fabric.
              </p>
              <ul className="list-disc list-inside space-y-1 text-gray-600">
        ...
        <h3 className="text-xl font-bold mt-8 mb-4 text-brand-brown">
          Roof Replacement Material Comparison
        </h3>
      ...
      <FadeIn>
        ...
        <p className="mb-6">
          A roof replacement is one of the largest home improvement projects you can undertake.
          Knowing what happens at each stage helps you plan around the disruption and make informed
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow text-center">
            ...
            <p className="text-sm text-gray-600">
              Complete removal of old roofing, deck inspection and repair, ice and water shield
              application, underlayment, and new roof installation.
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow text-center">
      ...
      <FadeIn>
        <h2 className="text-2xl font-bold mt-12 mb-4">
          How Do Financing and Insurance Work for Roof Replacement?
        </h2>
        <div className="bg-white rounded-lg shadow-md p-8 mb-8">
          <p className="mb-4">
            A roof replacement is a significant investment, and we work to make the process as
            manageable as possible. Read our{" "}
            <a
              href="/budgeting-for-roof-replacement-expenses/"
              className="text-brand-brown hover:text-brand-gold underline font-semibold"
            >
              guide to budgeting for roof replacement expenses
            </a>{" "}
            to plan ahead. Whether you are paying out of pocket or filing an insurance claim, we
            have experience guiding homeowners through the financial side.
          </p>
      ...
      <FadeIn>
        <section className="mb-16">
          ...
          <p className="mb-4">
            We provide roof replacement services throughout the Texas Panhandle, Permian Basin, and
            South Plains. Select your city for local details and scheduling.
          </p>
      ...
      <section>
        ...
        <Accordion type="single" collapsible>
          <AccordionItem value="faq-1">
            <AccordionTrigger>
              How much does a full roof replacement cost in West Texas?
            </AccordionTrigger>
            <AccordionContent>
              A full roof replacement in West Texas typically costs between $8,000 and $25,000 for
              residential homes, depending on roof size, pitch, and materials selected. Asphalt
              architectural shingles average $4.50-$6.50 per square foot installed, while standing
              seam metal runs $9-$14 per square foot. Most homeowners pay between $12,000 and
              $18,000 for a standard 2,000-square-foot home. We provide free written estimates with
          ...
          <AccordionItem value="faq-2">
            ...
            <AccordionContent>
              Most residential roof replacements take 1-3 days once materials arrive on site. The
              full process from initial inspection to completed installation typically spans 1-2
              weeks, accounting for material ordering and scheduling. Larger or more complex roofs
              with steep pitches, multiple valleys, or specialty materials may take 3-5 days of
              active work. Weather delays are common in West Texas, so we build buffer time into
              every project schedule.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="faq-3">
            <AccordionTrigger>Should I replace my roof before selling my home?</AccordionTrigger>
            <AccordionContent>
              A new roof can increase your home&apos;s value by $12,000-$15,000 on average and
              significantly speeds up the sale process. Buyers in West Texas are especially cautious
              about roof condition due to frequent hail storms, and many mortgage lenders require
              roofs to be in good condition before approving loans. If your roof is over 15 years
              old or has visible damage, replacing it before listing typically yields a strong
              return on investment.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="faq-4">
            <AccordionTrigger>
              What is the best roofing material for West Texas weather?
            </AccordionTrigger>
            <AccordionContent>
              For West Texas, Class 4 impact-resistant architectural shingles like GAF Timberline
              HDZ offer the best balance of hail protection, wind resistance (up to 130 mph), and
              value. Standing seam metal roofing is the premium choice, lasting 40-50 years with
              superior hail and wind performance. For flat roofs, TPO and EPDM membranes handle the
              extreme temperature swings from summer highs above 100 degrees to winter freezes below
              20 degrees.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="faq-5">
            ...
            <AccordionContent>
              Texas building codes allow up to two layers of asphalt shingles on a roof, so an
              overlay is sometimes possible if your existing layer is in reasonable condition.
              However, we generally recommend a full tear-off because it lets us inspect and repair
              the roof deck underneath, ensures proper underlayment installation, and provides a
              longer-lasting result. Overlays can also mask hidden moisture damage and void certain
          ...
          <AccordionItem value="faq-6">
            ...
            <AccordionContent>
              New roofs come with two types of warranties. Manufacturer warranties cover material
              defects and typically last 25-50 years depending on the product selected. GAF offers a
              50-year non-prorated warranty on their Timberline HDZ line. Our workmanship warranty
              covers installation quality and lasts 5-10 years depending on the system. We are a
              GAF-certified installer, which qualifies your project for enhanced warranty coverage
              beyond what standard installers can offer.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="faq-7">
            ...
            <AccordionContent>
              Asphalt shingles cost less upfront ($8,000-$15,000 for a typical home) and last 20-30
              years with Class 4 impact-rated products. Metal roofing costs more initially
              ($15,000-$30,000) but lasts 40-50 years with virtually no maintenance. Metal also
              reduces cooling costs by 20-25% by reflecting solar heat. If you plan to stay in your
              home long-term, metal roofing often has a lower total cost of ownership. For
              shorter-term situations, quality architectural shingles deliver excellent protection
      ...
      <section className="mt-12 bg-brand-gold text-white p-8 rounded-lg">
        ...
        <p className="mb-6 text-lg">
          Whether your roof has aged out, suffered storm damage, or you are planning ahead for a
          home sale, we provide honest assessments and transparent pricing. Call us or schedule your
      ...
      <RelatedArticles pageSlug="roof-replacement" />
    </div>
  );
}
