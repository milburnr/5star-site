      ...
      <div className="container-custom py-12">
        ...
        <FadeIn direction="up">
          <section className="mb-16 below-fold">
            ...
            <FadeIn delay={0.2} direction="up">
              ...
              <img src="https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/completed/completed-stinnett-49-1280w.webp" srcSet="https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/completed/completed-stinnett-49-640w.webp 640w, https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/completed/completed-stinnett-49-1280w.webp 1280w" sizes="(min-width: 1024px) 25vw, (min-width: 640px) 50vw, 100vw" alt="Wide-angle view of a completed gray dimensional shingle roof after storm damage restoration — 5 Star Roofing" className="w-full h-48 object-cover group-hover:scale-110 transition-transform duration-300" loading="lazy" fetchPriority="low" />
              <div className="p-6">
            ...
            <FadeIn delay={0.3} direction="right">
              ...
              <img src="/images/process/01-inspection.webp" width={768} height={355} alt="5 Star Roofing crew on a residential roof performing a free inspection in Canyon, Texas" className="w-full h-48 object-cover group-hover:scale-110 transition-transform duration-300" loading="lazy" fetchPriority="low" />
              <div className="p-6">
            ...
            <FadeIn delay={0.4} direction="left">
              ...
              <img src="https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/completed/completed-amarillo-19-1280w.webp" srcSet="https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/completed/completed-amarillo-19-640w.webp 640w, https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/completed/completed-amarillo-19-1280w.webp 1280w" sizes="(min-width: 1024px) 25vw, (min-width: 640px) 50vw, 100vw" alt="Newly installed gray asphalt shingle residential roof showing clean valley work and ridge lines — 5 Star Roofing" className="w-full h-48 object-cover group-hover:scale-110 transition-transform duration-300" loading="lazy" fetchPriority="low" />
              <div className="p-6">
            ...
            <FadeIn delay={0.5} direction="up">
              ...
              <img src="https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/commercial/commercial-plainview-23-1280w.webp" srcSet="https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/commercial/commercial-plainview-23-640w.webp 640w, https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/commercial/commercial-plainview-23-1280w.webp 1280w" sizes="(min-width: 1024px) 25vw, (min-width: 640px) 50vw, 100vw" alt="Wide-angle view of a commercial standing-seam metal roof installation on an industrial facility — 5 Star Roofing" className="w-full h-48 object-cover group-hover:scale-110 transition-transform duration-300" loading="lazy" fetchPriority="low" />
              <div className="p-6">
            ...
            <FadeIn delay={0.6} direction="right">
              ...
              <img src="https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/metal/metal-sanderson-15-1280w.webp" srcSet="https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/metal/metal-sanderson-15-640w.webp 640w, https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/metal/metal-sanderson-15-1280w.webp 1280w" sizes="(min-width: 1024px) 25vw, (min-width: 640px) 50vw, 100vw" alt="Hail impact points circled with white chalk on a residential shingle roof — documentation packet prepared for insurance adjuster review" className="w-full h-48 object-cover group-hover:scale-110 transition-transform duration-300" loading="lazy" fetchPriority="low" />
              <div className="p-6">
            ...
            <div className="grid md:grid-cols-2 gap-6 md:gap-8 mb-8">
              ...
              <FadeIn delay={0.1}>
                <a href="/hail-damage-repair-amarillo/" className="flex flex-col h-full bg-gradient-to-br from-white to-amber-50 rounded-2xl shadow-lg overflow-hidden card-blur-bounce border border-brand-gold/20 group cursor-pointer">
                  <div className="relative h-64 bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
                    <img src="https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/completed/completed-amarillo-13-1280w.webp" srcSet="https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/completed/completed-amarillo-13-640w.webp 640w, https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/completed/completed-amarillo-13-1280w.webp 1280w" sizes="(min-width: 1024px) 25vw, (min-width: 640px) 50vw, 100vw" alt="Completed gray architectural shingle roof installation in Amarillo after hail damage restoration — 5 Star Roofing" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" loading="lazy" fetchPriority="low" />
                  </div>
                  <div className="p-6">
              ...
              <FadeIn delay={0.4}>
                <a href="/tpo-roofing-midland/" className="flex flex-col h-full bg-gradient-to-br from-white to-amber-50 rounded-2xl shadow-lg overflow-hidden card-blur-bounce border border-brand-gold/20 group cursor-pointer">
                  <div className="relative h-64 bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
                    <img src="/images/materials/aerial-commercial-flat.png" width={361} height={209} alt="Aerial view of a Midland commercial building with a completed white TPO membrane flat roof — 5 Star Roofing" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" loading="lazy" fetchPriority="low" />
                  </div>
                  <div className="p-6">
        ...
        <section className="section-sub bg-gradient-to-b from-white via-orange-50/20 to-white relative overflow-hidden below-fold">
          ...
          <div className="relative z-10">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-2xl hover:scale-105 hover:border-2 hover:border-brand-gold transition-all duration-300 group">
              <img src="/images/materials/impact-resistant-shingles.webp" width={768} height={576} alt="TAMKO Titan XT Class 4 impact-resistant shingle bundles staged on a roof for installation — 5 Star Roofing" className="w-full h-48 object-cover rounded mb-4 group-hover:scale-105 transition-transform duration-300" loading="lazy" fetchPriority="low" />
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-2xl hover:scale-105 hover:border-2 hover:border-brand-gold transition-all duration-300 group">
              <img src="https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/completed/completed-stinnett-50-1280w.webp" srcSet="https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/completed/completed-stinnett-50-640w.webp 640w, https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/completed/completed-stinnett-50-1280w.webp 1280w" sizes="(min-width: 1024px) 25vw, (min-width: 640px) 50vw, 100vw" alt="Completed white TPO membrane installation showing clean drip-edge transition — 5 Star Roofing commercial work" className="w-full h-48 object-cover rounded mb-4 group-hover:scale-105 transition-transform duration-300" loading="lazy" fetchPriority="low" />
        ...
        <section className="mb-16 below-fold">
          ...
          <p className="text-center text-lg mb-8 max-w-3xl mx-auto">
            ...
            communities. Expert hail damage repair and roofing services wherever you are.
          </p>
