...
export const metadata: Metadata = {
  ...
  description: "Expert roof inspections in Levelland TX. South Plains experiences 7-10 severe hailstorms annually. Complete storm damage assessment and insurance documentation.",
};
