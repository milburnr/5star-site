  ...
  return (
    <>      <Breadcrumb items={[
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "name": "5 Star Commercial Roofing - Snyder Metal Roofing",
        ...
        "description": "Expert metal roofing services in Snyder, TX. Free inspections, insurance claim assistance, 24/7 emergency response.",
          ...
          <FadeIn>
            <div className="max-w-4xl">
              <h1 className="text-6xl font-bold mb-6 text-white leading-tight">
                Metal Roofing in <span className="text-brand-gold-light">Snyder</span>
              </h1>
            ...
            <div className="space-y-8">
              <div className="bg-white p-8 rounded-2xl shadow-lg">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <h4 className="font-bold text-brand-brown mb-2">Snyder Applications:</h4>
                    <ul className="space-y-2 text-gray-600">
                      <li>• Agricultural and ranching facilities</li>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-600">
                      ...
                      <li>• Feed and grain operations</li>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <div className="mt-8 p-6 bg-amber-50 rounded-xl">
                ...
                <p className="text-gray-700">
                  Our comprehensive maintenance program ensures your metal roofing investment continues to protect your Snyder property for decades. We provide annual inspections, preventive maintenance, and priority emergency response to keep your roofing system performing at peak efficiency through all of West Texas's weather challenges.
                </p>
              </div>
            </div>
          </section>
