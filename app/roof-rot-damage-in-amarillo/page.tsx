  ...
  return (
    <div className="container-custom py-12">      <Breadcrumb items={[
      ...
      <div className="content-block">
        ...
        <p className="text-lg">
          Roof rot is one of the most serious—and often overlooked—types of <a href="/roof-repair-amarillo/" className="text-brand-gold hover:underline">roof damage</a> in <a href="/amarillo-texas-roofing/" className="text-brand-gold hover:underline">Amarillo</a>, <a href="/midland-tx-roofing/" className="text-brand-gold hover:underline">Midland</a>, <a href="/odessa-tx-roofing/" className="text-brand-gold hover:underline">Odessa</a>, and surrounding areas. Unlike <a href="/hail-damage-repair-amarillo/" className="text-brand-gold hover:underline">hail damage</a> that appears immediately after a storm, roof rot develops slowly over months or years as moisture infiltrates your roof decking, rafters, and sheathing. By the time you notice sagging ceilings or visible water stains, the damage may be extensive and costly.
        </p>
