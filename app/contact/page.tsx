...
export const metadata: Metadata = {
  ...
  description:
    "Contact 5 Star Commercial Roofing for roofing services in Amarillo, Midland, Odessa, and West Texas.",
  openGraph: {
    title: "Contact Us | 5 Star Roofing | Amarillo, TX",
    description:
      "Get in touch with West Texas's trusted roofing experts. Free inspections available.",
    ...
    <>
      ...
      >
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-3xl">
            ...
            >
              Get In Touch With{" "}
              <span className="text-brand-gold-light">West Texas's Roofing Experts</span>
            </h1>
            <p
              className="text-2xl text-white leading-relaxed"
              style={{ textShadow: "0 2px 4px rgba(0,0,0,0.8)" }}
            >
              Ready to protect your property? Contact us today for a free inspection and expert
              consultation.
            </p>
          </div>
        </div>
      ...
      <div className="container-custom py-16">
        ...
        <div>
          <section className="mb-16 bg-gradient-to-br from-amber-50 to-orange-50 p-12 rounded-2xl border-2 border-brand-gold/20 shadow-xl">
            ...
            <p className="text-center text-gray-600 mt-8 text-lg">
              ...
              <a
                href="tel:8066226041"
                className="text-brand-gold hover:text-brand-gold-vibrant font-semibold hover:underline"
              >
                Call us
              </a>{" "}
        ...
        <div>
          <section className="mb-16">
            <h2 className="text-3xl font-bold mb-8 text-center text-brand-brown">
              Why Choose 5 Star Commercial Roofing?
            </h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <FadeIn delay={0.2}>
                <InteractiveCard>
                  <div className="text-center">
                    ...
                    <p className="text-gray-700">
                      Full assistance with insurance claims and documentation for hassle-free
                      repairs.
                    </p>
                  </div>
                </InteractiveCard>
              ...
              <FadeIn delay={0.4}>
                <InteractiveCard>
                  <div className="text-center">
                    <div className="text-5xl mb-4">
                      <Star className="w-5 h-5 fill-brand-gold text-brand-gold inline-block" />
                    </div>
                    <h3 className="text-xl font-bold mb-3 text-brand-brown">Class 4 Hail-Rated</h3>
                    <p className="text-gray-700">
                      We install UL 2218 Class 4 impact-resistant shingles — the highest
                      hail-resistance rating available, qualifying most homeowners for insurance
                      discounts.
                    </p>
                  </div>
                </InteractiveCard>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-700 mb-4">
                  ...
                  services with insurance claim assistance throughout the Texas Panhandle.
                </p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-700 mb-4">
                  ...
                  solutions including repairs, replacements, and new installations.
                </p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-700 mb-4">
                  ...
                  for businesses, warehouses, and industrial facilities.
                </p>
              </div>
            </div>
        ...
        <div>
          <section className="bg-gradient-to-r from-brand-brown via-amber-900 to-brand-brown text-white p-12 rounded-2xl text-center shadow-2xl">
            <h2 className="text-4xl font-bold mb-6 text-brand-gold-bright">
