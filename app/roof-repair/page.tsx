...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Roof Repair Services West Texas | 5 Star Roofing",
    description: "Expert roof leak repair and emergency roofing services across West Texas. Same-day storm response, all materials. Call (806) 622-6041 for a free inspection.",
