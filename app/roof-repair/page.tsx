...
const faqItems = [
  ...
  {
    question: "What are the most common causes of roof leaks in West Texas?",
    answer:
...
export default function Page() {
  const serviceSchema = {
    ...
    description:
      "Professional roof repair services across West Texas. Leak repair, flashing replacement, storm damage documentation, and all roofing materials serviced for residential and commercial properties.",
    hasOfferCatalog: {
      "@type": "OfferCatalog",
  ...
  return (
    <div className="container-custom py-12">
      ...
      <FadeIn>
        <div className="bg-brand-gold-light p-8 rounded-lg mb-8">
          ...
          <p className="text-lg mb-4">
            Roof damage rarely announces itself conveniently. A missing shingle after a windstorm, a
            slow drip in the attic after heavy rain, or a sagging section that appeared overnight --
            these problems demand prompt, professional attention before they turn into costly
            interior damage.
          </p>
          <p className="text-lg">
            5 Star Roofing provides roof repair services across 14 West Texas cities. From quick
            shingle replacements to emergency leak containment, our crews arrive equipped to
            diagnose the problem and fix it right the first time. We work on residential homes,
      ...
      <FadeIn delay={0.1}>
        ...
        <p className="mb-4">
          West Texas weather puts roofs through extreme conditions year-round. Here are the most
          common repair issues we handle:
        </p>
        <div className="my-8 rounded-lg overflow-hidden shadow-lg">
          <img
            src="https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/completed/completed-channing-16-1280w.jpg"
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-700">
              ...
              often requires emergency attention.
            </p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-700">
              West Texas winds regularly exceed 50 mph during spring storms, tearing shingles from
              the roof deck and exposing the underlayment. Even a single missing shingle allows
              water penetration that damages decking and insulation. We color-match replacement
              shingles and secure them to withstand future wind events.
            </p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-700">
              Commercial flat roofs develop low spots over time where water pools after rain.
              Standing water accelerates membrane deterioration and adds structural load. We correct
              ponding issues with tapered insulation, additional drains, or membrane patches
              depending on the severity and roof type. See our dedicated{" "}
              <a
          ...
          <div className="bg-white rounded-lg shadow-md p-6 md:col-span-2">
            <h3 className="text-xl font-semibold text-brand-brown mb-3">Wind Damage</h3>
            <p className="text-gray-700">
              Beyond missing shingles, wind damage includes lifted ridge caps, torn drip edge,
              displaced soffit panels, and loosened fascia boards. These components work together to
              keep water out of your roof system, and damage to any one of them compromises the
              whole assembly. Our crews inspect and repair every component affected by wind events.
            </p>
          </div>
        </div>
      </FadeIn>
      ...
      <FadeIn delay={0.2}>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="bg-brand-gold-light p-6 rounded-lg">
            <h3 className="font-bold text-brand-brown mb-3">Repair Makes Sense When:</h3>
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            <h3 className="font-bold text-brand-brown mb-3">Replacement Makes Sense When:</h3>
            <ul className="list-disc list-inside space-y-2 text-gray-700">
        ...
        <p className="mb-8 text-gray-700">
          We walk you through both options with transparent pricing. If a $400 repair will buy you
          five more years of reliable service, we tell you that. If a repair would just be patching
          over a failing system, we tell you that too. See our{" "}
          <a
      ...
      <FadeIn delay={0.3}>
        <h2 className="text-2xl font-bold mt-8 mb-4">How Does Emergency Roof Repair Work?</h2>
        <p className="mb-4">
          Active leaks and storm damage cannot wait for a scheduled appointment. Our emergency
          repair service is designed for exactly these situations:
        </p>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <div className="text-center p-6 bg-gray-50 rounded-lg">
            ...
            <p className="text-sm text-gray-600">
              ...
              and describe the situation. We triage based on severity and dispatch a crew.
            </p>
          </div>
          <div className="text-center p-6 bg-gray-50 rounded-lg">
          ...
          <div className="text-center p-6 bg-gray-50 rounded-lg">
            ...
            <h3 className="font-bold mb-2 text-brand-brown">Permanent Fix</h3>
            <p className="text-sm text-gray-600">
              We schedule the permanent repair as soon as weather and materials allow. Most
              emergency repairs are completed within 1 to 3 days of the initial response.
            </p>
          </div>
        </div>
      </FadeIn>
      ...
      <FadeIn delay={0.4}>
        <h2 className="text-2xl font-bold mt-8 mb-4">What Roof Materials Can Be Repaired?</h2>
        <p className="mb-4">
          Different roofing materials require different repair techniques and tools. Our crews are
          trained on every roofing system common in West Texas:
        </p>
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow-md p-6">
            <h3 className="text-xl font-semibold text-brand-brown mb-3">Asphalt Shingles</h3>
            <p className="text-gray-700">
              We carry a range of shingle brands and colors on our trucks for fast repairs. Whether
              you need a few tabs replaced or a full section re-shingled, we match the existing
              material and integrate the repair seamlessly. We install GAF, Owens Corning, and
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <h3 className="text-xl font-semibold text-brand-brown mb-3">TPO and EPDM</h3>
            <p className="text-gray-700">
              Single-ply membrane repairs require specialized welding equipment and materials. We
              patch punctures with hot-air welded TPO or PVC membrane patches, apply EPDM-compatible
              adhesive patches, repair seam separations, and address flashing failures around
              rooftop equipment. Our commercial crews handle these systems daily.
            </p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6">
            <h3 className="text-xl font-semibold text-brand-brown mb-3">
      ...
      <FadeIn delay={0.5}>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 border-t-4 border-yellow-500">
            ...
            <p className="text-gray-700 mb-3">
              Damage that compromises one or more roofing components and will lead to leaks if not
              addressed within weeks.
            </p>
            <ul className="list-disc list-inside space-y-1 text-gray-600 text-sm">
      ...
      <section className="mb-16">
        ...
        <p className="mb-4 text-gray-700">
          We provide roof repair services in 14 cities across the Texas Panhandle and Permian Basin.
          Select your city for local service details:
        </p>
        <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-4">
          {cities.map((city) => (
            ...
            >
              <span className="font-semibold text-brand-brown">Roof Repair in {city.name}</span>
            </a>
          ))}
        </div>
      </section>
      ...
      <section className="mt-12 bg-brand-gold text-white p-8 rounded-lg">
        ...
        <p className="mb-6 text-lg">
          Whether you have an active leak or want a professional assessment before storm season, 5
          Star Roofing is here to help. Call today for a free inspection and honest repair estimate.
        </p>
      ...
      <RelatedArticles pageSlug="roof-repair" />
    </div>
  );
}
