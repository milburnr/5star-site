...
heroCaption: "A properly installed architectural asphalt shingle roof — the most common residential material in the Texas Panhandle"
faq:
...
<ArticleImage
  ...
  alt="Close-up overhead view of architectural asphalt shingles in gray and brown tones showing the dimensional tab pattern"
  caption="Architectural (dimensional) shingles — thicker and longer-lasting than three-tab, but still vulnerable to granule loss from hail impact"
/>
...
<ArticleImage
  src="https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/hail-damage/hail-damage-perryton-8-1280w.jpg"
  alt="A gray plastic turtle vent installed on an asphalt shingle roof with mixed brown and gray tones"
  caption="Proper attic ventilation — like ridge and turtle vents — prevents heat buildup that prematurely ages shingles from below"
/>
...
<ArticleImage
  src="https://pub-797574ea9b1b4ccda73d4f6afb5d90d5.r2.dev/images/hail-damage/hail-damage-perryton-9-1280w.jpg"
  alt="A plastic turtle vent installed on an asphalt shingle roof with multi-colored dimensional shingles in gray and brown tones"
  caption="Even well-maintained roofs in the Texas Panhandle benefit from annual inspections given the region's hail and wind exposure"
/>
